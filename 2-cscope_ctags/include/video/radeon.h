...
#define MDLL_RDCKA__MRADEO0_REF_SEL_MASK ADEON_REGSIZE			0x0x#ifn0030ef _RDEON_RHf _RADEON MM_INDEXFB _RADEONMM_INDEEGSIZE			0x444000


#dcADEON_M_INDEX               0x0A    KEW       0x0000
#define MDATA   70                           0x00SIN               0f _RADEON_M_DATA   8               3          HI_STAT                         fine BUS_CN4Cf _RADEONBUS_CNTL1              0x00		       0x009              0x00 70
#define BUS_CNTL1              BP
#define BUS_CN                0x008E          CNFG_MEMIZE	                0x0ine BUS_CNT4f _RADEONE      APER_0_BAS           0x0100
#def1_SLEE                0x0034
#define I1                 0x010APER_1_BAS       _1_BASE         ER_1           0FG_RE8_1_BASE       REG10C
#defineRESETER_              0x0100
#define2        0x01              0x0100
#def0x0164
#define PAD_010L_1			    C    0x0164
#define PAD_016APER_1_BASANGE0110
#define PAD_AGPINPUT_DELAYc                    0x0164
#define Pf _RADEON   0x0000
#define MM 0x03A    08
#define CNFG_REG_1_BASE    08
#define CNFG_ 0x00F8
#define CNFe PADD_CTLR_MIS     0x0168
#define PACNTL                             0E0
G_REG_APER_SIZE                  e VIPH_CONTROL			       0x0C40
#d0 0x0TL		0168
#define PAD_C9c          VIPHefine I2ENGTH                     ENDOR_IDe VIPH_CONTROL			                           0x0          G0x009DOR_ID          ne CNFG_R7APER_10x0168
#define PAD_C0FG_APER_SIZE        CNFG_FEG_1_BASE      USCONTROL			       0x0C40
#def               0x0aa0E
//DEX       Bne MM_INDEX       B       B0                       0x0100
#define0A
#1ine MM_INDEX           UB_CLAS                 0x0                A_1			     ASE_COD           0x0100
#dine 1          PAD_AGPINPUT_DELAYELAY                 0x0F08
#defineF    define HEADER Bne CACHE_LICHE_LIN           0xADER D1         EADER           0x0F08
#define 6EGPROG_INifn     MM_INDEX       efine HEADER     0x0aa0
#define AGP_CNTL                                          ine BM_STATUS                      ine VIPH_CONTROL			       0x0C40
#defx0F1                              0x0                TL1                            0x0F0BOS_ROM           TL_1			       0x0094
#define CNFG_CNT0xE0
#defin                    0x0FADAPTER_ID             _APER_1_BA     0x0F2C
#define BIOS_ROM          PER_0_BASE            
#define REG_REG_BASE                0x0F06
                     0x0104
#define             0x0aa      0x010C
#define CN     0x0F08
#define R4                                 0x0100
#define CNFREG_APER_SIZE       I_CAP                0x0F02
#de                                                      
#define LATENCY                     0x0F34
#define INTERRUP    52        0x01STRENGTH                0x0F0F
#defG_APER_SIZY       I_DATA                   0x0F0F
#define REG_D      0x0160
#define CAP0_I_DATA           aax0F10
#defAGP      0x0F2C
#define BIOS_ROM                       M                       0x0F08
#defF0F
#defER_0_BASE     0x0FI_DATL_1		          5IC_STAT     P1_TRI       DOR_ID                              CONTROL	E        0x0C4                                0x0F02
#dine D8
#ADER x0F10
#defDEVICE                0x0F02
#def_TLB_AMAND IC_CTR    COMMAN      0x01E0
#define AIC_TLB_ADREVISION_ID                            0x0F51
#define HEADER 6    0x0aa0EVISION                0x0F02
ine     ADER G_APER_SIZREGPROG_INF       0x0 MM_INDEX    300       MM_INDD             51P_STATUS  MI_DATA                      GEN      0x0F2C
#define BIOS_ROM       AC_CNTL       E_1			     IS                    B       0x0F54
#define00x01D4
#defMEM_C4     0x0F50
#define            EX_TIMING_CNTL   MC                    C
#define BUne MC_TIMING_CNTL        0x0168
#define                   4
#define CNFG_CNTLx0144
#define MC_TIMING_CNTL        0x0144
#define M           0x0F0D
#deATUS G_APER_              0x0F0                   0x01M_INIT_LATEN       INIT_LATENCY MEM_REFRESH_CNTL                   8007c        pllCLK_PI     TL           0x0F0D
#definx0174
#define BM_STATUPPLLC_INI5G_APER_SIZ                    0x0F3F
#define ADLB_DATAL_1	DIV_LAT_TIMER O0x009_A4
#define CNFG_3CAPABILITIES_PTR DIV_0FX_LAT_TIMER TL_AB                  0x0144ATUS L_1			    M1M_IO_CNTL_B0                        50x0180
#define MC_INI2M_IO_CNTL_B0                        60x0180
#define MC_INI3M_IO_CNTL_B0                        7   0x0178
#dV 0x0ECPx0170
#define MEM_IO_CNTL_A1     DATA _AGP_LOCATIONHTOTAATUS                                DATA 9   0x0178
#dM_Sdefine MFBSH_CNTL RE    AB   EXT_MEM_CDATA    0x0F18
#de    180
#de            0x0150
#define MEMDATA ION       pllLB_DAT              0x0150
#define MEM_02
#defi   0x0178
#define  0x0148
#define HOST_PATH_CNTL          D                                0x0150
#define MEM_       E             X   CKOne MEM_VGA_RP_SEL                         0     L_1			   LAT_e MEM_VGA_RP_SEL                   1ine 3G_APER_SIZSW_SEMABHOR           0x0100
#define 38
#de      0x017C
#Mf8
#de              VGA_WP#defx0104
#define CTL            LL_TE          0x0F50
#define 8G_APER_SIZMC        0
#defi     WRMG     0x0178
#define MEB         SURFA0x0B00x0F10
#dL                 0x#defiN_ID       E1_LCE1_LBOUND        C       MACRO_RW_WRIT     #define SURFAFACE2_Lfine SURFIOP   0x0F18
#d#def248C
#0B04
#define SURFAFACE2_LSURFDEBU             0x04
#defDATPL                   CE2_L                        4
#def0170
#define MEM_IO_CNTLCE2_L             DIS          4
#define SURFACE2_LOW3_LOWECE2_LOfine MC_CHIP SURFACE2_LOW7     URFACE2_LOW4     R_BOUCE1_LOne CNFG_CNTL      CE0_UPPER_BOUE2_LOW5         0     x0B08
#define SURFACE1_UPPER_BOUND   0170
#define MEM_IO_CNx0B08
#define STERRULAY_BAS_B                     0x017x0B004
# SURFA8
#define     ISCE_ADD                 0x033         BOUND G_APER_ST      FINEY_BASE_ADDR                0x0 0x02           R            0x0F50
#define                IO_O           0x0F0D
#defin0T160
#    _TIM                 0x0B18AC_CNTL    TV_DTO_INCREMENTSne SURFACE2_LOW7_UP0x01  0x0B180_LOWER_BOUND   AU               0x000x0B00
#define SURF2OWER_BOUND   0BOUNSURFACE2_LOW2    Oe VIPH_CONTROL			      BOUND        M238
#define MEM_VGA_RP_SEL                   x0B74
#defineCE2_LOdefine SURF8C
#define MC_CHIP_I0B5C
#define SURFACE6_CE2_LO     0x0150
#deBE0
#define C6C
#define SURFACE7_INFO PIXCLKSx0170
#define MEM_IO_CNTL_A1                     TERRUPT_L           0x0F0D
#defefine MC_INCE2_LOW          C
#EG_REG_B_TIMIG_APER_SIZHOST_PATH               S_CL                                     0x0BF8
#d      f      0x017C
#de                      0x03f8
#BAGP_STATUS S      0x017C0xSS_    0x0F3C
#define INTER_LOWER_BOUND               		  1CS_           0x0B68
#de		       0x1C3C
#defineWER_BOUND   YNC_CMO      ATUS fine CRTC2_E2_LOW6_UP       5          ixMC_PERFx0170
#define MEM_IO_CNTL_A1                         0x017
#def           0x0F0D
#define HES_alt_1                       ON                    0x0B6C
#define SURFACE7_INFO  T_STAT174
#define SURFACE0_INFO                 0xNFO           T                    0x0B6C
#defineWER_BOUNDT_STATUE4ER_BOUN
#define SURFACE0_INFO      WER_BOUND    
#define#define R                0x0B38
#defURFAefine SURFI48
#define NQWAI           0x0B38
#define Sfine SURF          define NQWAIMEMCH_             0x0B18                     BBM_CMDFIFO                         0x0OUNDE               IM         0x0F50
#define 0
#define BOUNDefine e MC_CHIP_ICHP_I     0_A                   0x0B6C
#define SURFACDATA              efine RBBM_CNTL_alt_1                S                   EXT_MEM_CNTL defiefine MC_IN             0x0B68
#defiEM_CNTL            L_1			    GPIO_Vfine RBBM03IFO_DATA  0xH                    0x0B6C
#define C
#define ixT     MATCHI
#define SURFACE0_INFO       8
#deL_1			    NTL                           0x0B38
#definG_APER_SIZERTC      B#defiTR0
#define MEM_IO_CNTL_A1           4
#defi_CNix    COLLARER_BOUND               R_ SURFACE_ACCE0       00BG_APER_SIZND                   0NDACE2_LOWER_ID        i_CTLR0           e GPIO_CRT2_DDC                    0x01          _                 0x0060
#define GRTC_EXT_CNTL  4C_V_SYV_SYNC    T_W    
#define SURFACE0_INFO   a          _Vx0F0_CRNTT_FRAM
#define CNFGAIC_STAT         bTC_V_SY     FRAM                       0x03f    2fine LATce CRTC_CRNT_FRAME                        definG_1_BASE   d         0x0B44
#de                  0x0218
#define CRTC_ee CRTC_CRNT_FRAME                        define CRTC_OFFS                  0x0218
#defi24        0218
#define CRTC         0x CRTC_CRNT__    L                     0x0B6                CRTC_V_SYELPID8
#deNTL       0x1724
#defi MC_DEBUG         VLINE_CRNT_VLIN      0_C                                 CRTC_V_SYx0E4WID_TOP_BOTTOO_DATAH              ACE7_LOWC
 CRTC_V_SYO_DA    WRRBBM_CNTL_alt_1           		          define SNAP        VR_WID_LEFT_RIGHT      efine I2C_CE0x01D4RTC_V_SY0B        0x0EOVR                                    NE_CR                  0x005C
#define GPIO_ SNAPSHOT_VIFFRAME     0x007c
#               0x0B38
#defiRTC_V_SYTRIG_VLINE                    0x0218
#             TC_GUIAIC_PT                  0x0180
#define SURFACE_ACCE          0x0B44
#de      0x0180
#defindefine SURFACE_ACCEET_RIGH           0x    0
#deE2_LOWER                         0xfine CNFG_CNTL                 0x1724
#define R               NB_TOMDP           0x0B44
#de                15C    endif	/*
#define C */
