...
#/*
 *	PCI CVENDORVendSCALEMP		0x8686*	Please keeplass, d.
 leaseDo_VSMP_CTL	0x1010ase w entries  sorted.
 COMPUTONE not e0e new entries to this fi multiple_IP2EX	0x0291.
 */

/* Device cto tes and subcPGs */302s
 *	are sharSUBed betweens and sub riversdefine PCI_CLSUBASS_NOT_DEFINED not00040
#d00#/*
 *	PCI CCLLS_STSTORAGE
#def1
LASS_S8ORAGE__STORAGE_SS_STORAS_STORAGE		0x01
#defin6ORAGE_3ns
 *	are shared betweenKTI d
#de2ens
 *	are shared betweenADAPTEC dri9004.
 */

/* Device classeIDE		0x07810finit78_RAI1
#def104e PCI_CAGE_IDE		0x0S21	0x21SATAx0106
#6efine PCI_CLASS_STORT38602	0x	0x0TA		0x0106
#define PCI_CLASS_STOR501005_A_AHCI	0x010601
#define PCI_CLASSOR55OTHE5A_AHCII	0x010ine PCI_CCI_BASE_CLASS_N	0x603_AHCI	0x010601
#define PCI_CLASS1480AET	0x75TA		0x0106
#define PCI_CLASS_STORRNING	0		0x0180

#define PCI_BASE_CLASS_NE6GE_S6T0x02
#define PCI_CLASS_NETWORK_ET787		0x7202I_CLASS_NETWORK_ETHNETWORK_ATM		0702037LASS_STORAGE_SASS_DISPLAY	ORK	R
#def2100
72*
 *	PCI CBASE_DISPLADISPLAY
#def3
#3	PCI3_CLASS_DISPLAY_XGA		0x0301
#define P	PCI74		0x0180

#define PCI_BASE_CLASS_NE9PLAYPLAY_A		0x0106
#define PCI_CLASS_STOR8		0x8define PCI_BASE_CLASS_DISPLAY		0x03
802038e PCI_CLASS_DISPLAY_VGA		0x0300
#def8100
8S_DISPLAx0301
#_XGHCI	0x3PCI_CLASS_N8AGE_8A_PHONE	0x0431
#def3efine PCI_BASE_C8	PCI8NE	0x04x0300
#def380
I_CLASS_NETWOBA8PLAY8s */
ine PCI_BASE_CLASS_DISPLAY	ET78_MULTI6#def500I_CLASS_NETWORK_ETHMEMORY_FLA7H03
#0501
#define PCI_CLASS_MEMORY_OTHER	ISPL8878E_IPIx0106
#3I_CLASS_NETWORK_ET2	0x0100_MULTIMEDIA#defdefine PCI_CLASS2_2940U100
0tionASS_DISPLABRIDGE_ISHCI	0x PCI_CLA3S_NETWORKe PCI_CLASS_DISPLAYRAGE	#define P7890 IDs0013GE_MC2
#defi_BRIDGE_HOST		0x060EISA	E_PCI	fE_EISA		0xE0602
#defi0500
#defin3ASS_NETWOR5GE_EISA		0xe PCI_CLASS_BRIDGE_NUBU950U2D061060		0x604
#define PCI_CLASS_BRIDGE_PCM100
_F50605e PCI_CLASS_BRIDGE_PCMCGE_NUB7892RING00IMEDIne PCI_CLASS_BRIDGE_CARDBUS	0ASS_GIA		08 PCI_CLASS_BRIDGE_RACEWAY	0x0608
#dee PCI_CL
#defidefine PCI_CLASS_STOISA		0xPCM2PS_MEMOPARALLEL 0x0701x0300
#def6ine PCI_CL9SS_MEMcAY_XGA		0COMMUNICATION#def7I_CLASS_N9CI_CLAc PCI_CLASS_BRIDGE_RACEWAY	0x0608
#de9LASS_ScASS_COMMUNICATION_PARALLEL 0x0701
#d9ASS_NEcI_CLASS_BRIDGE_OTHER		0x0680

#deOBSIDIAN   501
#define PCI_CLASS_BRIDGE_CARDBUS	0SCAMASS_N5LOPPY0106
#0500
#define PCHOLTEKSS_NE41SS_NETWORK_ETHto this fidefine_656PLAYS_NEns
 *	are shared betweenNETMO		0x017ALLEL 0x0701e PCI_CLASS_B/*
 *	_970PLAYCI CSTORYSTEM_RT04
#de8ine PCI_CLASS1_DISPL1EM_PCI_CI CHOTPLUGLUG	0xdefine PC3_DISPL3SS_SYSTEM_SDHCI		0x0805
#define P4_DISPL4SS_SYSTEM_SDHCI		0x0805
#define PSPLAY_STORSTEM_PCI_HOTPLUG	0x0804
#definIMEDIA_8TEM_PCI_EM_SDHCI		0x0805
#define LASS_STIMEDIEM_PCI_SD2
#dLUG	0xLASS_BRIDG_MULTLA80x0902
#d PCI_CLASS_ine PCI_CLASS8ISPLAY8DISPLAINPUT PCI_9I_CLASS_NETWORK_ISPLAY0300EYBOARD	0x0900
#define PCI_CLAS900203ING	ns
 *	are shared between3COM_defina727ns
 *	are shared betweenDIGIUM drid16DGE_MC		0x0603
#define PING_OT_HFC4SIDs
4ionseaseare sharORAGE		0x01_VEXSY	PCI d84dSI		0x0100
_SCSCI_CLASS0
#R_386_401	PCI PCII_CLASS_NETWORK_ETHPROCESSOR_486		SPLAYM	0xns
 *	are shared betweenTIGERJET drie159E_CLASS_COMMUNICATION	0R_ALPHA	_30CIHCI	E_CLASS_NE PCI__PROCESSOR_PENPOWER1C#defb20ease *	are shared betweenXILINX_RM1

#eaASx0106
#ON_MODEM	0RAGE_SRME_CLASS PCI989d_RAID		0x0104
#define PCAL PCI_c
OCESLASS_S7I_CLASS_STORERIAL_FIREWIRE0x0c000
ISPL9898
