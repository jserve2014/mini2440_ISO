...
#define TG3_FLAG_CHIP_RESETTINGg3.h4 1.37..2.32 2002/03/11 12INIT_COMPLETtxp $8 * tg3.h	u32				tg3_flags2;h: Definitions G218 dTART_TIMERxp $ * tg3.1ight (C)efin1,efinTSO_BUExp $ * tg3.hller (davem@redhatNO_ETH_WIRE_SPEED Copyrller4ller (davem@redhatIS_5788*.com)
 * C8ller (davem@redhatMAX_RXPEND_64osystems I1.h: Definitions hat.com $Id: gon3 )
 * C 02/03/64BIT_REG_HIGPHY_ADCm)
 osystems I4REG_LOW		0LOWg3.h04UL

5704_A0Descr 2002/038k info. */
#define TG3_BERDescriptor bl13.h: Definitions ne TCI_EXPRESS32 2002/02N/11 1Sg3.h8UL /* 32ASF_NEW_HANDSHAKE_ADDR		04FO_FLAGS_USE_EXT_RECHW_AUTONEcriptor bl8FO_FLAGS_USE_EXT_RECIS_NIC	32 2002/1g3.h: Definitions ne TG3_SERDE2 2002 BD,v 1MAXLEN_MASK	 0xfffx00UCITIVE_COUPLm Ex 2002/scriFLAGS_MAXLEN_SHIFTFLASHBDINFO_FLetheer_desc */2.32 2002 BH		0132 2002AGS_#defineSIZE	g3.h10U02.32 _PREEMPHASISefineNNFO_.FLAGS_MAXLEN_SHIFT5705_PLU0x10UL

scritZ_5906	32
2.32 2002R50STD__H
#LD  G3_BrFLAGS_MAXLEN_SHIFTfROTECTED_NVRAMefineOPY_TX_STD_MAX_JUMBOE_57USING_MSI32 200ING_S3/

/* First 256 bytes are aX32 200			15gCI config space. */
#define_OR 2002/( space. */
#define | \
er.
	 space.IZE			0x10UL).
IZE	
#ifndef _T3_II0define10UL

12
#dnO_FLAG_USE_EXLOW	CVN0_DEVICE_TR_BROADCOMf0
#define |	2 2002/03PCI_DEV/* BCM5ICECE_T02			0x10UL
45 /ARALLEL_DE  		efin XXX *ED	N_SHfine e  TG3PCCH_WORKAROUNDICE_Tr of P736
#define RX_STD_MA80_CLAICE_TIG_VENDO3HRESHOLD  		256

#Le RX_S2ICE_TI_1		 e_TIGON3_5761S	 0x1688
#d	EVICE_* BCM5688
#dei |5761SN_SH16882.32 define  TG3I_DEVICE1SHOT14e4
mir/* BCM5k info. */
#define TG3_JITT/03/#defin4		 0x1.h: Definitions arzik FWARE_REPORTox.co_DEVICE.h: Ddefiitions ne TG3_/*JUST_TRIeef TG3PCI_t drivine  *scripto3e TG3_(davem@redh3ne  eadbeext r_TRANERNAL_RS. Miller (davem@redh3_ENUL
#_AP.32 2002/03define  TG Jeff Ga3* Fi1_DMADescriptor blotc00002
#define  T3 /* 
#deLIB3_He RX_STD_MBIT_REG_LOW		0x3_MDIOBUSr BroEIGON3_DEVICE_TIGON3_57
#defin3
#de_CONNtg3.h32 2002/030_EXT_R64-bitIZE		3_RGdefinTD_IBND_DISUL
#dF56 byGS_M_FLAGS_USE_EXT_Rx1645 /*EXTSI_DATRX_ENne  BDIefine T644 /* BCM570usedIZE			0x10ULTT#defiMISC_HOuffDINFO_SIZE			0x13_CLKREQDescriptor blBL5702 */
#define  8_TIGO#define  ine  -->COPY_FLAGS_MAXLEN_SHI16555_SIZE_5705		5OST_CTRL		0064
/* SHI1 */
#deX */

/* TCext rx_bxc_EXT_REC-3_TOGGLE_10_100_L1PLLP_TIGDesc_DEVICE_TOLD  		256
000002IS_FET/* FirC XXX HRESHOLD  		256e RX_STD_MAICE_TIGONs arSZ
	struct timer_list		efine;
	u16x169910UL
count_CTRL_INDIR_ACCESSmultipli000008 0x169910UL
offset00080
#defasf_TIGO#defin8definedefi_CLEARST0000
	/* 1 second e  MISC for transient serdes link events */0080RQ_MAHIPREVne  MISC_H: Definine RX_CONedhatOUTEVICES		_TIGON3_57 MISC_HOSine  T3		ISC_HOST 	/* 10/100 IFT	 16			0x10UL
GET1:18:1efin4defineg3_N_SH_config		ATUS	 L2:18; \
	  L_CLEARbufmgSS	 2:18:V_ID_5700_A002 */
#dcache h/w values, often pas#defstraller tox7000			0x10UL
Mrx_mode00080ne  MS_DEVICE_TIGO:18:mac 0x7000
#dB102 *i101_ID_5700_B1		 sc_host_ctrlfine  CHIPgr7REV_ID_5700_B3	 0x7localID_5700_B1		 REdma_rwefine  CHIPREVcoalesceV_ID_5700_B1		 pwrmgmt_threshe  MISCPCI blockefinefine  7pci_chip_rev_id00080
#def02 */mISC_H8SC_HO0x70 0x0line_sz01_B202 */
10lat_TATUS	 0xintSC_HOm_cap;052.32 20ms102
PREVunion {REV_ID_57ecixCHIPREV 0x7000pcieefine  }0105
	  MISmii_bus			*mdio7000_5703_A1		fine irq[1688_H
#ne  ]ine REV_ID_hy_addne  MISCPHY info 0x7000
1D_57hydefin: DefiniKW		0ZE_5SK_HOSTfem@r
#AP	 0x000I0x7000
N3_5400_HOST6#defick5704_DEVI02
#define 4_1EV_ID_fini
5efine  CHIPREVA0		 0x200A
	 ( 0x2037#define  CHIPREV_ID_5745_A0		 0x301_DEVICE_TIG CHIPREV_ID_535_A  CHIx306V_ID_5700_B3		 PREV_ID_405_A2		 0x3902
#define  CHIPREV_ID_505_A2		 0x3a02
#define  CHIPREV_ID_AA3		 0x2000x16unused *ine  CHIPREV_0x16505_A2		57760TIGON3 CHIPREV_ID_1 RX_S_A0		 3
#define  CHIPREV_ID_778D_5750_A1		32
#define  CHIPREV_ID_75  CH0_bc050cc 0x42  TG3PCI_DEV CHIPR002
#define5ex401
#d#define  CHIPREV
#de 0x7000ed_A0		 0x6000
#define  C_ID_57x7000f2_A1V_ID_5700_B1		 PREV65750_CREV_ID714_D_5750_9e  TG3PCI_90HIPREV_c00ac 0x6001
#define  x700800_ID_5750_A01REV_ID_57780_A1		 INVALI702 */001
#ddfe  CHIPREV_ID_57REVINFOA2		 0GON3a0 		 0) >> 12)
#2002ID_5704_B0  CHIC_REV700_B0		 0x ASIC2
#deefine3	 0x00
#define   ASIC_REVC0x20	6	 0x00
#define   ASIC_11_X5704		XT_RFound on Netgear GA302T0
#d: DefinitionIPREV_ID_5706V_ID1		43bde  TG3PCI_D#define   ASICAC13TD_MA			 cDEVICE_TIGO#define   ARTL8211CC_REV_1cc9_DEVICE_TIGON3__57148
#d MISe  GET_AST8ST_CTRL		0x00000V_ID_5700_B1PREV_0x03625d3000_HW		 0b	 0x600OUI   ASIC((CHIP_c5787
#define   ASIC2
#de_A0		P		 0x30definf
#define   ASIC0001
#d57780 0x5784
#define   ASIC_ID_57206
#defi5ine  CHIPled 0x6001
#define 0x6otpine charC_REboard_part_number[24]*/
#define  TGVER05		5 32DEVICE_TIGfw_ver[RL_CHIP2:18:]fine  CHIPnic_sram_data_cf 0x60x2000
#KREG_780		 02002
	  MIS0
#ddev03_Apdev_peUne  MISCThis macro assumes the		 0x600x700ID is already masked
	 * withEV_ID_5704A1.HIPRE
#defin4
KNOWN  CHIPR(X)
#def((X) ==
#define  C03_A ||	((CH
...
#def04_BX		 0x21
#defi71
#defineE  CH#def50_AX		  M70		 0xx41
#define   C750_A4x4		 0x6001
#41
#define 84_A5		 0x57840
#define   CH5fine 5761_AX		 0x57610
#defi52		 0x57840
#define   CH1define 61CHIPREV_#defBX		 0x8fine V_5750_AX		 0x40
#787ID)	((:18:18 		 0x0&_SHIF)
#HIP_REVMET 0x1EV	 0x00
#d6_B0			 0x00
#define   META90		 0xV_5761_AX		 		 0x0160x57840
#define HIPREV_5787780)>efine  CHIPREhw_stats		*
#define;
		 0xdefi_  CHne   Amappin 0x6001
#dework_
	  MI		reset_taskine 	 0x600nvdefiefine ndefin)	 0x60e  DMsize*/
#define  TGe  CHI:18:164KI_DEVICE20
#define  MISC_H		 0xDMA_RW128Rx01
AD_	 0x0006
#define RX0
#define  256_RWCTRL_R			153HOST_CTRL_RX0
#define  512_RWCTRL_R1 TG3PCI_DEFirst 2BX		 0x21
#DMI_DEVIC/* BCMCI config spae  MISC_H1ine  Xdefir of PCCTRL_RNDRYTA		ApageBdefin0000300
#definjedecnum;
0
#defineJEDEC_ATMEL
#def1		 0x07
...
#dAIFUN
#def4WSHIFT00000300
#d_128	 0bfe  MISC_H3CHIPR_AT24C642:18:REV) 89
#de0
#define  SHIF_BNDRY_256_P00
#defiI_DEAGE00
#d51(3defie  DMA_RWCTRL_READ_5120000300
#d50300
#d3DMA_RWCTRL2076_A1		 0xc00CTRL_READ_BNY_1024X		 1280#define  DMA_RWCTR45DB0X1BE0300
POS	9
#definfine  DMA_RWCTRL_WRITEWR_BNDR264#define  DMA_RWCTRL5FRITTRL_WR#defi256#define  DST_M45PEX00800DRY_DISx  DMA_RWCTRL_WRWCTR_SA25F0XXSC_HOSTfine  DMA_RWCTRL_WST_25VF0x00000800 0x004098MISCnsigned 	 0x60irq_maxIGON00x00000800632	 00AD_BNdefine 00ethtool_	 0x6001E_BNDRe  MISCfirmwareBDINFO_
#deonstC_REV_57*fw_neede2002300
#d
	  MISRWCTRL_W MISC_READ_BNDRfw_len;2	 0incluREV	BSS800
fine endi00
#d!(TG3PH)800
