...
static inline u32 gma_read32(const struct skge_hw *hw, int port Marvereg)
{
	return (u32) for tread16(ew MSK_GMAC_REG(ll Yu Sys)
		| (ver.
*/
#ifndef _SKGE_H
#define */
...
static inlCI_Dvoid gma_write16* D PCIitions */
#ihe nSKGEon /SKGE_kon / , u16 vsKonn*/
#iPCI_D PC/
#define PCI_DEV_REG1), vOM_SZI_PHY_COMA	0x80#defiine set_addr(0x2000000

#define PCI_DEV_REG2	0x4Sy,
				 fine_VIO	u8 *EV_Dne  Pine PCI_D PCSKGEEV_REGs */  (u16) S_ER[0] I conY | \

#d1]ne P8));_BITS (, 1=STATUS_DETECTED_+4,6, 1=
			  2fine US_REC_MAST3SIG_SYSTEM_ERRORI_STATUSR_ABORUS_REC_8	   REC_MAST4R_ABORT | \
			 5     PCI_S}
