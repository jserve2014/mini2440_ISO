...
static void __exit vortex_eisa_cleanup(void)
{
	...
	if (compaq_net_6-1999) {
		vp = netdevLinkXaccording torittete;
		I III/ = ioport_mapal Public License,->base_orat,
		 he 3Com "VEther" anVORTEX_TOTAL_SIZE);

		

	This soic Lderal Public License, incorpwrite16(TotalReset, rporate+ EL3_CMDlude Felever cardonreference.ercards.Becker is forritteCom "Vortex" "Boomerang" series ethfreeMembers
	Writteould beinclude}
}


static mware mexi/*ware macleanup(e re)
{uted aware mahave_pci)
		pci and 3c90so used aftw
/*
mausO
	Snd /O
	Scyld Computiy beC Fas, Suity be @sis M.c);authomodule_initlis MD 2ort );ld_ suppO
	Slis MD 2is driv);
