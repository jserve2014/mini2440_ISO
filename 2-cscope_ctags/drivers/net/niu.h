...
#d/* niu.h: D/* nitions for 3eptun6 ethernet driver.
 *
 * Copyr4ght (7) 2007 David S. MillTCP_IPV@davem8) 2007 David S. MilleD_NIU_H
#def9) 2007 David S. MillAH_ES			0x000000a) 2007 David S. MillSCT			0x000000boft.net)
 */

#ifndef 			0x6ght (cneine FFH
00000 niuPIO	eptuLPFLP	dLdefine FZFZC_C_FFLP		080000UL0x3800eine PIMACFLP		10x40000define0x3800f0UL
#define PIO_VADDRRP	ght 10) 2007 David S. MillR niuDMC		1) 2007 David S. MillDUMMYNDMC		260000UL
#definne TX			0x5ight 13L
#define FZC_TXC			0x780H
#de14L
#define FZC_TXC			0x7805
#defe) 2007 David S. MillFLP		0x3801C) 2007 David S. MillFLP		7L
#delIPP			0x280000UL
#deFLP		8L
#de_TXC000UL
#define FZCFLP		9L
#deine FZC_TXCe PIO_VADD		0x50UL
#deG)		(PICP			0x500000U + 0x01L
#de_IPUL

#d20000UL
#def#defin7x4000x3L + (LDSV0(LDG)		(P#defin * 0x2* 0x2000UL)
#PIO_VADD#definL
#defZC_TXCZCUL
...
/* Logical devices andV#defin groups */) 2007 DaLDN_RXDMA(CHAN)			(
#deIMGMT_)0UL)define FZ ESV1(OFF_ARM	16 LDS  LD	0x400400000
#TLDG_000000G_IM32 LDSV20(IDx000000000000fine2eMER	fULL5MT_TIMERDR		2000UL)
#deMIFV + 6efine FZC_K0 + AC(POR#defin64LD_IM0(IDX)		(PIO_IMASKDEVICE_ERROR		6e FZC_PIM	0x2000XMER	IDX)		( + 0IMASK
) 2007 Da		0x000UMINMC		MER	_IM1_efineptunDX) *_IM03ULL

#efinNUM

#de LD_LDSV + 0PeptuINVALIDMC			fDG000ULHY stuff2IMGMT00000UefinPMA_PMD000U_ADDR		xL
#definef0000CS_DMCIRTY_TI3x000000003ULL
PHY_ID3ULL
GIDX) *fff0f2000UL)
#30000_TID_CTBCM870H
#def02060DG) * 0300000IMASK0 + L
#dDI0x3800defiL_define PIO000000000000035464R0UL
#definbRDTHRED	0x00000000000MRVL88X20n + 0S01410000_RES_fine  DTIDE register addressex00000000ffff00001ULL

#*
 * CDEV10010ULD_CTL		(FZine LDSV180000000ULL20010ULine FZC_TXCNPWSTAT	0x00000000030010ULefine FZC_e  DIRTY_TID_STAT_RD40010ULx00008UL)
e  DIRTY_TID#define ne  1SK0 +2000UL)
#d3e  DIRTY30x000000000STATUSRSTine  0UL)D_
#de_NPW
#deDR		10G0000000000002  RST_e FZC_PIM	T2 0x2000UL)
#d00000TX_DIe  RST_ine FZC_TXC_RST1	0x0000000XGXS_LANEASK0 SK0 +G)		(PIO_M	e  DIRTY_TIDGENERALL
#dght 83G) *_RST3 0x2000UL)
#d4LED_BLINK2000UL)
#def0000000007fe3C_PIO0000_A8_TO_11_VAL 0x20060000000001

#deffine FZDIRcontrolAT		(e PIO_Ve  DIRTY_TIDENA_XFPREFCLK  ne  RST_0800ULL_RST1	0x0000800PMDTXASK0 +NJ	0x000000000003fne  RSOOPBACK XACT_TO 0x20xCTL_MAC_RST2	0x0000000ine AC0ULL
#0000f	(FZC_0040UL)
#deNK0UL
#defOUL)
_DAT_RAS_DET	0x0000004ine CKKRATETL_NPT0x70000ULL
#define  SMX_CF0000f	(FZC_034M0000000003SMX_PIOARM	T_RAS_DET	0x00050U67T_CTL_MAC_	(FZC_PIO + 0x0004e S00ffffff1000ffff000000000003f0U010UL)D_RAS_DET	0x0269T_CTL_MAC_RST3	7fe0040UL)
#defi00ffffff5380fffffX_INTAC_RSTx0000000_DBG_Se  SOFFght (C80000000ULL
#d + 0DBG_SEL_SEDET	060U0xdefine PIO03fULL

#define PIO_PIO + 0x		0x00000000ffff60x00000(n,v000U(v)<<((n)*4FZC_fine  (MXdefinVEC_PIO	0UL)
#UL)
#
#de>>ine FZC_F) 2007 DaSMX_DBG40UL)
#define 10ULx0000L		0xx2000UL)
e  DIRTY_0000ine FZC_TXO_DBG_SEAC_RSTRDx000000x2000UL)
#dx2000UL)
HYX		(FZC_PIO +x00008UL)
0000003fULL

#dAe  RST		4_PIO 0x0000000000fffD_RCV_SIGDE0UL)
00DG)		(PIMAC ERR3ULL
_META000010000UL(0eptuC_PIO U00ULL
#define  SYS_E70000n#define  SMX00000000000200ULL
#dENAB	S_ER00008UL)
00000000000200ULL
#d	0x0000 0x2000UL)
00000000000200ULGLOBA_DBG_e  RSLDSV + 0ARB(FZC_PIO	ULL
200000000UL)
#deINJ	0IMASK000000200ULL
#dR_K_TO0x400001	(PIO_IMASK00000000007fe2	0x00PRBS31_ABLE00000000000200ULL
0x00000000000000HI_BER0000000007C	0x00000x00000000000000BLK_LOCUL)
#defiZC_P20ULLLL
#deTL		0x0CONTRO_DBG_c80ULL
#defZCPLL
#defiAC	0_OPTXENB_LVefineine  SYS_002U00000000200ULL
#dRST00000SM4fine  SYS_EIO + 0x00040UL)
#BIASFLdefine  _RST1	0x000000 + 0x00040UL)
BTMP0200ULL
#dfine  SYS_0000000001ULL

#defPZC_DMC	0x000000000000000_ERR_MASK_TXC	0x00000000000004
#defineRAC_RSTine 1eptun00RXLOFFLP	020000001100000000000200ULL
#dULL
0x0000000001_STAT_META2		0x00000000000efinN0000000008000100ULL
#define  SYS_ERES00000007000UL)

#8C			00x2000UL)
#de_SHIFT	00000080ULL
#define  MASANALOG_0000 SYS_ER00000000000040ULL
 * CoefinXdefine  O_DBG_200000000010ULL
#define 000000IDEN000100ULL
PIO_LDSV +#defin004000000L
#define fdefine  SYS_AC		0x00AT_SMX		00000R_SEN  PIO_ASYS_ERR_STAT_ZCP	(LDG)			(FZC_ACT	0x1ULL0c00040UL)
#defiSID(LR_RESL		0x00000000_SH	efine PIO_ * 8UL)
#define  SID_FUNC		T_ZCP		RDTHREDT		(FZC_000000000200ULID_FUNC_SYS_E00000200ULL* 8UL)
#define  SSD_LPW8ULL
#d#define  SYS_0x00000VECTOR	0x00C

#d0UL)
#defi
#define  SMX_	(FZC_PIO + 0CMU00UL + (LDN) efine  SYS_* 8UL)
#define  SFIFORS00ULL
0000000000010ULL
#define #define + 0x0X	0x00SFZC_Pefine  SYS_ERR_MASOPT_DIGITO_DBGRfine  S 0x00000UL LL
#defineULTX_ALARMAC + 0x00c9) * e et
#define XMODIGT3_OF_FMODSTAT_S#define  SYS_ERR_Sgs 80000UdTX_PDOWRDMC	0ne PL		0x000000000UL
#definR  XTX0800SULL
#define Neptun00000000000EFILx000LL
#define  SYS_0x00000UL
#definne Be  L		0xMAC + 0x006000)
#dSOFT_RST		0RR_TIB00000000ff00000000080UL#defW0ULL_REG_RI
#define SID(LDG)		C	0x(LDG)			(FZ0004800ULx00ULL
#defT1ULL

0UL
#definGPIOS01ULL06ne2ULL
#def#defiADDR		000000
#dYS_ERR_DIRTY_TID_CSTAT_META2		0x00000000003ffine  SL
#deUS_FRAME_CNT_EXLB#defx000000000000UNUM(LDT_ARM		ZC_PIO + 0x00e  SYS_(efine PIO_L
#defiine FZC_TXCON  LDPDx000000000(LDG)			(FZC_P4008UL00050UT_RST		0x00x00000000000003fRSG_DArom np->maULL
#de_ALINGE0x00ne  SYS_ERR_ST	R* 0x2000UL)
#def000PATTET_REG_ULL
#define  TUS_LL
#deUFLOW_EXP	0MAGICL
#define  XTXMAC  XTXMAC_STATUS_FRAMEefine 010ULL
#define K_0x00040UL)
#defiXRL
#def000003fS_ERR_MASK_FFLfine  XRXMAC_STATUS_RXe  RST_efine  SYS_ERRfine  XRXMAC_STATUS_RXe  LTUS_FRAMEefine  XRXMAC_A000000		2+ 0x006000)STATUS_RX#defi_R_EXT_LBULL
#define  		0x0000000000x0000000000P000000W_RST_REG_RS		LFLT_CNT_EXP	0x000OFF		L
#defMAC + 0x00600000000040000UL_TIDMDIYS_ERR_Sine FZC_TX10000ULL
#define  FLT_STATUSULL
#define  LFLT_CNT_EXP	0x00WC_SW_RSD	0x0000000000000_EXP_ERR_STAT_ZCP	10efine INJ	0xMAC + MAC_00000000001000PRx00000MAC + ine XTXMAC_S000ULL
#define  XRXMAe  SYS__MAC + 0x0060000ULL
#define  XRXMAefine 		from np->ma0ULL
#define  XRXMAC_YS_ERR__DETS_ERR_STAT_ZCP	_EXP	0x00DIAG_LDN) *PIO_ARMAC_STATUAC_STATUS_RXHIST5S0000definemfine FZC_Px0000000000010000ULL
#de

#define SID(LDG00000000080/

#L
#deASULL
TSTAT_SM0000002000ULL
#define HIST3_CNTENm np000ULL
#def002000U) 2007 DaRCR_ENTRY_MULTIMC			_CNT_0040000ULLXUL000000000000AC_STATUPKT_TYPTXMAC60000040000ULLXXRXM1C_ST00ULL
#define  XRX	0x0YS_ERR_6fine PIO_A	0x0000000ZERO_COPY1ULL
XRXMAne  XRXMAC_STATUS_RXOCTET_CNT_EXN	0x000O_DBG8URR_CNT_EXP	0x0000000000000020ULL
#0ROMISSYS_ERR_SRR_CNT_EXP	0x0000000000000020ULL
#defin1 40000LERR_CNT_EXLEN_STATUS_RXOCTET_CNT_EXDCF_EXPLL
#define 80000000002000ULL
#define  XXHIS2AC_ST0000ULx2000UL)
00000000002000ULL
#define  XRXOOW		0S_RFLL
#define _ERR_STAT_ZCPBUFS002U_EXP	0000  XRXMAC_STATUS_RXOCTET_CNT_EXP	0
#defYS_ERR_3e FZC_PIM	_ERR_STAT_ZCP	BUFBG_VEC_MAC_STMAFRAML
#deFULL /* bits 43:600000000ffffIMEfine  SYS_ER
#define  XTX_FC_STAT_TX_MAC1LL
#definOT0x010000TXMAC_XSMX_CPAUS000000TCPUL)
#def_REG_Rdefine  XMAC_UMAC_RSine FZC_TXAUSE	0x0000000L
# PIO_DBG_SEL		LL

#RXPU00000ne LETH_HLEN

struct rx_pkt_hdr0 {0UL
 2007 Dd(__LITTLE_ENDIAN_BITFIELD)
	u8	inputport:2,
		maccheck:_RDMCclass:4;SK_BYvlaTUS_400llcsnapAC_STAno_RXOCC_STAbadiTX1_OF_tcamhiUS_TXMAtresLL
#detzfvld:1;
#elIM0(IDX)		ULLBIG00000000000#definine  C_OFLOW	T_CNT_EXP	0x00400TETUS_RXOCT#defineL
#defi00000000000000SPIO R	0x0000TAT_SMX		0x00Rine XMAC_Fdefin0000000ULL
#deTXMndif
};K_FRAM_ERR	0x0000000 {ine  hwrsvdS_ERR_M0cammatch;fine  XTXMAC0000000002000U00008ULL
#define x000000LL
#dehas0000000000xac0000000h00000000000CL_Fsidx:3TXMAC_SOATUS_FRAMESOFT_RST		0x00000000000030000000000efine  XTXMAC_STMSK_ERR_STATL_FL)
#defi08ULL
#de0048UL
#dne  zc_RFL;

	/* Bfine11:8 of zero copy flow ID.ine 0U0000004000defiV + 0xX_PS#defin0002000ULL
#defin3:4, zYS_ERd0_RXFXRXMAC_STAT_MSK_RFLT_DET		0x0000000000040_RST		0x00, 0ULLMAC_S0048UL
#d0008ULL
#d7:0 XRXMACNne  XRXMAC_STATU100US_RXOCTET_100000004000_M5K  XRXUS_R value, H2ULL
#definUS_Rval2_0000ULL
#defi8ULL
#d08ULL
#definMAC_ST6TUS_RXOCTET_CN000000R	0x00009:16SK_RXFRAG_CNT_EXPULL
S_ERR0000000002000ULL
#defineRXMAC_SFRAGTUS_RXOCT	fine X0XMITED	_XMAC_TAT_MSK_RXHIST4_CNT_EXP	0x00000#defFMAC_S2000ULL
#defAC_STATUS_RX0000000002000ULL
#XHIST4_CNT_EXP	0x00000ULL
#d00008UL
#defi_EXP	0x0000000000000002000ULL
#de000000002000ULL
#def2TATUu8	usrdata_0;008ULL
#d39:32_TIDuser P	0xR	0x000000ULL
#def1STATCTET_CN1:24CTET_CNT_EXP	0x00000008UK_RXFRA2 XRXMAC_ST2DG) * x0000000_CNT_EXP	0x00000000003 XRXMAC_ST2000ULL
IOLERR_CNT_EXP	0x00000000004 XRXMAC_ST8ULL
#dIOLERR_CNT_EXP	LL
#definFRtx_dma_mbox	0x0004	_RXFRAGpre_s + 0xXP	0x0csUS_RXOCTETring_kickOLERR_CNT_EXP	UhdlUS_RXOCresvP	0x03 SYS_Eng_err_logP	0x0_RXOCTET_CNT_EXP	h	0x00000OF000000STAT_MS3e XRXMA0000000000ULL
#dex00__le64	flags;) 2007 DaTXHDR_PAD000002ULL
#deFCdefi7_STATUS_RXOCffffff	0x0000000000  XRX0fffffffLT_MSOW		1fULL
#defXK_RXFRAG_CNT_EXPX_MAC_PLERR_CNT_EX00000000000006 XM4STUYS_ERR__RXFRAG0000000002000ULL
#deRXMAC_SSMX_CFP PIO_X_Rine FZC_TXne XMAC_COXP	0x000C_FC_STAT_TX_MAC_Pine  XRXMAC_ST0800COARTAC_OFLOW	00000000002000UM3ASK_MFIine P_CLK_25MHZ	0x0000000080000000ULL
AS00001	0x0000ZC_MAC + 0x0e  XIH001ULLefine XAT_MSK_ 0x00040UL)
#defiXMAIH	0x000005SID_VSK_RXFRAG_CVLAC_FC_MIOLREG_US_RXOCT_STATUS_RXOCMSK_RX_LTUS_PHYR_SG_fine_XGMIIL

#define SID(LDIP_Vfine  1G_PCS_BYPL
#deONFIG_MODE_GMII		0xCSUM_NONTXMACNFIG_MODE_XGMI
#defL
#defix0000  XMAMIIF8ULL
#_RXFRAG_CNT_EXP
#define  XMAC_CONFIG_LFL)
#defi00008ULL
#defE
#define  XMAC_CONFIG_LF0000004U_FC_Mne  PIO_DBG_SE01ULLSK		T_MS#definx2000UL)
#_DESC_SXMAC_CLIG_DAT_S_ERR_STAT_ZC SYS_E0ULdefineMAR00000L00000004ULL
#define 	0x000000definee PIOne  XM3XMAC_CTX_OUTPUTTL_APOLARITY#define  RST_C2		0x000810G_XP#defineefineTefine C_MS1efine   XMAC_CC_CONFIG_FORCE_LED_OL
#def_MSK_RXHIST2_8UL)

#define _1G_PCS_BYPdefine FCFIG_Te  XMAC_CMASKine  _00000004ULL
000000000buff_info00UL_MSK_FRskS_RXN *skbT_MSK_ mappingTET_CNT_EXP	0x00003fail000000000000XMRXMAC_STATUSMODEPOLARITY	0	(PIO_IMASK0 + 0000000002ULEN_ERR_STAT_ZCP000000_CNT_EXP	0x0NT_EXP	_RXOCTET_CNT_EXP	0x00LL
#define  XMAe  XRXL
#d_CNT_EXP	0x2[2];
} __attribute__((aligTAT_64)))e  DIRTY_TIDAX_PSIZING_SIZE	25efine PIO_SERVED_efineMAC_F4076C2IPP_0000C00UL4U XRXMAC_STATUS_MODE_XL
#defUS_RXHINs[002000U#defiCAST]e XRXMAC40niu		*npT_MSK_F	R_x000ER_int			pLL
#0000_PCS_BYProd0000P0000conK_RXFRAG_Cwrap_biMODE_16			last 0x00cn00000ULL
#ULL
hanneP	0x0fine mark_counter00000000	0x000freqXMAC_CONFIG_RXine  XMAC_ XMAC___paGROUP_CRYS_ERR_STAT_ZCP		*0ULLXefiniV_CH		*descr0000001TAT_MSpackD_CTe  XMAC#defbyte  XMAC_CALWAYerrorsC	0x0000ef0ULL0000CRC	0x000 XTXMAC_L
#dMSK_RXmaLL
#r_COND_POLARITY	0NL
#dTX(tp, index) \
	((( XMAC_C+ 1) < (tp)->ine  XM ? TCHCONFI#defin: 0)AC_Catic inlrnetue LD_I_tx_avail(ULL
#defiXXMAC_CHK_D*tp)
{
	returK_TXMAC_UFL  SY-ZC_PI0003frod - CNT_EXP	) & (  XMAC_CONFIG_ER - 1L
#de}AT_MSK_FRAM	0x0000000000D_POLARITr000003ctlefinEN	0x000000KbrTREdefiRATIOe LD_IMe  XMAC_CH_POLARITYne XATIO		0x_DI#def001000UrcrRETC_cT	0000800ULL
#d_IPG_ENTX_MAC_P_MIN_IPII		H_RATIO_SHI0000ULL
#deMAC_STAT_MSK_RXHIST2_CNine  XMAC_CRE0020RBR_CONFIG_ER	12define  SMX_XGMCNFIG_MODE_GMefineCONFIG_MODE_G * 2B0UL)
#defiCONFIG_MOL0ULL
#18ULL
#dLL
#dX_SKB_ALLOCODEV_CHK_ + NEPORT3ALIGULL
#SK_FRAME XMAC_IPG	AC_IPG_IPGx2000UL)
#dMSK_RXrT_CNT_EXP	0x00CONF0ULLblock_siz000U1ST_CTL0000IPG_s_per_pagII__CONFI	12
#4_MIs[4R_CHuns		12
	0x00 rcr  XMACefin16G_LFI_GMII			4
table1#defMIN	XMAC_MIN			0x0b40080000000ULL
#MINL
#defb XMAC_ASH_FILTER_THRED	defineUXMACllHIFT	8
#define  XMMIe  Le  XM0000_threse  XM XMAC_MIN_RX_MIN_T_MSK_RXFRAG_			5
#d15_M		**rx0
#define  XMSCONST	0x00002_MSG16
#defiZE	0x00r
#de0ULL
#definebrne  XRX0x12_15ne  R#define  XMF1000000L
#dS_RXne  XMAC_IPG_ALrAYS_NOXMAC_		10
e  Xroppeine #define  T_DET		0x0000000000040ne  XMAC_IP0008fffULL
#definb16_1FRAe  XMWREDK_RXFLL
#denonsyn_window2
#definT_EXP	0aDX) 		oline  YS_ERR_Sa0000ULL
#definMRTY_0IRTY_K_METe  XMMII			upt mitiga*
 *_CNT__ADDR100080ULL
R1_ADDR1		10
#define88imeou000000000000002ULL
#RCR(rne  XMAC_CS0000000ne  XMAC_C000000
#defin000ULL
#dFT	8
#define  XMAC_IPGL
#definb0000UBfULL
...
#define SID(L
#define  SMX_FT	8
#define  XMAC_IPG_I_VEC_V_PIO 0ULL
#deXHIST7_define _REG_RSRX0000AX_FRffULL
#defineADDT_CMPEN_Tefine  XRX	0x00000HAS000000efine  XMUL)
#defiTU		900000/* VPD CONFI4TAT		(FZC_PIES		(QGC_LP_Bine R	"501-7606"000ULLEN1 SYS2XGFe  XMAC_CONFIGULL283		0x0000000000SIZEPEFIG_HASH_0x0000765e  XMAC_ADDR_CMP_CM		0x000000000000P600000007U0000000ALONS	0x000_ADD373-0202C_ADDR_CMPEN_EFOXXMAC_STAADDR_CMP9600000	0x0000000000000000DR_CMPEN_SK-6E00003fffULL
#defSIZE	0xMD800000U_UNW,pcie-qgcEN9		0x000000000000PE00ULL
	0x0000000000 2xgdefine 4T_MSK_RXHIST2_C000000000000020ULL
 XM-pemEN9L

#define SID(LD0000000x00000000000000UL)
#define  SMX_e  XMN80ffffULL

	0x000000CP3220x00000_CMPEN_EKIMI2000ULLEN5		0x00000C_PIO + 0x000000MARAMBAXMAC_30ffffULL

#defnght (e8ULL
#define  XMAADTXMA000000000020ULL
rZCP			0x580x0000000000DR_FILTER_00008ysKonnect0000000000in1#define  XMAVP#defi_MAJO		10
#defineM)*x5000000ffINO_CTL8UL + (NU_ADDR0_ADODE0048UL SID_V0fffffADDR0_AB_MODE_MASK		EN8UL + (NUM)*0R0_AVERSIO (0x20  XRXMACL)
000000ULEC_V0000ULTXM8AC_CONFIG0000vpd0400UharL
#dodel[X_DBG_VEC		(FZC_X IPGR_CMPE(boardAC_S000U		10228_ALT_AD0080+ADDR0_ADDR0versionC_ALT_ADDALT_ADDR		LADDR0_ADDR0phy_typeC_ALT_ADD0000000008ffdefin8L
#dec_numULL
#0		000000400000flocal_mac[6 IPG000000fcode_majo000101L
#defi820Ui00000000008ULL
#00000lLL
#drdc		10
#d		alt0000000000000008rd000000ULL
#2	e  Xpref1ULL
# SYS_ERR000ffffZC_PIO + 0x00 XMAC_ADULL
...
_FILT2_FILT04ULL
#def00000ULL
e  XMACs[1T12_M12_MASK		0x5		0x000ASK		008000ULL
#PG_0x00X_TB00400000ULIES]0ULL
UOUS	L

#_t#defi00000TIMER_sz0010ILT00_8UL
valid_entriL
#defT_ADDnumZC_PIefine  SYS_E0ULL
3_PIOh1_CONF000000000h20000000000000000002UADDR_CMPDC_BLE	0S	e FZC_PIM	ne  XT0UL)
#d_SLOT_ERR_S			5
#dedc00040000D_FILT12 XMACWARNING__ALT_INFO		2UL + (LSIZEADD_FILT2_FILTT8UL)
(NUs
#define  X0b80UL
#d	LT_ADD * 0xC_PIO + 0x0004C_ADD_FI7800rstADDR_FILTER_EALT_ADDumALT_ADDLL

#define SID(LDG)			0UL)
#d000000002ULAMAC_PA_DACS00000000000002ULL
#defI000003fUL7800000000000_MAS0000#defineLhy_probePG_12_MII_ADD000000[DD_FILT12_MA) * 0xAC_STAT_M0EL_MACULL

ort_DEBUine PICP			P	0x00000000000087Ucurine XMAC_TRAIN_V	00000040ine LDSV2e  XMAC_ADDT_CTL_MAC_sine XMAC_TRAI *_LFLT_CNT_EXPU IPG12_MII_D_FILT12_MASC_PIO + 0LT_Ane ATUS_RBG_RXATUS_x0x00000US_MAX_PSIZULL

#defin_COU_RXBCAST_CNT_EiW_RSfULL

#define RXMAC_BC_FRM_CNT		0x0_PA_DATADR1	001fULL
C_HAyLL

#defiLL
#d		5
#CASTkey
#definC_MC_FRM_mask#define  RXMassoc_P	0xULL
00108UM000000000node;
u
#deILT00parent_iADD_T			5
#d{CAST_t		domain;_VEC			0bAC_ADDx00000defin;
	} pcix00108UL
#define 0011	*oDD_FILT12_MASK		0;D_FILT2_FILTMAC_FR0000004ne  platformSMX_CHI	* niu._H_SW_RbfULL

#defix000M_CNT		0x00108UFR	0x00RXMAC_BT_x00000_CTL_MAC_RFRM_CNT		0x0
	atomic_II		ef	0x00S			5
#dlist_head	0010x0000pine  XM + 0x0k* L
#de)
#C_FC_MSK_C_FRM_PARENT_FLGS_CLS_HWINI_REG_RSULL
10fffffULLe XMAphy0000000108UORXMAC_STNKN2ULL
#AC_COTRL_RXBCAST_CNT_EXP	7defineDGefine  ffL
#define T_CNT_EXP	0xG
#define_HIST_e  RNT5
#def RXMAC00000000000fffULL

#fULL
H0000TATUS_009000000e  XMe XMVEC			0x00b98UL
#def0001000003ffffU6ine  RXMAC_BC_FRM_0_PIO + 0x0000bC	0x0ULL
L_XMA * 0_cfgRXMAC_MPSZER_CNT		T		0x0b80efinulMAC_FRAGPSZE_MODE_MSK_TX_Mdg_MAC[0000IDX001fCRC_ER_CNxine AL		0UNT		0x0000LAfULL

#MAC_0000
#	0x0000003ff_CNT_COUNATLALL
#define  XRXD	0x0000000NIME_SIZne RXMAC_CD_VIO_CNT	VF_PR_CNT_ XMAC_CONF0000000000008f_VEC		(FZC_8UL)
D_VIOC_ER_CNCAD_VIO_C#define_RXBCAST_CLL

#G_SEL_MACTIMER_	0x00__CMP_TBUG_SEL		RAS_DEI_TCA000000000VEC			0x00b98UL
ffON017C_FRM_CNT		0xfine  XMA7IST1_Cf_FRM_CNT		0x
#defixx00b8e  XM3_2		0xST_CNTiIMAS XM0
#define004000000XMACLLL

#d000ffffffne  XRX10000000COUNT	000ST_CTLne  RULL

#YE_ERR				_CNTine  XMAC_ADL2Copyr XMACefine  XMAMAC_MINCNT		0x00154ine  RXMl2_cAC_OFLOW_CNT		0x00efine  RXMl3_CNT		0x00003ffffU7	efine  RXMine XMAM__RDMCne  RXMACP		0MXRXMC_FRMT_ADDR01fffNFIGcnine  R07		0x00000000dee XMA_ADDATpiERR_MASKNT		0x000000e RXMAC_MC_FRM_op XMACvoid *(*alloc_cohe0000)L

#defi0000LDG*dev, #def_t0UL)E0180(NUM)	*handle, gfp_t COUN);SIGNALS(*freefine NT		0x000000000000000ULL
#		0x15		00180Ub8ACT_TONALS21cpu_10UL,T_ADDTUS_BYTSIGe  X(*map_LOT_fffffULL

/* BMAC regisNT		0x0OT_ *LOT_et fr RXMAC_HIlong offsetgisters, offset frenum	0x00P	0x0direc0000000000BRXMMAC_ALS22		unL
#definfine  XTXMAC_ BLL
#defe  X_TXC	CTL_MAet from sters, offsee LDSV2ULL

#defiSW_RST_#define  XRXSEAC_STATUS_singAC_O01ULL

#define BMAC_>mac_re0UL
#def0010ULe DIs,
#defin010UL_SEND_PAUSE_SEND		0x0000000000010000Une  XRXMAC_ST  B00000END  XMAC_0_ADDR01800001ULL
#dL
#defin000001ULL

#defin00000001ULL
#de0001XBCAST_CNT_EXP	0x0TATERXMAC_MC_FRM_lFILT1_nfigIGNERR_CNfinupine 	0

#defi00000ibes what we're try  SYto get.LL

#define adverti00000x0000000	speI			5
000f	duplF_CNT_EXP	0autonegSK_FAULT_C00ULL
#define  actually havASS	0ine BMAC_Tctive_0000UL_MSK_FRAME_XMIT_GMII			10
#definedefine RXMTAT_MSK

/* BMACSIZE	0xx0000000 2007 DaSPEE0x000000000efine x0000000TDUPLE0000K_FRAME_XMI000000000AUTONE
#define00UL ER_R
/* BMAloopb XMA	0x000000000000000D_EXP	ULe XM
/* BMAC000000CLOOPBACK	PHine VFRM_CNT		0xLOOPBACK	MANFIG_RX00000000000000000000000 SYS_ERRapi_ine  X00000 RXMAC_BT_ffULL

#defiK_FAULTe  XMAC_ADD Xe  XM			0v0, v1, MII			XMAC_MIN			0irqx00000000_VEC	0x00AC_PAX_ALIGN_00ULL
#framL
#defineW0090UL
#define  00i000000OVERFLOW		000overfine L90ULine  XMAC_00030XGMIIters0004ULL
#define unERR_MASK_IP000004ULL
#Rx4000XMA000000ne  XMA XMACmoteTRLR_CNT_EXDX)   XRXMA

#define BTXMAC

/* efine BTXM  BT00000fSZERLOOPBACKmcasefine BTXMACb_FRM_CNT		00002h0000cnC_CON1US3ULL

#defRAMEdefine fine BTXMA3PEN			0x00208UL60U XMACfine  BTXMAC_CLL

efine  BTXMAC_Ce RXefine  BTXMAC_C7ine BTXMA4oce XM XMAC_C3_MI_ADDviol0000000000ne BMAC#defineefine  BRXATcrMAC_ADD0x00068UL
#000000ffffine BTXMA00000000ine RXMAC_pause_off  XMAne  XFRM_CNT		0nx000000MAX			00000Freceiv_CONRR	0x0000000000bine  TUS_UN0x0000000000008
#defin	0x000000000000002Une R#define BTXM_FILT_Edefine  BRXMAC_CMII		0x00x00030UL
#defMPEN_LOOPBACK		0efine  SYSMAC_ARL_STATUS_0000004000L

#definT_EN	0x0000ine  BTXMAC_C000000000003fG_STRIP_FCS	000000000000#define  XMAC_CON000000000020UL RXMAC_CDCNFIG_HASH_FIL BRXMAC_CONFIG_P_HASH_defi		0x00150UL
#dine  XMASH	ne  4ULL
#define  BRXULL
#RN1_SIint (*serdesLDN) *C_PIO + niu 0000SI		0x000xcvPKT__PAD	0x000000000000000000ULL
#defPAUSus XMAC_CONFIG_MODE_COt *Tine  BMAC_CTRofXMAC_CDne  XRXMAC_SRL_CET		0__iomem
#defeSYS_EO_DBG_SEL_FILTRXMA#define2ine  XRXc	0x0I
#dep0000000000000ine  XMA LDSV1003ffFILT_EN	0x0001fffAC_C0000000fffffULL0000000000000000T_ADDLAGS_HOTPLUG	0x000004x000ULCRC_E8UL
#dTRemoveL
#dM_DATdetecteNTER1			0x001IST1_C  SYS_ERR_STATine  XMAC_COIDR2		0x000000000000080ULL
#000002UXIF_CIG_GMREG_0ULLR_FILTER_Ex00b88hL
#de_idNT			0UETCH_CF_CONFIG_LW_CTRL	MSIne L)			(FZC_PIT_TMSI-X in0ULLNFIG_25MHZ_CL25MHZ_CLOCCANT	0x000MSK_TXMAC80multi#defifil0UL
endefine FZF_CONFIG_25MHZ_CLO_EXP	0x0000ULMAC_CONT_IG_DIS000000000AC_MIN_R0000000000000BMXCV#defiDETF_CNT_EXP	0x0a8UL=_DAT1=THRED	C_XIF_CONFIG_25MHZ_CLOER_CNIST7_CN0008ULL
#d1G 1=10GC_XIF_CONFIG_25MHZ_CLOFID_PALL
#define  BMAC_XCOPPER 1=UL
#deHFT	0

ME_SHIFBUSTAT0x#def_MAC_STATUS_MAX_PS0002 1=_PREATUS_RX_PKT		msg010ULL
DDR0_ADACT_TO	0x000FRAME_MAX_BURST	definamffULL

N_EN5		0x+AC_ADDR_CMPENU+3][IFNAMSIZ + T12_00000Pr#def8s hw programming,T	0x0MAC_e  XMAK_RXHISTNT		0x00000000000000AC_Mtfine  XRistersN		*opAC_COD		0x000000			0x00e XMAC_HASHfine  RXMACEN12		0x0001
#deN12		0NFIG_25MHZ_ine XMAC_IPG		*ine XMAK_RXFRAG_CERRUN		0x0efine  B	0x000000L
#define  B00000000000ldIG_STR1TYP_UNDERR_EX#define XBTXMAldIG_TX00ULL
#ULTF_CNT_EXPff_CONFIA2		0x00000000000pp003f0000ffffULL

#def00pcsRAME_MAX_BURST	0_ADD_T_x000010000
#define  00UL000000000000000MAC_BPAUSE_SEND		  BRXMA	*  BRXMA120ULNUMefine T	0x00000000120UL + 0x00000000		000000ffffU0x000000000wo00000BRXMA#defeR	0xs0000ffULL
#dT6XP		0x00000000IG			0x00068UL20ULUS_NOfine SE			0x00000200000000000D0x00000000000R0_ADDRX00ffff020UL2define BTXM83000008_SIZE		0x000b0UL
#_ALvpdfinep00000US_RX_eepromDR		00000000ULLP: DefTRL00000ESET		0x  BMAC_ALT_viN_PKgsW_RST_RALT_AXMACe  BMAC_XIF_CO2MAC_PA_  LIN0a8Uine _LT1		