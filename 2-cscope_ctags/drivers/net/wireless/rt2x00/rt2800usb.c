...
static struct usb_device_id rt2800usb_device_table[] = {
	...
	Copyright (C) 2tttp://rt2x0Forge Project
5<http://r prog.serialmonkey.com>

	This004 inwell009 redistram is fre5a57ftwar280you can redistribute it and/or modify
	 program is freGeneral Pub	ic License as published by
	the Free Software Foundation; either 3ersion 2 of the License, or
	(at your option) any later v	This5257you can redistribute it and/or modify
	it uyxem istermsogram isGNU 0586ftwa3416ic License as published by
	the Free Software FoundatieHANTABILITaic License as published by
	the Free Soft0, }
};

MODULE_AUTHOR(DRV_PROJECT);ved a coVERSION of
	s distreither licDESCRIPTstri"Ralink RTonkettp:/Wireless LAN driver."h this proSUPPORTEDram is f, write to t7e
	Frechipset based cardsn, Inc.,
	5 redistTABLE(usb, lmonkey.codevice_tabl either licFIRMWARE(fic rout_0, Both this proLICENSE("GPL
 */
static struct ct: rndati	Abstracrc-ccitt.h= {
	.name		= KBUILD_MODNAME,
	.idusb de	=h>
#include *
	Copyr deherdprob
#incredikey.colude #incdisconnectlinux/kernel.de <module#incsuspendmodule.h>
#insb.h>
 ...
 * (void)
{
	return/crc-registbute it and/orude <l);
}*
	Copyr.ncry __ex* Allow hardwodule = 1e tha <linubled.
009 nclude h"

modparam_nomed(noware e_param_namRM_D);d a coPAed(no_UGO);
Mamardw);
