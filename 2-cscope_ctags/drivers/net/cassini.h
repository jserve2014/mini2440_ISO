...
static cas_hp_inst_t cas_prog_ip4fragtab[] = {
	...
	{ "IPV6?", 0xffff, 0x86dd, OP_EQ,  1, S3_IPV6c, 0ini.hCLNP,
	  LD_SUM, 0x015cassin0x0$
 * 000},
	{ ",v 1 cont?"cassf00 Exp 6Micro$Id:cros32004/TCP6416 2004/08/17 21:15:FIDcass484Exp cassiExp ffff}, /* FID IP6&TCP src+dst */ Defiernetor Sun fems sy06ems Cxp $
i18) ethernSQ driver.
 *
 * CopyrLENcassi3f004n (astems system03 Adria seq",	/* DADDR should point to dest por)rive3 ng.com.Exp $
i.ising.com(river.TCPFG, 4lished by th15:1EQ * Co0x081ni(+) edistribute is InLoad /orassi #Generand/orons frol flagsun (aublic License asassiprsioree SoHL drieral is distriST_FLGr ver4 Expe it wsion002of theassi
 *
 *y lat (at your opleng * Tuseful,
.
 *assiThis programin the . driver.NTABIL* CopyrReith0x20ll be useBn redist it andcenseeven ptionthe implied warranty of
 * MERC1_PCKTilsd warranYou* CopyrHDRhe imfu cathe implie 2 of 03 Adni4 Fragmesion.
 *
 * Tfor more detau shoul3_FOFF if not, write* Copyright (C103ut WI GNU Gented iPthe
cd wa 4e
 * Fc GeneraAde - frag off* Thlong with ty of
 * MER;e to the Free s ofion,Free SoftwarFounit wi0004 Sun  * Fofff8 PrsionCleanupalong with this program; if notd have rder thehave receIM_CTtribx00PARTe useful,
 *01ssini)NULL },
};
#ifdef HP_IP4FRAG_DEFAULT
#dlic e CAS_HP_FIRMWARE 0x100b (Nationcas_
 * _ip4MA
 tab
#endif device 
/     Alterna(Sunable which does batchi07, USAout reassembly
rive  are aUSE venIP46TCP4BATCH
statical Sehp_inst_te aremiconduc6tcp4ds: 0tab[] = {
	ace PROGeton) m 0_PREAMBLEe
 * GNU Ge* modifyhe
 underMicrotermsal Pion, Inc., 59 Temrsion.
 *
 * This program 1e Softwad in 32-bit mre .)
 dtiona;              0eral P WITHOUT ANY e, orNTY; withoutiona) anWARRAthe implied warranty of
 * MERCy spa hopbuted i Licen+. e thathe
 w * Tpear in cax100but WITHOUT ANY WARRANTY; = Saturnneralion,implied warranty of _CAMERing.comILITYG_PLUS_ addc acce PARTICULAR PURPOSE.  Seses ITHOUssini register map: 2M memox01 = Cassini
 *               0x02
#d       i rev 2 _CA: 0x0bit words. there is seti  33/ bi330, Bost *urceirds. eightsx01 =sing.comse, o if rx weight0x02iter. e.g.urces **/
 if rx weight ==10iter. e"Drop pack11-1307, USAd warranvendor idin aB2ht ==30

/** global resources **/
8appearmoryExp egister maaddr= 0, rx == 2x tx tra5MHz d warring.com+ 0.2un to access the pci 00b (Nationak domains:
 * PCI:  33/66M id: 0x0e pci 0035 Workarsiblfine d tx weight2re icrip Suncorruaddref
 *blem. (DPDnd robin a3sferSaturn B **/ _CA, * Ghe ws cassSAP_H

a known /* data pat065/0+ 0.all*fine is  /*gs ar11-1l* 0211WORKAROUND *fine3:2]re two clockk domains:wSHIFT, rx66MHz      { "   0x0 arrival (as(asual P
 *
 * ThisNP,  6ci buVLAN* map: 0x0 = x1, 0xCL_REnly
 3here  Sun Micro2004/ter mape sid bursts atrib81 * This prog.com)_CFI memory 8023 tx weight == 0,4a
/* cassini register mapCFISun (a1sion.
 EG_INFesIFT   phelin
 *
 * even  _CASSargedeSINIined* = x4on.
 *f packet :03 Adion,or transfer ansunrisingL      /* iLLC,         IPV4 (Su tran enn)
 *reg */+ 0.2u
 *   INF_BURLLCor transfer anaaaaITHOUmax08  /* iLLCcrx weight == 0inte_MASKs [0-9] [3:2]uto-cleareds of0 when cd burstsn@darks3 * This prog2top levelcated ipts [13 - 1813 - 18re cleat
 * that _CAion,x1 = xvelN              8ine CASis read. se#defILITY oht ==6 tx weigSAPributAE
/* cassini register map: V4ptionSun (asetion r45nrising.comher ared0x0Fowed by 
 *
 * Copyr16 zaume0Thts gth of packet NF_BURnit, tor)Sun (a3        */
# busis read. seMHz t drivesc ace set
			 Ince; yoe can rehe hopREG_he
 * GNU 4cleareR0e CA 0-9] 6, rx == 2x7REVus.
x0C 
 * M          0x00ITHOUFou829 biis] aris
 * setIFT Place -tware
 * F 330, Bostts [or translic and6d/* Cassini(x weipts [frameKick == TX compl			     nll bred from host queue to
	iolenun (asrsion 2 of thas
 * pubs Inpts [00CX_TAG_
 *
 * CoIM_ID_REVP128 all xmit frames xferred				 E         rsion.
 *
 * This programe wrian            0x0000000ete. if Genean redistribute iple Place ftware
 * F 330, Bostriann (asmpletion re  0x1   .com)TX_D		, rx =TX        0x0000000000002  /of tl xmit frames xferred in _CASS/* corNI_H+ 0.2u
 *_CASSInking
/ of packe    PACED_map: 2Mowed by m= x4emory space arosyy sp theCAS_ssi)
 *his pr space words.RR_DIS is no i/o GNUt						 . REGdefinresse* [3: _CAsh * thbetwee. t_TX_DONandFO tag f+G_ERRO02
#defin       on* ri*iAR PURPOSful, _CAb. REG_MINUS_ addresses only appear in cassini.
 */
#define CAS_ID_REV		       ri		pletion S FOR AID_REVPLUS       0x10
#define CAS_ID_REVPLUS02u    0x11
#define CAS_ID_REVSATURNB2   0x30

: 0x0 = x1, 0xivSIZE cop     * cassini register map:hted round robin arbiter. e.g.,
 * if r
 *
2_DONE    rin2MASK * thu     PACED_ auto-cleared torf th00000100 2ound robin arbiter. e.g.,
 * if rx weight == 1 and tx weight == 0, rx == 2x tx transfer creT: 0x0, SIZE: 5 bits
leared CAWREG_CAWR	               0x0004  /* core arbitration weigs In[4]free
/ CAWR_RX_DMA_WEI [3:2] */
#defENCRYPTR_RR_DIS, rx == 2x tx t transf  encrySK   TR_RXifts [0-9d, BIMbe desenN              
#define > cachelu
 *size.terrup00000izesgramt enablSoftINTR_TX_f* foret for
		MA_WEIGmpty */
#deffine CASis read. seallow_TX_TAG_nfinite btlace Cassi xfer cassini register#if 0
// 0.2u
 */* 02 FIND CFIEIGHTIfSUMMARgo_H

S1_DROPX_TA//_ERROto 0 whS4] */     0x0000040			 8X_TAG_E to
terrupts [0-9] are auto-cleare
	00, id: 0x0 auto-cleareset,MARYH        0x000004000000001UP1 (ignore     _Snd_H

host)., 59 Temry interrupt bit. this
					when d bit will beinterrupts [0-9] are auto-cleared to 0 whST_ENH        0x00000400t. th/*ts [0-9]
				* plicated ipts [13 - 18] are cleared at
 * the source. bits
					 _CA   PACED_     ad. sens:
in [19 - 31]
 * DEFAULT: 0x00000000, SIZE: 29 bits
 */
#. tx       0       PACED_3rupt splicaG_PLUn [19 - 31]et size.
Lxferen d#defi, SIZE: 29    nmasauto-cleareary inTR_STATUTCH        0x000 */
#       ts [13 -ini.4		    fine CAauto-cleared toTR				INTMe thresh control statdefi1STATUf    IN/ed i MEor
			       0x00 to post 				* th25MHz     queuSun x00020000  /*TX FIFOleast 1 unmasked interrALLCH        0x0000040
#defin2STATU] */xmi 125ames* MIF stain at least
						      . i.e.,t least
						      ESP /* TX    0x0000x00020/* at least 1 frame xferren		      x00020000  /*also emptyleast 1 unmasked interrable thresh     set */
#defin4_STATUnyINTR_MI000  /* PCI  txx00020000  /*    1 unmasked interrupt se	   ERRORX completion
						  bit w	      1tag 0x00ingx00020000  /*HT_MASKed. FATAL R_ERROeast 1 unmasked intR mask for TX completion
						0  /TATUt least 1INTR_MI xferred
						      from RX FIFO to   INTR_P@@@egistmem.x00020000  /*R        0ster ha updESP6.2u
 *      may be delayed by rec, 59 G_PLoREVPst mem.
						      RX     lINTR_ERRO|US | INTR INTR_ERegistery PURdelay      recvx00020000  /*int/* 14:H
#define _CASSINI_H

/* cassini registeFF0000e.
	 = x#define    I2_HT4] */x30 t   I.
						      RX Kick == RX complete */
#define    INTR_RX_TAG_ERROR           0x00000016MAC_CT8L_STATUS        0x000MAfield  corrupted. FATAL ERROR1*/
#dmmabSTATUS | INTRCOMP_Fni+
 completion
						8      nos progroom0x3 =TX_TAG_ERx00020000  /*r         stides TCP
		s             INTR_TX_TAG for
			incrs at least
					almALIAreachINTR_TX_TAGex00020000  /*m; i INTR_PCS_STATUS | INTRBUF_A for TX complet_PCI_ER1	   /* l      a  leax00020000  /*
 * MERman)
 *threshold #0x00ht   00, rx   02xstatmpty */
#cred020000  /*hwRPOS INTR_PCS_STATUS | INTRyout AFleared are those srrupts [0-9]0020000  /*PACost queue tiuring  0x0ts next   CAWto						            shoul  /*== 1 and tx weight == 0, = x4zaum3
#de8interrupt "No IAS.ound robin arbiter. e.g.,
 * if rx weight == 1 and tx weight == 0,e as east 1 unmasked interrupt
	SP  hea fies thSERRORhas ati register 						  32S_CLEAR
 * DEFAULT: 0x0000000AH4,x1 = x2,egister21,0200st 1 unmasked interrupt
AHni.g ABS64 cycle
	*/
#AHR_DTRTOit. this
					30x02    /* delayed xaction ti, SIut */
tasked
				 AULT set retry af
 * 2^15 crrupt s*/
#define    PCPCI_ER6ed by[3
CH        0x00000ght == 1 _STATU interruxacG_ERRtime6ine    PCRR_BIM_DMA_WRITE        as REG_INT_ALIAS.C_CT32IAS_CLEAR
 * DEFAULT: 0x0000000M_DMA_READ   wriR_BI */
#dWRITe threshon;  */
#deBckseived 0 count DMA wriR_t9] aq          unusno morCasx    ed byo     #deferror* BIM received 255x00000400  /*20   IMassinne   0 count DMAA_WRIas at
						 . */

/* mask for PCI status eve   PCI_ERR_BIM_DMA_TIMEOUT     0T: 0x0, SIZE: 5 bits
 INTRLE      of descr spaces for hw
						      use in completio. */
#dltatu CAWR_RX_DMA_WEI_RR_DIS               domains:null* if e {				}mable threshold i+REG_CAWR	               0x0004  /* core arbitration weigconfXR_BIM_     phy typeses on       X_DMA_PHY_UNKNOWN/* coreletioto-cleared _ERRCFGSERDES/* core  any_PCIMAC_/skedservedMII_MDIO0  /* res2rved_RESERVEDMAC_ST those 21  /* res4rved */
#define    BIM(x)/* core ()
 *& (fine    BIM_CFG_  |01   /* reserved_6)) for
	RINy inDEX i [4] *indexHT_MA4] *rdefi DMA _H
...
/* i*/variousauto-srupt(DP8. NOTE:t */ng f buncr paralignne  corrstraints4-bit */
   BI. toCAWR_ealine  es on, i just.
 *oc    * resetoUS_A    Cpace si* th(DPor
		c     NABLE rtas Rrparity mas : */
#INTRDESC     youtSERVmasmM_CFbe 8KB+ 0.2u        TSERVtarS       2uto-cleared rom MAay behang_RTA_Inumbers,    cognizant  /*how0  /*/define   willed */
#SERVEn INIT_BLOCK as wellill se_CFG_RESERVtaT     )_TO_S)
 *6(32*(1 <<able))	         OMPA. unusedM receive12866MHZ            _ERRTX_1      unus bite4 DMA 511 an8kg ABS64 cyclRded          ED1            0x400   /to-cleared10000  /* MRROR_BLOCK 2048 = 64k:fine _CAbe 4x rx#define    PCIreif (n   BIM_CFG_PERROR_> 8) || */
#define    INT32 < 0)
#mask e00000000, SIZE: 32 S       * RX FIF0     8fine   /* bl (            PR_ERR_AC_C DMA. STR_SM_MASK       Gbit. this
					_SM_MASK       IM Diagnostx000auto-cleared _ERR_IAG_MSTR#             d0x3FF   00 /T_SM_MASK       trollED_Mta* saT_SM_MASK       e bits [21:0] */
#define    BIM_D       N_TXT    o-clearedissue ax0 = MAXW */
#T_RXtop B/*HT_MAQoS */
#define S* reset. AS.
  in ue a globaalmaskedset.*/
#dcT_TXraminSW0 /* PCI mas poll umpletion.#defi== 2x tx tranry iHT_MAipsecdINTR_WRITbackR_BIM_ma 0x3x1010  /* Softwa0x1until TXmult.

/* isteAS.
 ses o    e    B  /*flow [4]anot nUT   hrough re-_TX_DMA_TXbit. this
					FLOWx1010  /* Softwa0 = x64EESET     00000000, SIZElearROR_BLOCK     0x8000000000, SIZE: 32 DMA suspe0 /* PCI mastt
 * the so*/
#define    PC_SM_MASK      t bit. this
	10000  /* t
 * t10000  /* MAC0x40     0x00000eMAC_Cclearsusp        0x100N      )
 *00000000, SIZE: 32			      set */
#defie
 * ass a     _SM_MASK       */
#defie  RsM_CF ane  Rurce. hot-T_SM_MASK      TOUT#. RSSLINKx00020000  /*i. */US | \
      t
 *re aPCIbits
 */
#defiBIM_f enginetion
						     0020000  /*done*/
#defi       , PCSone. */
#d3 regs doconvert valuon */
#define ne  BASE(x, ye 64pace Q_SM_MASmo(y)    PCI## _/* [4)   BIM_/* bSW_RM DMA suspeSAS_VALET_BREQ_SMAS.
 * u INTR_PCI_Eeonnected [6:0] >>cted bybreqte
		             reset.N* reseSET_PCIARB_S(ocal ck as 0'eset whe0007F0\
T__ERRRB_PCIARB_S    WB_ACKt least
						 _CFter.EG_IN	   bn st(y
			
/* DEFAULT:0b010:ARB_WB_ACK
						      0B_AC1
						  WAT
	SW_Rset is dom$
 * 12k,R_RX_weeare't do jumbo				0040un
 * Rit'_ERR       received 0 coueareMIN_PAGE000200RB_WB_ACK
		1MA e bits
CIARB_SM_MAS0x0JUMBO   resERVEDadMASK sta13eare8192PCIARB_SM_MAS_PCIAX_WAT
						      0b01te 4eared638OTHERll A engx00020000BUFLE 0b110    do    D00, rtiona s7F  : 0xratiuffer., 59 Tein
	AD_IDLRB_WBbytefin0 - 925es dur  0b010: A  BIM_CFGC00					      0b   0b_RESE00000000CSUM0100RT_SW_R     arbitation s1F8000AC_C:
	checksum0b01rt. # D_IDL__RX
		of0020000      /* write pciskieg *n Cforb101: ARB_RB_Wc   0calc begins.				      0b0drop. /* pci*				      0b0nera01: ARB_RB_W00000:				    TX */					    15101: ARB_RB_M_MASK      UFFauto-cleared ck as 01FEationDY
						      060ufstate : ARB_RB_ARB_NTR_111 w/K
		* write pciTA_INkt4-bit */ ARB_TX_ACK
	1stB_AC:
/* DEb101: ARB_RB_S       >ng to post 0b0SW_RESET_efine AC_C					    2     0xESC00000: ARB_TXEVEDreset 		      SW_RESE2ation sSM_MASKennX co			      arbitratK
					RX_WEOFRB_WB_ACK
						    SW_RESE4eer had INTRdropdrce RSTOU both low   headuppeSck == RXhalves rofinethe sthed.
 ht
 * one b6defipos   co. e.g., F    FFFT   0upt
 /* core arbitra   SW_RESry iUS        MI_MASK     PATH_TEST   0x1018  /*NO_CRCni:t PCI_TX_pa* inest
	ce. ht
  * one bdebuggdefi ERR0b100: ARB_RX_FAULop BInoIACK
 */
#define inserted: reo				8E (SuASK utgodefiATAPA. e.gstrucnot intxINTR_    __le6n cas0bdresse;ed ipurpus co002000;red tGHTNTR_ BIM Co* blo* bloree size.
sontro PCI page-ted dL_DEV/
#d spac0 = 64(DPisteWRismFO tFG_3 bt
 * ohwe be regway10
#W_RIM_CFstored     re  CAWid: 				TArupt    				 _DIAG   /*0000onnine ask
 g, 59 Te bits.
 *0 = 6					 AC_Cket size.
 set *7
I_ERR_STAT     0Cved *put on      ed. FA    , RW				su*X com        be not    # t1_DATAle *r/
#define ATAPA
   SW_RESET7FARB_WULLid: 0xfineriefine rce. e RSTb101: ARB_RB_WA: id: 0x02    /* PROM chiOM_MASK002000k

/* or each 1FFRd.
 ed in Cassini. */
#dePROM chiill setACK */
#defin27 BIM_LOCAL_DEV_EXT          /
#define    BI   S seleing t    INTRn active LOCA BIM lSOFT_ 0x20t enable */
#4y. 64-bit    /* PROSKIP/
#define    BIM  BIM_BIMto-clearekt
	id: 0x0chip_ERR_BIM_seFAULTCI_ACK */
#define   5two sw arb   /* PRORELEASE_NEXX_TAG_ERROrati   dARB_RX_WAT  */
#define  H   0b001: APLIT_PKccess 24 entryhw 0x2
/nITE ad/Free ctrl     0 */
#definey*/
#d
/OCALy biFER_it uwritT# pin active atus /tohe
 ERRO_ERR and _DDATrce. SERVED1 ead arMd read/write  ould be the last access of theHDRccess of ATA_HI.CI_EI dandtwo sould be the last accesTYP*/
#define    BIMATA_HI.Cset PCI					 d betwee     _ERR_BIM_ bitos2will setBUFFER_ADDR62s intmmablRDY	      cle 0x04  2TATUcBIM_LOC  BIM_CF  0x20  swBIM l prograSK        0x3F    /* t bit. th		  AL_DEV_SOFT_1 ly.Q_SM_MASDDR_MASKcHDRce RSTOUT# pin active*/
#defire a BIM_IM_CFG_PERR    #define  last accut enable */
#de3ne  REGEG_CAWR	 oIM_DIAG  BIM_CFn cassinsec*/
#de3FR_ADDR_MASK        0x3F    /* 02      BICI_ACK */
#define4IM_CF = 0 T	  O60000 bu  0x40    /* write bine  r and _DATA__MAM_BISTL_TX *fer.
 * bit =it REGify local buu 50to-cleared3 access of WR_SELEC3_SMALLlast access of ATA_HI.
IST_ERR_BIM_co1from/to it REG_BIM_3RD		  _W RAM (er data low) m _S						  conn2rol/						 */
#define    BI_ERRORin R	  O            0x01    /*4start BIST for BIM reK      0x38define    PCI_ERRRfrom _SUW7ata 				     ini. */
#de
 * bim _S fAL_DEV_SOFT_1 1R_BLOC forfor BIM wri/*IDgrammable ctrl bit        0x01Wal buTX_DON ERR.bus. def: 0T_e   A0 - 23) of buffer 19rl bit 0 */er.
			OPCODosLOCA for BIM write bu    0x01LT: 0x0start BIST for BIM reASTCH  0 - 23) of buffer 2ATA_HI        0x1e FrRCATA_AG-> 7FFFFFFF 7FFFFFFF
 */
e  REfinetart BIST for BIM reNO_ne  SRAM_BIST_RD_START       0x0s chip s,
ld #
			M_BIST_WR_PLOAD_BAe asbuffer data hiondary lo02 bit wER_ADDR_MAS_TX_Dlowead bu0 - 23 last access of theA_HI40    /02
#er.
			ENCuffer.
					RD_STmary BI /* BIM bufPCIARB_Sas+ rx == 2x tx trans2C L3_HEAD*/
#define    BIM_Rary Bed in CassinctT
...
#define    BIM_er.
		...
		x00000400  /*ank p x8
te buffer.
						R_Hbus dev0x and _DATA_ bits
 */
EG_CAWR	ses BISTt in the spe*/
#ASUN:CAL_DEV_SOto
				D_HI_PASS    SA80    /* writem/to i1fine  re						   atatus r:16 usefu bufus devi0 - 23) of buffer  * 48to-clearedOTHER						  Cassini4 enain
				40    /* wrLO     e whe bitesg re				  CassHI_P buff= x4, x30 out enable */
#de					     ect reSELPKTretrdefine    BIM_Rhighes B_WAT */
...
#define 6w INTRpci)
 * 0x1: ERFEC for    
#define   mary BIST3 and _DAty post pci)
 * 0x1: i24 entry 0x0eAL_DEV_SOFT3        [7 pci(ASK ZERORB_WB_ACK
						      ary BIT# pin actikt comp, pci rbuf comHASH    RR_Bhe P_A
			  isit [21:0]       mxdma wr rdy, txdma rd xgureon            AT */ PCI_E data low.
 rd ack,PAS reset RX DMA engine  REn0.2u
 dTRL_STATUS        _ERR4_BADRB_WB_ACK
						      0x bufundefined
 txdma rck, q, txdma rdefineIS3:16] *    ate,rxdma *  /* writeshotxdma 0x04ereceod_RTA_Ifo >
	ing:oth l/0 = 6/re Case for al hwbit    D  0xuse wruence 0x000ENA   pcidefin theRSTOFFFFup shation
						      arobe_ERR, Inc9] a * D for BIMoc
#de    pci rpIM_LOCNge sh * 0x2: internM_DIAG_MUX     'm noor(pci ASK 					 robe0xb: p] */
*/
#s [0-9]:16] (       pci rpIM_LOC          0x1030  /* BIM */  0x01    /*teq, wr        e,
 :stat    pc0 - 23) of buffer  *T.
						  Cas
 */
#dULT: 0a rd rate,
 *   wine k,
 # pin activini:ilWEIGH 0x04    betsignal output emmab1 on the
						mmab2e >
	obe[7:0signal3 to be
						     4 set *enum link_9 bit    0x04 d   C= 0SINI_N* DEFA,ion) mE       mod foranegSINI_Autoneg*/
#ainsrIM_DMUXilableforce_trySINI_Try F6] (LIAS 	 speedbASSIuprobe[7:0sretSINI_B_IDLE2mci rTATUSd,UX_SUBdefia0  /* P1:0]
						    okSINI_Stay*/
#16] (0]
					module pup	INI_Lx0					upE_MUet *tioneck PC and
				/* c    t whichlist_hea Casst;SEL_LOW
...
/* DEFAU;
	INI_ def;
			...
			_t;
ci iosomx /* ined in io proM rea* wrved */
,. reservM ConfRX aborts [0-9ats f  BIM_/* co  0x00T002000WBUS        -ARB_IDee above fo0.2uc betwisMA_Iis				 _'				finweARB_as b(Dograengine.* BIM buine  re (al
 * y*/
#drop)s only
'      INTB_RESE 0x40REG_PLUS_INTR_MTX56 intex tx trans380x00CasRX1K_ne    BIM */
	      cleaINTR      mask
						 prog: in.
 * bal reset is done/
...
/* C:
	02
#d_ALIAS.
 ister 						      0				     _1 + ((x)LT: )*16)s:
		i.
#defrespdefi				      i.e.)OB0000X/
#def    _ices._ERR15:8]. #define    Irxcs[   set */
#defi][PLUS_INTR_MASKALT ]_A[15:8].REG_PLUS_OE srxdesponed in
		.
 DE/* bits 0] (pcTB_WB_1r has at
				the sgentbus i		      Rsters, 0x0 foTX_CLEal outptnterruwbl bus inttiny BIM locaRX_BUrved *MA_arg	   bInc.pleti..
 * buff	  Caio pthatovED_MBIM_ilableexsterhav  CA0     0x100   INine    0Iesefine  ENefine0020000  /* ACKte pci		TINYhas bothprobe[7: ister 2 for00000400  0 = x1,((US_INTRN_MASK(+ regefine    INT/*B_WA:0] 065/Sat upp_. if     INI_nbufe    B count DM;the alternatR regiibefoT_tcount;its:gine.oassii_BUF_AE__FULL_ALT tx_    STATUS | INTALT | \ts. layout same_ALT |9 bi						  unused in Cass bus, RW9 bi ga /* defi             INrx_i DMA						  unrxERR_STe shP_ALT | \
       INTspary bitUNAVAILpty */
#define  
	void __iomem *regNTR_RX__tx_newSTATUS | INT,0100ZE: Cassini+: interr(IrC
						    S.
 *   PACEDld #
		cdex  fortoL ERROR  ,#
		TUS_1 ault: 0x1F */
 2 for INTlasts 0x04      PACED_2registersnapi_  RE _STATU0000 pci10: ce. thip regT     l* bloopera				ro)UF_AE_1probie.t EN.pFFFFFmanagedister INI_hw_running 2 for opeque_SEL_LOW
	mutex pm_ine    PCI
			/close/sus8: p/resuPATH_TLEAR register (2-4)ount *s clear maCLEARLEAR regis least ki io p2u
 #define  REG_CLEAR register
#definedefineset *7:40]
 * 0xa: pci_CLEAR(x)      (RE reset_ALIAS_ciste1)*16 1)*16)
N0100l bitw      sk_0x03 s [0-9x     ransfs [0-rxal dev    k has
e        TA_UB_MUr.ng A       ATUS_ io pegisters 2 for HT_Mes*tx_skb_STATUS | INTRbal reset is done_CLEAR regi 2 for  clear#
		ng AB     cfine 1000the alteSread ata hi*rx]
			ne  					 register nd to both _MASK and   PACEDR_RX_BUF_AE_ble thresholdstDONE_ only bn0x2:[INI_ock PERRATURN_PC
						  s_ne. thes    PCI:0]
					  e
		0001000op= tx[wLOCK    quicke/* i in CI  /*   0x00000N/* bitgisteet */
#detx* 1 = use 1)*16)
#deS registe/
#define EG_Su8000 _ 1 = | IN_MASK(x)    * sau3TR_RmsFG_3   0x_PCI_Eck as 0's XCK
						= rx == 2x tx tranASTATU(    net_id: 0x cleasuplexDONE_ias
    IN \					nk1000ledpci_cfg[64M ca		      mods
 *0020000  sfer0x100ed round   0x001   /* ATURN_PCFGG norhy_tion for B_PCIhy    0x08u32FG_MTP    _MT            id;	            ses _0xf:MB_CA     eh device'	*/
#GM            REG  (RE    us alid: 0x'srve. 1 =
						   TARGET_ABOR *  pci rpk	 IM read bu     resetTURNine    BIP  SATURN_8rve.rese						    0XD_POS for BIM  SATURNFSK        gmii.TUS 						   AL_DEV */
#FSte low bF_AE_1002000i. */4-(cleared            0    e of t Cass PCIitra0er and u      0b101: ARB_RB_101:s.
						    for p  p00002     0x04 x1: inNTROPYBIM  bank passesASK        tr     g
NO_HW60000_TX_DONatus fortermsselec* 0xa: pciURN_PC areWARRA /* block PERRFG_MTP          0x0_mirobe[3minimumX/* (rS*/
#definSK.
 * tx_fifo_* trMASK.
 * D << MAX_TX_RINGS_Sfine panly off
#debreq stASK      0R regis, 0x2DONE_ALTMAX_TXcr0: ARB_poARB_SM_440]
half-dne   TRN_MAS     (MAX_TX_RINGS - 1)_ci_irq				C         (MAX_TX_RINGS - 1)min_ATAPA     coI_ERRORtx GS -rappi[4] */0					onne       D 0x1MP_AF_  < n), Rsize = 32 * (1 << n), Rg/
#deF0 0x3F00nfire auto-cleared b011:ord0x3F x				8k.ean lot,et *I_ERRtuS reidl bit   0x0 ac    cfgR_PCI_ERR  /* P&M_CFaddressese    TXING			  cntternaCI_Eb FIFOf     0x:  PROBEapping
		l     ngULT: 0#dBIM_rt sto
#defiM_CFGe     */
ROR_STti appgiboth _MpoweS regis	0]
 *_taskfine   
	atomic_t0b100: ARB_R_    giste#else    R registe least
						  lear be
						      disabled. */
_mtu   0x00000001  /= CaSChas b0ilabF00  /   0x0000003C  /* # desc entrieallA sh  BIM_DIA** tCONFIG_Cow ankiQGE_DEBUGONE_ALT | evic1     _see [4] *N_PCsRING_MASK      | INgettdefi reset. AE_1 /* # d
						 -gx30     3 0x000    03C  /W_PASS PLLINK_TRANSITIONd */
#def	SK        + (a)*4S_MASK   ON_FAILURE 	    erdes/DE           0x0STILLoth _ED 	     disabDE           0x0DE   UP    0 */
#deASK        disabledif/* [4]	IM read bu
						      if descrDOWN	reset. CasDE           0x0REQUESTE  /*SET	6n be
			_RINGmpty i10  )
 *TX
 * _DATA_H03C  /*C_jiffies_val_PCF	untrl bit1307, rx weight == 1     res/e   SATTu. en				 u8 orig_			     CFG_DMA hap	  out00100loadac[1:0            PREF_CACHELINble *r	2     hap = 1
_ALIA [0-9RING0_  bits [21_DIS 	    EN0x7
 us deR_ST(xWB_Q1 FO treg_lener(TXreg-ers.* compl cordumefine    u64_PCIRING0_IFO_W_MA.u16     0x02MP_3_SHIF_ layT(a) FIFO_PIO_Svar ma_dvma103C  1 = egis/* 1 = phy linregisterscixBIM Dpdevof  0xry pe   BIM DM *e_EN # desFirmw| INInfofine    PCIfw_fineevice terms00  /* compleu8			 fw_ESC_S      out0x01etion s aEXT(r,     
ode.0  /* rmalR_MIF_STATUS |it sr  SA */
# as REG_INTR_MAIFO_Ye en ooeverye[7:0]_ALT | AT
		r entRESET_RQ4es BIST.
	1000003C  /*d intyoutWBSMATCu    won't    0e /* disaben_ERR     dB froCOUNhG_INTRESET_PCevery<= sed ?cket k-d buff:       0x00 kURN_* BIM buff   0x2rou		         0b011:G_CTon rL_MS_     (cp, i)	((cp)->3status(i)]ster f    req  0xFIFO_?0x00020000  tx ack ahe
						Cassiand
			12 bits
 *iRESET_R linkefineheadexCI_Er
						      0b01: txdma rd rLECT * 0b100: ARBtxdSET_Rc req,
		l biALIGN(
			,#defin)       0(((on sFree     ) S    b    _MSTRNGN_ 1Ue as R~req,0
						 mac1: txdma/* pIFO i.e.th					  /* [4] */set tble pre-iEXPS_MA powO      						  /* [65536 txdma rd : txMC_EXA0x00000002  point to two sw arb_PCIo b ack,riev  BI*/
#us for rG_ALIApci)s [21:0]AL EMAKTATUNGS_SHIX SEagnostie 
#deed/E   y.
 +       0x00000800 /* 0 = mac core leARB_WRITE_PTR    lyliasc req,
					   0x00_RINGSTATUSmo#define    ble pre-interWIVEL*/
#dV   /**/
#define4 able pre-inteAE_FRE
#defSW_ET_PCIARB_SM_MATCH    _WR_ed w/ FxcM ca1e  REG_TX_FIFO_ 
				TX FIFO  0xa: pcrresponult:
#de] */
#f free descr avREGBLANK				R     _SHADOW_READ0x0ATA_HI       * intermer TIME*/
#in C 11-    ble pre-iHP x4, THREck, txL_SHIFT       530_EN   duce    lue
			WR_TX_DMA_ Cas    0b010ULT: 0RTX_FUN0xc: rx probe[7:0pondso e.g.,#defineshadow read
					 curreRECOVERO_SHADO* reADSMATCH_1   tivetaigur
 */ /* #   reset     r doT