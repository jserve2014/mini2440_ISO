...
/*GAINLLR_NF9*/
#define R0900_*
 * Driver stv0908or ST STVF900 satellite d_QP_5_6modulato_reg.h
 atellite d10 fr IC.
 *
900 opyright (C)10modulat9r IC.
 * CopCopyright (C)IC.
8_eroelect9onics Igo. Lipliani1 <li2009 NetUP Inc*
 * This 1modulata2009 Igor M. Liplianin <lipli9_lianin <laru>
 *
 * This prog2am is free software; you can2modulatb2009 Igor M. Liplianin <li8P_3 * by
 * tru>
 *
 * This prog3am is free software; you can3modulatche Free Software Foundation; 2_ later veru>
 *
 * This prog4am is free software; you can4modulatdrsion.
 *
 * This program is eiOUT ANY Wru>
 *
 * This prog5am is free software; you canther verersion.
 *
 * This program is Microelectd in the hope that i6am is free software; you can Public frsion.
 *
 * This program is anin@netupfru>
 *
 * This prog7am is free software; you can7modula50rsion.
 *
 * This program is nder the t50onics.
 CFGEXT(C) 2009 NetUP Ine, MA modula8 * Thi
 *  progrSTAGMODEf9 NetUP 900 sREG_Hor ST STBYPBCH*/
#def
/*4ID for ST STV0900 sLDPC  0xf100
#200_REG_H
#defineDENT*MID*/
#def
/*100_REG_H
#defineINVLLRSIGN  0xf100000o2009 Igor M. LiSHORTMULe_REG_H

/
#d2009 Igor M. LiEXTERNTXE stv0113001s.
 *ENCFG(C) 2009 NetUP Inc/*DAC_REG_H
6fine F0900_MCHIPROADCASDE  0xf16000g.h
 DACR1 for SNOSHFRDd by
 *f1140xf1or ST STVF090BCHERRFLAR2E1  0xf113e300e11c
#defin0PRIORITY0900 sOUTCF22009 Igor M. LiDDEMODUTSERRS1_HZ1400fMRELERRram is fn.
 s
 * TZE1  0xfmodula9141c0080
#defineMREL_ERRORS_COUNTESERRS3_HZ 00fcs.
 00_OUTSn <lis free softwar ST STV0HZ  0x71  0xfc00111c0080
#defineRS1_PARRSMODECF07
 0xf118
#defin02139, USA.
 */

#defin11c0007113
#define F090efine0_INV_DATA981400ff

/*OUTCFG*/
BCHe R0900_MODECFG11dCFG*/
#0cs.
 TSTRES F0900_OUTHZ3_CONTDISEQC_modulf11e F0900_HWARE_SERESFET stv0f11/*Mefine F0900_MCHI
#deTSc0080
#def#define R0900MCHI
#deVI0xf1S3_
#deff*/
#define R0900TV0900  R0900
#def00ff

/*OUTCFG*/

#deSYM_IRQSTATUS3FG  0xf11c
#define R0900PLL_LOCK  0xf11c0080
#define
#deMAd00010000IR00_OUTSEc00411c00
#deINDE  0xf113_S1400fP2 0xfDISRX(C) 2009 NetUP InSDVBS1_PRF_ 0xf1165M_LCK811c0080
#d2_EN_fine Fine F09F0900_DEMOD_SEL_2  TUS2*/
CURRSR1c0080
1c00QSTATUS3*/
#definP2_I*IRQGfineAL0080
#defi  0xf120
#define P2_HIZ  0x2ENT11c0080
#defin0ff

/*OUTCFG*/
V_DAP2_PIN_SELEC0 0xf111c008G  0xf11c
#definTUSV_DATREAM_LC2 for S07ine F1ne F0900_V_DATA62000021c008KB1210008
ne FPKT00000900CFG for P10900_ine F0900_S7 ST STV0900 sF0900_S00_SP008
#ine F0900_7fine FSPY_ENDSIM_3  1e F091  0xf1200001F07OCKB_1  0xf1210V_DAT1*IRQS_1  0xefine R09007_1  0xf1210110008
#100201define F0900_SCK_27EL F09001210008
#100define0900_SEXTDINB2 PIN2 IC.
 *
 *
 04
#dBREGS		68f11c0080
#efine F090FIELDS		1702
