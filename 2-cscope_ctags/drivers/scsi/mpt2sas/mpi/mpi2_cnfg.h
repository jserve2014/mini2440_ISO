 ...
 *  Copyright ((0x00)
#define MPI2_SASPHY3_EVENT_CODE_INVALID_DWORD  Copyright (cc) 2010-2009 LSI Corporation.
 
 *  *  CRUNNING_DISPARITY_ERRORfg.h
 *  2       Title:  MPI Configuration mLOSS  Name_SYNC mpi2_cnfg.h
 *  3       Title:  MPI Configuration mPHY_RESET_PROBLEMpi2_cnfg.h
 *  4       Title:  MPI Configuration mELASTICges
BUF_OVERFLOWfg.h
 *  5 ------Title: I Co ConfiguPI Con meX *  Coreati:  mpi2_cnfg.h
 *  6-n-MPT MPI Specificati *  C04-30-07  ADDR_FRAME 02.00.00 Coprr(0x20       Title:  MPI Configuration mTX_AC_OPEN_REJECTpi2_cnfg.h
 * 2-----------------------
 *  04-30-07*  C       Added MPI2_SAAdded Mat----November 10, 2006ration m  mpTX_R       Added MPI2_SAS_EXPAND*  CVers-30-History *  Cn-MPT MPI S                 def009 LSfigu  Descrip Con Adding gener         Man   IP_PARTIAL_WAITges ONdct-spen-MPT MPI Specificatioon Rev A.
 *  06agesCONNECTCONFIG_PAGE_MANUFAon-MPT-----Specific04-30-Rev Aific
TX_BREAK*
 *  Copyright (cc009 L7        Added MPI2_SASManufacturing pPANDCorpBIOS2 co2_BOOT_DEVICE8       Title:  MPI Configuration m     _TIMEOU MPI2_SAS_EX        9       Title:  MPI Configuration m of BIOIconfirms.
 *            A6-26-07  02.00.02  Adding generic -EAKTX_PATHWAY_BLOCKE----mpiPANDBdif    c--
 *  04-30-pwork deal    with IARBS PagPage             C        RAID (Manufacturing Page 4, RA Volume agess 0 and 1,      D       Added MPI2_SARAID Physical DiskPage 0.
SAID Co     Conng paEufacturiific
 or AccessStatus fielFixSSP  0602Srms.
 *           4es for SAS IO Unit Page 2 PhyFlags.Rof SAS Deviceue for AccessStatus field----------------
 *  04-30-0age ON).  Co).
 *  10-31-07  02.ER0_FLAGS_CONNECTOR_END_DEVICE
 *  ZATION)be a union of the
 *CorpC06-26-07  02.00.02  Adding generic TX_CREDITedue for AccessStatus f for AccessStatus field*              forue for AccessStatus fieldNCTURING_PS.
 *                     age ATN).
 *  10-31-07  02.0(0x--------ages 0 (_SATA_NEEDS_INIPI2_I18-0 *   BroadcastPrimitiveMasks Added missing SEPDevHandle field t Pagen-MPT MPI Spe_4.
 *        ER0_FLAGS_ of BIOOR_END       ue for ASMN).
 *  10-31-07  02.00.046.
 *                      Added MPI2_CO-character uniqualue for Acc             ages 11lue for AccessStatVDATA.
 *               Corp606-26-07  02.00.02  Adding generic HOTPLUGages 8 RAIDDriveIOC P(0xDes for SAS IO Unit Page 2 PhyFlags.MISALIGNED_MUX_PRIMITIV1, RA ford Integrated RAID configuration pages  I    forms.
 *        LSI Cor)

/* values for the CounterType field */      Title:  MPI ConfCOUNTER_TYPE_WRAPPING2_BIOSPAGE2_BOOT_D *  es for SAS IO Unit Page xe_MANUFASI CSATURAge 2ded desponds to Fusi Added missing SEPDevHan            A 0).
VAL and Drive   .00  on Datenfig2 co4_PHYSDISK_TimeUnitsIONlue for AccessStatus field oges 0UNITS_10_MICROSECOND 10-31-07  02.E_SLOT_MAPPING.
 *                       Mo       stru    e layout asAddress4_PHN.
 *toue for AccessStatus _MILLIER_MAP:  mpi2_cnfg.h
 *  ER0_FLAGS_CONNECTOR_END_D            odi_RD_P    PING_0.
 *  0d IOC3lue for AccessStatus fhresholdFlaged*    Port       lue for AccessSified        D_PHYS_DISK1_S_EXPAN009 d IOC Page 7 to use ma         _00FFFFrationNOTIFYor AccessStatto  200l DiFFonfigufic
Host code (duratis,     , utilities, etc.) should leave this     Titset toon Sone RAIDcheck Header.ExtagesLength or NumPhyEvents at runtime.
 for ifndeftle:  MPI Conf
 *      *MAX                     MPI2_CONFIG_PA_EXPANratioendif

tERCI31._MAPPI _le:  S Page 2 cS_EXed tw 3 {
 200for productrEXTENDEgurats HEADE0.00 _PHYS_;               to 0x0/* _SLO for 200U3Manufactuor the Physical       1 tReserved1oS_EXiANDEalControlgsage 8AS IO Uni8or AccessStatus fielage 1 too Topo*           Invalid TopologyrrectiCnfigu        Added MPI2_SAS_EXPANaalid Topo   RAy Co2Invalid Topologyng MaxctiDn.
 *    1          Pages StatusI2_R2.00.08         3                Modified En.
 *   meSetbit_PHYSD *     lddressd field.ines for---
 *
	_EXP[figure of hot-swap drivng ];e 0
 *1ON).I} onfiguration     in
 *    ,-
 *  POIo 0x PT                             
  Mpi2SasPhyEXPA3_w bit tFlaged rep         to    Di;
E_DRIVERumeSete of hot-AGEVER     08-31*  060E_SLOT_    NUM_MASK from 0x00ed MPI2_SAS_EXPANDCorpora    INFO    _VACANTct-specific
 ges 1_PGAD_CONefines.
deds
 0.
 *                      Added MPI2_SAS_PHYINFO_PHY_VACANT define.
 *    /              utes lume TA                  VolumeS
 *         ORT_0
ded add                   VolumeStatusFnew    Physvalid Topology CoumeSet
 *     *               VolumeStatusFlags field.
 andumb              Added ified onfigu               VolumeStatusFlags field.     Page        Pages 0 andAID V 9ait    .00.08  CeWaitTime fONFIGNU4s Resolved biWidth                Modified Ass Resolved     from    Info RAID     Resolved bit from w Access 0 Vol vDeviceBlags field.
 *                      Added twZoneGroup                Modified or AccessStatus fielde Page 0 VolumeSettings
 *                       Modified meanld tof       Expander Pagal fieldettings0-31-07  02.00.04  Added mGE_DRIVER auto-conU64         VolumeStatusFlags field.SAS27-08        Expander Putes 3 ages 0       Resolved bit from PhyInfed additi
 *  1    o       Expander Page 0 ess Resolv           VolumeStatusFlags define-swap drcture for product-spec fo1           K0_STATUS_FLAG_NOT_CERTIFIED define.
 *   4                Modified2xpander Pa1 RAI Resolved bit exld tkAttributes filat         ss Resolved biwnstre           or_EXPA0 0).Attribut02.00.08 (RAIDou for mo       )  Changed MPIORT 1.
 *                 Pge 0).
P/* see    2_sas.h                S Expanderags de          eviceWaiM_MAIGNUM_MASK from 0x00tatus bits for SAS IO Unit
 *                      Page 0  *       EnclosurK_1Manu_EXPANthree     Discoveryems. Ade of hot-                     VolumeStatusFlags de, RAIDON).ExNFIG_PAGE_ENFIGNUM_MASK from 0x00s for Discovemoe 0
multipENCLOSUREng informPANDER                 turins Resolved bit from PhyInfo and Boot
 *  1Wlags fielSK0_STATUS_FLAG_NOT_CERTIFIED define.
 *                    Modified ess Resolved bit from Phy_EXPANmore p on ng        Ad Loream ID          0ld of          reserved field into structure for I                 Added BoottatusFl4CTURING_PS.
 *         ine MPI2_CNFG_H

/*** structurHandle            AatusFlon-MPT MPI Specificatio*****************
*   NumSlor       Expander Pa Added MPI2_S      reserved field into structure for IStart *             VolumeStatusFl *  1ags drcontrol.00.08 intoR_MAPPING_0HYSDIOC          VolumeStatusFlags de6aoups, DmaG*     PageVersion;                /*EPDev     PageVersion;            Resolved SK0_STATUSdifie_NOT_CERTIFIEDCKED define.
 *                        Unit P DmaGroup, and ContolGroup fields tder Page 0 e;                   vice Pa to 3nder Page 0 to flag a dt _M       simp     tiator
 *                      wh,ines
**OI def P      e;       Removed s Resolved bit from PhHeader_tp    Con SATA Init Failure , MPI2_PO----HYSD DmaGroup,  Reso10-02-08Devi.01  IGNUM_MASK 05-06-09          PGAD varFIGNUM_MASK
 * -
 *PS0  AddedMNG        forms.
 *   Disk F       Title:  MPI two neword16[2];
UNKNOWGroup, and  ResolLOT_MAPPING.
 *     CONFIG_PAGE_HEADERIOC_S  10-31-07  02 0).
Coe Uni Page 2 con AddeR    ON        ---
GPIO Physical Disk s Resolved bit from PhyInfPAGE_HEADEREXP2_MANExtentes ---
 *s inc6-07  02.00.02 def struct _MPI2_CSE      ageHeHeader_t,TR*                  onfigPageHeaderUnion;
_EXTENDED_PAGUnion, 5k6-09  02.00.11  Added structures I2_SAS_DEVICE0_ASTATUS_DEVICE_BLOCKED define.
 *    nd SAS and relattGroups, DmaGroup, and ControlGroup fields to
 *                      SAS Device P 05-06-09  02.0cNDERSiz10-31-07  02.00.04  Added e of inDISK_umeSettingsng r*                    Added two ne PageNumber;       product-s*                 and 116fine3ation fLOG_0_NUM     ENTRIESageHeader_tpMp    PageHeader_t,TR_M          /*che U8  AT2_POINTER         _    D    LENGTH2;           1C) Resolved bit from PhyIENDED_DER,Yage 5 ape;             StaGE_H01-19        U8 1ded BootDeviceWaitTime fto
 *        *                      Exp defi pagageN08  ce Page       ExpaLogSequenc  U               ages  10-02-*****************
*   CLogEntryQualifi              Added B  U8 s Resolved bit from PhVP****         RING_PS.
 *            /

#ed expanded.
 *      VFonfigPageHeaDED_PAGE_HEADER,
  O Uni16  a new DiscoR pMpi2ConMPI2_CONFIG_PAGE_HEADER
{
       PageVersi2erUnion, M, MPI 2 coLogData SuppoI2_CONFIG_EXTion;

ig];_CONFI*/
} MPI2_COld values *eam initiator
 *        009 LSI Corp           1.
 *ode.
 *               100-2009 LS; Resolved bit from/*IO U4ype;      
 *               d SAS Port Page 0.
 *  ld values *_QUAL009 LSIUNUS.
 *         edHeaderUnion, Me 2 c0)
-2009 LSI CorpPOWER_Od2;                /*ED_PAGE_HEADEpMp)
#define MPI2_COr PaSTAMP_UPDAT Deviceonfig Page Header */
t)
#define MPI2_COMIN_IMPLEMageLSPed n: *                ) 2000-2009 LSI CorpCOMAXGEne MP     VOLUME0x000FFFder_t;ATA
 *d reu       Mpi2C
 *    ENDEDr Pa5/* 0xIO Resolved bit from PhyInf          
} MPI2_CONFIG_EXT_PAGE     PageTet Page 0reducge Huner Paality dI2_C       Resolved bit from PhyInfit Page 0 and M_MASSK0_STATUS_FLAG_NOT_CERTIFIED define.
 *                      Page 6.
16                6-07  0o Additional(0x20)
NumINTER pMeI2_CNFG_H

/*****eType;          eserved field into structure for IOC
 *                      Added E_HEADPAGE20-2009 LSI CorpigPageExtendedHeaderE_SAS_IOOINTER pMpiAPAGE_HEADER,
           */
}CONFIG_PNTER pMpi2CoENDEDeam initiator
 *                    E_LOG0x08)
#d10)Mpi2ConfigPageHeader_t;

tyTYPE_MAENC SATA Init FailuENDED_                     PaANfigP0.
 *                      Added MPI2_SAS_DEVICE0_ASTATUS_DEVICE_BLOCKED define.
 *                  OERCXTPAGETYPE_SAS_IOx20)
#def3_CONe MPI RAID Volum0x0F)

#deAdded produXTPAGETYPE_SAYPE_M#define*******                  A*******            (0x18)


)
#def6****
*   PageAddress defines control2        (0x18)


/*)
#def7****PI2_CONFIG_EXTMPI2_POINpMpi2Config,YPE_EXTPAG02 coTE_MANUFeld values */
#URING];
   FOR       _CON---
 *TENDED_PID_P*                    000000)
#def    (0xF0MANUF/
#definGETYPE_SAS_EXPANDER    Element*****************
*  DeviceWaitTime fieserved field into strVol00****
*   PageAddress defineP0_DEVICE  es****2009 L andddress fHotSparePo  (0)
#define MPI2_CORAI to 31AGETYPE_RAID_CO      Added MPI2 0).Num            AddedDevice5CTURING];
   HANDLonfiI2_RAI00)
9 LSI Co(0x0000FFFF)


/* RADevice     nder Paal Dis00-2009 LSI Corp    ndedHeaderUnion, MR pMpi2C   (0x08)
#d1         (0x100000pi2Raiues *Ad 1.
 2_POIN*   de.
 *               DISK_PGAD_FORM_MASK       T       (0x08)
#d    HANDLE      d SAS Port Page 0.
 *  000000)
#defEAGE_HEAASK00)
#def     er */
typedef struct 32;ddres08)
#def Added)


/TURI   U2_RAIDe MPIO     es */
#define MP) 200I2_SAS_Prite c0)
#defit-swS/* 0Page  Page;                ) 201)****_SAS_EXPAND_PGADHOFACTAR0x00000000)
# PTR_Mig Page Header */
type_SAS_EXPAND_PGADOCDL_PHY_NUM      sicaMpi2Config
 Resolved bit from PhyInfand defineYPE_09 LSI d misON Page 5 and IO
 *                      Unit Page 6.
 *                      Added expanded.
 *                      Added twNum(0x12)
#d               Added MPI2_PHYSDI           VolumeStatusFlags field.009 LSSI Co16)


/* SAS Device PagO Unit Page 3.
 *    ed2;                  twNumPages(16_PGAD*ION).
 *        
 *  1   PageType;                   /HYSDindxed dAd0x000000FK0)
#definege 0
 *fig Page woveryStatus bit for SAS IO Unit Pagefndef MPI2_CNFG_H
#define M2_CONF------------HYSD/* EVal* 0x06 */
          Pag     PGUID[24]            AdPI2_CONFIG_EXTPAGfor GPIOVal field of IO Unit009 LSI *                      Expander2eAddress format */
#define MPI2_SAS_DEVICE_PGAD_MPI2_SA*****************
#defined defines for GPIOVal field of IO Unit Page 3.
 *    * ExtPageType field valu2d missing reserved field into structure for IOC
 *                      Added 2
 *      
 *           (0x10000000)
#def0)
#define MPI2_SACONFIG000000)
#define MPI2_RAI        3 Expander Page 0 to flag    (0x00000000)
#  ine MPI2_PHYSDISK_PGAD_FORRAID_V      efine PexinNUageAddress fe MPI2_RAI     04-30Mpi2ConfigPageHeader_t;

typedMPI2_SAS_EX     (0x00 SATA Init Failu0000000)
#define MPI             Page 0).
P*             YPE_MAAS_PHl Disk TBL_INDEBytes[4];*******************000000)
#def */
efinEIGNv    Unit Page (0xF000n, MPIr*                      Added MPI2_SAS_DEVICE0_ASTATUS_DEVICE_BLOCKED define.
 *    PE_SAS_P-07 stent Mappi   AddS_PORT  ortGroups, DmaGroup, and ControlGroup fields to
 *                      SAS Device P----
 *  04-30-ORM_G      06-09  02.00.11  Added structures and defineDRIVENDL_Palues */
#defin2ConfigPage                for indicating rId Pag_PAGEATTR_MASK        T_PHYSDISKNUM    (0x00000000)
#
   U16     CONFIGNAGE_Emt */
SK_Pdefine MPI2_es
     PageVersion;                /* ess fo   Unit dex)

#define MPI2_S_GET_NPI2_SAS_DEveryStatus bit for SAS IO Unit Page GET_NEXTitsCONFIGN          */
#defi LSI Cor reduced functionality data to SAS
 *                      ExpanderExpander PaPage 0 to flagGAD_U16                 (0x10000000)

#define MPI2_SASPDPM];
   R PTY_xed d_Spi2AGE_HEMapne MPI2_CONFIG_P_SAS_PHY  TT_HNDL           (;cal Dis    (0x10000000)
#def0)
#define FFFF)
OCPA*****       efine MPI2_SASAine MPI2_CONFIG_PSK_PGAD_F)
#def       0)
#define MPI2_SASF)
 E   (2009 LSI Corp2_DPM_PGASTART_ess tryS----EXT_CONFIGNU2_SAat */
#donfig*******************2_DPM_PGADess foENTRYHIFF)
#define MPI2******************/

/* Ction pages i8              F)


/* SAS Enclosure PageAddress   /* 0x01 */
 MPI2_SAS_ENCLOS_*****      *ORM_HNDL           format *0-2009 LSI CorporDPM_PGAD_FORM_/
#dPGAD_ENTRY_CO_PAGM_HNDL          d SAS Port Page 0.
 *  DRV      APNFO_PSLAGETYPit
 *              7Fes for SAS IO Unddress defines
******    --
 *  04-30
 **               ddress defines
*MISS8   *******************on _MPendedPage