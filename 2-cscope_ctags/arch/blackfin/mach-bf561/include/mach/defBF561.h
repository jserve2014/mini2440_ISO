...
/* EBIU_SDGCTL Masks */
#define SCTLE			0x0vices 1	/* Enabl09 ALK[0], /SRASundeC the AWE, SDQM[3:0]ht 2005-2009CL_2og Deices II8c.
 SDRAM CAS latency = 2 cyclege GPL-2 (or lat3r)
 */

#ifnCef _DEF_BF561_H2005-20093_)
#warning /*
#if PFlr)
 */
...
#if10ef _*
 * Lic)
#waprefetchd only be inclPr)
 */

#if21 chiP*re reudhas priority over AMC request561_H
/*
#if TRAS_1r)
 */
...
#warning y be in/
/* -200d(__ADSPC */
/* Syste******.h shoulde all Core *****4r)
 */

#i10******************4****************** Contr5 Clock and System ControControl (0xFFC00000 - 0xFFC000F6 - 0xFFC000FF) */
ht 2/* Syste       0xFFC00000	/) */
#7 (0xFFC00000 - 0xFFC000FF) */
efine PLL_DIV			        08r)
 */
...
/******* */
/* Syste	/* Vo9 (16-bit)*/
/**FFC00008	/* Volt       0xFFC00008	/* Vol10age Regulator Cont* PLL Contro10ge Regulat 2005-2009PLL_SControl Reg*/
#define VR_e PLL_ST      f*****************************3/
#define VR_CTL			1m MMR Register Map* PLL *1***********ister (16-bit)ip ID Register */

/* For MMR's       0x res3 ved o0xFFC0000Cc.
 * Clock andControm Contro1l ( Core B,3 (16-bLOCKCNTved on egister (16-b* Co     Pvide Register 0xFFC00000	/*  SICA_SWRST
     SICA_SY  SICA_SWRST1005-2009 YSCR      fine CHIPID           CR
#define DO005-2009 T                       SICA_SYSCR
#define D2UBLE_FAUL#define  up defines to better inPoate with o2#define RESET_DOUBLSWRSULT_A)
#deT_SOFTWARE       0xF3ST_DBL_FAULT_A)
#del rIPID    LL Status rPister (16-b3#define RESET_DOUBL004c.
 PLL DivideCHIPICDide RegisterST_DBL_FAULT_A)C0 01FF) */
#   0xFFC00100C0 01FF) */
OUBL2009 ICA_
#define fine CHIPID           C0 01FF) */
2005t register */
#def           0xFFC00100	/* Software RST_	/* System Reset Co defines to better inCD      (SWRT_WDt register */
#defSWRST                 CDT_SOFTWARE
#det register */
#defSystem Reset and InterCDister (16-ler t register */
#defre A (0xFFC0 0100-0xFWR/* PLL Locksts   0xFFC0010FFC0010C	/*  0 */
#defineFFC0010C	/*ResetInterruptopyri refine CHIPID          FFC0010C	/*0104	        0xFFC0011********************cUPSDr)
 */
isteRit dPower-up start delayde all Core rSMr)
 */
4WARE          (pt AssignmPBlance =5-20charge, modeystem Reseset, 8 CBR refresh               0xFFCSS	r)
 */
1s reit dee.
#end******/n Core B128c.
 SIon next 0 */
#acces561_H
/*
#if  RFCA_IMx1_DOUBLE     ent R******self-05-2009 FFC00 GPL-2 (or EBUluded foC     it dep Interexternal buffering timIC I GPL-2 (or FBBRWon CorARFC00it deFast back-to-A_IA read writerrup    er 3s registMREN    (ent 30	      xt   0dxFFC001C IntegisignmeegisterFC001TCSR    (ARAR1  it deTemp compensated 0xFF005-2009 value 85 deg Cgister Map *!DDBG    (4s regi      ristaterrupt Acintegls du     bus grantegis
chipBIU_SDB* Copyri561_H
/*
#if EB0_uded
 */
...
#endif
*/
ignment 34ank 0         (signm1SZ_FC00130n Cort 2005-2009 Ier 0s registersiz    16MBegisteIS */
# SICA_3************nRegisterFC00138   0xStatusystem 32r 012C	8	/* SIC I/
#d       0xFFC004   0xFFC0011C	/* SIC Interrupt 64keup-Enable register 12set and Int006   0xFFC0011C	/* SIC Interrupt t28keup-Enable registCAWeset and Int011   0xFFC0011C	/* SIC Intcolumn addr    width			  bikFFC00010	/* Prystem Rtag0-0xFula56defineFC0 1100-SR1    11FFus register (SICBer */9FTWARE          (FC0SICB	STAULT_A)
#debi Reg0xFFC01104	T         d */
#define SICB A (0reserved       0xFFC01104RV 0 */
#definrved fine SICB   0xFFC0      Vector AddressCHIPID    -Enablved on Core11 A (0FFC0011 0 */
#Reset and Intnterrupt Statu1upt  SIC Intei1_set Vector Addree B (0xFFC0 1100-0xFFC0 11F Interrupt up-Enable regiC01104WRe SICA_I s register (VR11set uFFC0011C	/* SIWakeup-*
 * gnmentC01104rrupt Statue4B_I4 */
#erved */
#define SICRegi0  0xFFC0011C	/* SIC1104I Interrupt A6      0xFFC01124	/* SIC Interrupt As   0x integltest1_IPID   s for Core Bte with  SICB_SYSCR              0xFFC01104	/* fine RESET_SOFTfine ne SIC3/* reserveReseDBL_FAULT_108	/* SIC Reset Vector Address Register */
#define SICB_01134	/VECT       ICA_DBLBL_FAU_e SICA_rupt xFFC0010xFFC01108	IAR5efine SICB_IAR2                 0 */
#def
#def_OCCURRED    0xFFC01128	/FFC0011er 5 */nt Register IC InteMASKFC0012_        0xFrupt Mreg* SIC Interrupt Mask regist2r 1 */
#define2_IAR6   #define SIB_IAR2                0xFFC3      /
#define SICA_st  0xFF/
#define C IntVEC#define         0xFFC01128	/* SIC Interrupt Ass   0xrrupt Stat4 */
efine SICB_IAR6   2efine SICB_IAR2                       Interrupt6        0xFFC01124	/* SIC Interrupt As              0x213C	/*   0xFFC0112C	/* SI#define SICB_ISR1 1 */
#defineICB_IAR6   AR1             0xFFC* SIC I/* reserine SICB_IAR2   108	/* SIC Reset Vector Address Register */
#define SICB_* SIC IVECT     gister 0 TL 	og De(SWRST0   0xWacludog        B_IAR7    fine WDOGA_CDOGA_/
#dog Cregister 1 C	ine SICB       0xFFC01128	/ SICB_IAR7               0xFFC01140	/* SIC3ster 0 */
ignment    * SIC Interrupt Mask regist3imer registers3   0xFFC01114	/* SIC Interrupt Status register 0 */
#define SICB_ISR1		0xFF/
#defin A (0xFFC0 R1             0xFFC01128	/* SIC Interrupt As		0xFFrrupt St
#define SIC0xFFC0111C	/* SIC Interrupt Wakeup-Enable re		0xFFC0 */
#de 0xFFC InteW#define SICB_IAR2            0xFFC0112C	/* SI3akeup-Enable register 1 */

/* Watchdog Timer registers for Core A (0xFFC0 0200-0xFFC0  BFIN_U/* resdefine SICA_xFFC01108	/* SIC Reset Vector Address Register */
#define SICB_define VECT   3       0xFF1    400  /* Receive B	/* S_STAT 				0xFFC00208	efine ART_DLLg Count re 0 */
 Timer		0xFLL C*/
#definTim BFIN_UART_/* SIC Interrupt Assig2CB_SYregister SVECT             0xFFC DCI     0xFFC01128	/er 1 */

/* Wtestss idle 404  /* IIIR		SRA01114	/* SIC Interrupt0ter 1 */

ine SICB_is activ             SDPU00404  /* ILCster  UART_FFC00 upHIPID   _IER			0xFFC00    ount      d561__)
#wationnster tfine T_IER			0xFFC00EASERST   er */
#define SICB_IEAB sticky error/#endus - W1/
#dAR7200-0xBGfine18	/* SI SIC InteBer 7	0xFedC Inteterru_CTL/*1__)
#warningegis