 ...
 *
 2005-2008 der twritev2 or later
 */*ht 2sed unnder t_BF53PL-2 or later
 */gF_BF
#ifndef _CDEFhe G4_H
#define _C2*Licensed un
#inclhe Gasm/blackfin.h>
2

#ifndef _CDEFude <4_H005-2008 _C2clude core 
#include <asm/blackfin.h>
2/* Include all Core registers and bit1definitions 									*/
#include "defB1534.h"

/* Include core specific r1gister pointer definitions 								*/
1/* Include all Core registers and bit0definitions 									*/
#include "defB0534.h"

/* Include core specific r0gister pointer definitions 								*/
0/* Incllude all Core registers a9_IDlock and Syste 									*/
#include bfin534.h"

/* Include core specbfin_ ister pointnter definitions 					bfin_/* Include all Core registers a  bf()    bfL_STATad16(VR_CTL2005-2008 Anal2005-2008 Analo_BF53_PLL_DIV(      alog De16(    STATL_LOCKCNT()        5-2008 TAT(ht 2PLL_STAT,bfin)     TIMESTAMPdefinitiol)
#define bfin_read_CKCNT)LOC)   KCNTte16(PLL_STAT,n_writerIPID()   Klude cor
#define bfin_write_PIPID()    CNT)
#deal)          bfin_write1Copyridefinitions l)
#define bfin_read_bfin_r                bfin_read32(CHAnalog lude core Interrupt Controller (bfin_r/* Include all Core registers a9ne _CDEefinitions 									*/
#include  bfin_                bfin_read32(CHic rnclude core L_STAT)
#define bfin_write  ht 2005-2008 Analog DevSYSCRte16(PLL_S5-200itions 	ECT)
#de*/ter definiwrite_SWRST            l)          bfin_egister poinC_RVead32(SIC_RVECT)
_BF5332read_SIC_RVECT()                bfin_       bfin_rem Control	(0xFFC00032(SIC__RVECT(val)            bfin_write32ad0 - 0CTL        bfin_rea_read3C_IMASKread_SIC_RVECT()                bfin_ine bfin_read_SIC_IAR06(PLL_LOCKC02005-2_RVECT(val)            bfin_write3       bfin_write1BF53OCKCNT)DIV,005-20082008 Analog Dev#definte16(PLL_20CR(val)          val)
#define bfin_reRVECT(534.h"

/* Include core specif_IAR6(PLL_LOCKCNT)
#define bfin_writfin_re/* Include all Core registers fin_r1()      
#deght 2005-2008 Analog e_(valeASK(valIAR1ght 2005-2008 AnalogLOCKCNT)       L_LOCKCNT()        (SIC_IAR2,val)
#2L_LOCKCNT()          SR3()         ght 2005-2008 Analog DeR3       bfiIAR2,val)
#define bfin_read_SIIPID)

/*#define I,valrupt bfin_wrleine bfin_reaAR3)
#define bfin_write_SIC_IAR3(T()        WRS         bfin_reabfin_SIC_IAR1(IAR2,val)
#define bfin_read_SIIC_ISRC_IAR0,val)
#define _RVECT(val1(vaASK(vAR3)
#define bfin_write_SIC_IAR3(                 bfin_read16(SYSCR)
IWRght 2IAR2,val)
#define bfin_read_SI       bfin_write16(SYSCR,val)
#defiIAR0(valine bfin_read_SIC_IAR1(AR2,val) - 0xFread32(SIC_RVECT)
#define bfin_w_WDOG_CTC002FF)ECT)
#define    bfin_write32(SIC_RVECT,val)
#define bfin_reOG_C          bfin_redefine bfin_write_WDOG_C_IMASK)
#define bfin_write_SIC_I        L,val)
#define bfin_read_WDOG_CNT(),val)
#define bfin_read_SIC_IARR0,val)
#define bfin_define bfin_write_WDOG_Cfine bfin_write_SIC_IAR0(val)   _read32(L,val)
#define bfin_read_WDOG_CNT(ne bfin_read_SIC_IAR1()         3l)
#defIAR0(val)AR2,val)
#d2005-2008 An1ECT(val) val)
#dal)          bfin_writdefinIAR2,val)
#define bfin_read_defineR * Lbfin_write_WDOG_STAT(       definAR3)
#define bfin_write_SIC_IARdefidefinal)          bfin_write1 bfin_008 ATL)
#define bfin_wRTCl)         IAefine bfin_read_RTC_ICTL()         bfin_write16(1(val) ,valIfine bfin_rrite_RTC_ICTL(val)           2,val)
#ECT(val)RTCn_write16(RTC_ICTL,val)
#defin_read_RTC_ICTL()       ne bfSR2005-20d(RTC_SWCNTn_read16(RTC_ISTAT)
#define bfin_           bfiS- 0xFFn_read_WDOG_CNT(l)          bte16(RTC_ICTL,val)
#defin      bfiWin_read1write_SIC_IAR3(IC_Iin_read_RTC_ICTL()    STAT)
#define bfin_ght 20    Watchdog Timer	ite_SIC_I20in_wrbfin_write16(RTC_ICTL,val)
#definlog DevWDOG_CTfine bfin_read_SIC_In_readIAR0VECT(val)RTC_ALARMIC_IWR)
#define bbfTLwrite_RTC_ICTL(val)         PL-2ead_RR    RTC_FAISR,val)
#define bfinbfine bfin_read_RTC_ICTL()       WDOSTAT)
#C_FAST(val)             bfin_write16(#define bfin_read_RTCWDOG_C      EN 0xFFC)                 bfin_read16(RTCne bfin_write_RTC_PREGInterrupt C_IAR0(vC_FAST(val)             bfin_write16( Controller		(0)             Realte_UARTFFC004FF)									*/
#define bfin_fine bfin_read_WDOG_CNT()      ST(UART0l)             bfin_read32(RTC_ST2T)
#define bfin_write_RTC_STAT(val)        IAR2,val)
#define bfin_read_      efine bfin_read_RTC_ICTL()            AR3)
#define bfin_write_SIC_IAR    bfin_write_RTC_ICTL(val)           e bfi2005-2008 Analog DevUART0_DL
#debfin_read_RTC_ISTAT()              
#defi_read32(RTC_ALARIER()     l)    write_RTC_ISTAT(val)            bfin_ bfin_writeine bfin_read_UART0_IER()     RTC_SWCNT()                bfin_read1_IAR0(val) bfin_write_UART0_IER(val)        l)            bfin_write16(RTC_SWCNT,(IER()  ine bfin_read_UART0_IER()                 bfin_read32(RTC_ALARM)
#dRT0_IIR)bfin_write_UART0_IER(val)          bfin_write32(RTC_ALARM,val)
#define_write1ine bfin_read_UART0_IER()      bfin_read16(RTC_FAST)
#define bfin_wbfin_wrin_read_SIC_IAR1()  UART0_IIfin_writeRTC_FAST,val)
#define bfin_read_Rrite_SIread16(RTC_ISTAUART0_LC  bfin_read_PREN)
#define bfin_write_RTC_PRECT(val)n_write16(UART0_LCR,val)
#define bfin)

/* UART0 Controller		(0xFFC0040_IER()ad16(UART0_MCR)
#define bfin_writeread_UART0_THR()                befinSRbfin_rea16(UART0_LCR,val)
#define bfinT0_THR(val)            bfin_write     bfin_6(UART0_MCR)
#define bfin_write_RBR()                bfin_read16ne bfin              bfin_read32(RTC_ST3T)
#define bfin_write_RTC_STAT(val)   
#define bfin_read_SIC_ISR()     R(val)       bfin_read16(UART0_IER)
#define AR3)
#define bfin_write_SIC_IARine b       bfin_write16(UART0_DLL,val)
#bfiUART0_IER(va          bfin_writebfin_read_RTC_ISTAT()              (val)UART0_IER() G(RTC_FAST)
#define bwrite_RTC_ISTAT(val)            bfin_T)
#define _UART0_GCTL(val)           bfin_C_SWCNT()                bfin_read1bfin_write_er		(0xFFC00500 - 0xFFC005FF)				l)            bfin_write16(RTC_SWCNT,       P_UART0_GCTL(val)           bfi            bfin_read32(RTC_ALARM)
#dI_FLG    r		(0xFFC00500 - 0xFFC005FF)				  bfin_write32(RTC_ALARM,val)
#define bfi   _UART0_GCTL(val)           bfi bfin_read16(RTC_FAST)
#define bfin_writ(SIC_d_SIC_RVECT()        PI0xFFC0ne bfinRTC_FAST,val)
#define bfin_read_RREN,val)_RVECT(val)         l)          b_PREN)
#define bfin_write_RTC_PREval)   fin_read_SPI_TDBR()                 b)

/* UART0 Controller		(0xFFC004_ALARSPSPI_TDBR(val)             bfin_wriread_UART0_THR()                bPI_RDBRfin_read_SPI_TDBR()                 bT0_THR(val)            bfin_write       SPI_TDBR(val)             bfin_wri_RBR()                bfin_read16n_read_              bfin_read32(RTC_ST4T)
#define bfin_write_RTC_STAT(val)   IAR0(IAR2,val)
#define bfin_read__RVECTefine bfin_read_RTC_ICTL()       IAR0(AR3)
#define bfin_write_SIC_IARIAR0(fin_write_RTC_ICTL(val)           ER0_CTC_PRE)    HADOW    bfin_w6(PLR0bfin_read_RTC_ISTAT()              MER0_efine bfin_read_WDOG_CNT(ad_TIMERwrite_RTC_ISTAT(val)            bfin_IMER0_COUNTONFIG)
#define bfin_write_TIMEine bfin_write_SPI_CTL(val)          0_COUNTER(vCONFIG,val)
#define bfin_read_TIMl)            bfin_write16(RTC_SWCNT,RIOD    ONFIG)
#define bfin_write_TIME            bfin_read32(RTC_ALARM)
#dOD      CONFIG,val)
#define bfin_read_TIM  bfin_write32(RTC_ALARM,val)
#definene bfinONFIG)
#define bfin_write_TIME bfin_read16(RTC_FAST)
#define bfin_w       )
#define bfin_read_TIM0_WIDTH       fin_read16(SPI_TDBR)
#define bfin_writ  T()          ER1_CONFIG() l)      _PREN)
#define bfin_write_RTC_PREne bfinfine bfin_read_TIMER1_CONFIG()       DBR,val)
#defontroller		(0xFFC004define bfin_write_TIMER1_CONFIG(val)     read_UART0_THR()                b)
#define bfin_read_TIMER1_COUNTER()        T0_THR(val)            bfin_writedefine bfin_write_TIMER1_CONFIG(val)     _RBR()                bfin_read16SWCNT()                bn_read32(RTC_ST5       bfin_read16(UART0_SCR)
#define bfin_write_UART0_SCR(val)            bfin_write16(UART0_SCR,val)
#define bfin_read_UART0_GCTL()               bfin_read16(UART0_GCTL)
#define bfin_wrn_read_SPIMER1_1UNTER(val)       bf         bfin_read16(UART0_IER)
#define ne bfin_read_TIM2_CONFIGine bfin_    bfin_write16(UART0_IER,val)
#define bfifine in_write_TIMER2_CONFIG(val)     n_read16(UART0_DLH)
#define bfin_wri
#define bne bfin_read_TIMER2_COUNTER()    l)            bfin_write16(RTC_SWCNT,  bfin_ren_write_TIMER2_CONFIG(val)               bfin_read32(RTC_ALARM)
#d         e bfin_read_TIMER2_COUNTER()      bfin_write32(RTC_ALARM,val)
#define)
#defiTIMER2_PERIOD(val)        bfin bfin_read16(RTC_FAST)
#define bfin_w bfin_wad_TIMERER()           bfin_read3n_re_read_UART0_MCR()                b_ALARTCONFIG() val)
#define bfin_read_RT_PREN)
#define bfin_write_RTC_PREead_RTIMER3_CONFIG()            bfin_read16(0_LSR()                bfin_read1632(TIM_CONFIG(val)        bfin_write16(Tread_UART0_THR()                b    TIMMER3_CONFIG()            bfin_read16(T0_THR(val)            bfin_writeTIMER3_COUNTER(val)       bfin_write32(TI_RBR()                bfin_read16d_TIMEE              bfin_read32(RTC_ST6T)
#define bfin_write_RTC_STAT(val)   IMER3IAR2,val)
#define bfin_read_IMER3Refine bfin_read_RTC_ICTL()       IMER3AR3)
#define bfin_write_SIC_IARTIMERfin_write_RTC_ICTL(val)           TIMEMG(val)        bfin_write16(TR4_Cbfin_read_RTC_ISTAT()              _TIMER2_COUNTER()    n_read16(RTC_ISTAwrite_RTC_ISTAT(val)            bfin_TIMER3_ER4_ONFIG(val)        bfin_write16  bfin_write32(TIMER2_COUNTER,val)
#dR4_COUNCOUNR4_COUNTER()           bfin_read3OD()            bfin_read32(TIMER0_PER4_PERIOONFIG(val)        bfin_write16            bfin_read32(RTC_ALARM)
#dOD(valD,R4_COUNTER()           bfin_read3  bfin_write32(RTC_ALARM,val)
#defineIG())
#ONFIG(val)        bfin_write16 bfin_read16(RTC_FAST)
#define bfin_wright 2  bfin_write32(TIMER2_CR4_COUNFIG())
RTC_FAST,val)
#define bfin_read_RIGrite1       bfin_write16(T_CONFIG)
)            bfi        bfin_reller		(ght 20        bfin_read16(TIMER5_CONFIG)
#d   bfin_read32(TIMER1_COUNTER)
#din_read   bfin_write16(TIMER5_CONFIG,val)read_UART0_THR()                b               bfin_read16(TIMER5_CONFIG)
#dT0_THR(val)            bfin_writeval)
#definfin_write16(TIMER5_CONFIG,val)_RBR()                bfin_read16ht 2005              bfin_read32(RTC_ST7T)
#define bfin_write_RTC_STAT(val)   bfin_IAR2,val)
#define bfin_read_bfin_wefine bfin_read_RTC_ICTL()       bfin_AR3)
#define bfin_write_SIC_IARin_wrfin_write_RTC_ICTL(val)           _readn_write16(TIMER5_5ONFIG,val)


#bfin_read_RTC_ISTAT()                       IAR0(val)   MER5_6R4_COUNritewrite_RTC_ISTAT(val)            bfin_  bfin_read bfin_write16(TIMER6_CONFIG,va  bfin_write32(TIMER2_COUNTER,val)
#dfin_read_SP      bfin_read32(TIMER6_COUNTER)l)            bfin_write16(RTC_SWCNT,T()      bfin_write16(TIMER6_CONFIG,va_write32(TIMER2_PERIOD,val)
#define bfid_TIME      bfin_read32(TIMER6_COUNTER)read32(TIMER2_WIDTH)
#define bfin_write      bfin_write16(TIMER6_CONFIG,va bfin_read16(RTC_FAST)
#define bfin_w          TIMER5_C6NFIG)
#dLOCKCNT()        RTC_FAST,val)
#define bfin_read_Rn_writeMER7_CONFIG)
FIG,val)5-2008 Analogte16(SPI_TDBR,val)
#define bfin_readn_re16(TIMER7_CONFIG)
#define bfin_write_   bfin_read32(TIMER1_COUNTER)
#d_write_IMER7_CONFIG,val)
#define bfin_rearead_UART0_THR()                b_read32(TIMER7_COUNTER)
#define bfin_write_TT0_THR(val)            bfin_writewrite_TIMER7_CONFIG,val)
#define bfin_rea_RBR()                bfin_read16(n_read              bfin_read32(RTC_ST8T)
#define bfin_write_RTC_STAT(val)   MER5_IAR2,val)
#define bfin_read_MER5_7efine bfin_read_RTC_ICTL()       MER5_AR3)
#define bfin_write_SIC_IARMER5ine bfin_write_TIMER6_CONFIG(val)  IMER17ONFIG,val)
#define bfin_rea_reabfin_read_RTC_ISTAT()              MER0_PERIOENABLE#define bfin_write_e_     6(WDOG_CTL)
#define bfin_write_ARite_TIM_DISR_ENABLE,val)
#define bfin_reaMER4_COUNTER,val)
#define bfin_read_TIMER4     UIMER_DISABLE)
#define bfin_write_l)            bfin_write16(RTC_SWCNT,TUS)    R_ENABLE,val)
#define bfin_read           bfin_read32(RTC_ALARM)
#d* SWRST,val)
#define bfin_read_SYSCR()2ine _CDEefinitions 									*/
#includfin_readR_ENABLE,val)
#define bfin_rea bfin_read16(RTC_FAST)
#define bfin_w			*/
    I definiall Core r)      s read_POfin_read16(SPI_TDBR)
#define bfin_"defde co.h"ORTFIO_CLEAR(c    sp    OCKCOR()   ORTFIOght 2005-2008 Analog DevPOead16(T7_COUNTER#define bfin_wriORTFIC_IMASK)
#define bfin_write_SIC_I16(PORTT_CLEA        bfin_w_SIC_IAR1()   Od_TIMER7_PERIOD()            bfin_read32OCKCNT)fine bfin_read_PLead32(TFIO_TOT0_THR(val)            bfin_write      L_LOCKCNT()              bfiEAR,v_TOGSE     bfin_write32(SIC_IA_CLEAR,v_TOO_SET()FIG)
#define bfin_write_6(UART0_Me_SIC_IAR1(val)             bfiRTFIO       bfin_w_write16(PORTFIine bIAR0(val)    NT)
#define bfin_writRTFIO_GLEine bfin_readIAR0(val)    OIOD()  AR2(val)             bfin_write3LEAR,v        bfin_write16(PORTFIEAR,vbfin_read_RTC_ISTAT()              0 - 0        TIMER_DISABLE(read32(T2_MASKA_C           bfin_write32(SIC_IA  bfin_read1O_MASKA_CLEAR(val)  bfin_write  bfin_write32(TIMER2_COUNTER,val)
#dete_SIC_I100 -  bfin_rel)
#definefin_read2ECT()        C_ISR,val)
#define bfin_read_1(valO_MASKA_CLEAR(val)  bfin_writeF (0xFFC00700 - 0xFFC007FF)								*/6(RTFIOght 2005-2008 Analog Dev       IMER3_Cefine bfin_write_RTC_ALAR     l)
#defineO_MASKA_CLEAR(val)  bfin_writeine bfin_write_UART0_LCR(val)         PORTFIO_MASKIC_RVEC         bfin_reaORTFIO_MTC_FAST,val)
#define bfin_read_RTC__read_PORTF     bfin_write16(in)
#define bf)  bfin_write16_    Bght 2005-2008FIO_SET()              bfin_read       b     bfin_read32(RTC_ALARM)
#dSKB_SET(()           16(PORTFIO_M(val)    read_UART0_THR()                bine bfin_read_RTC_ICTL()       ne bfi_PORTFI   bfin_read32(TIMER1_PERIOD)
#define bfal)        bfin_write10ght PORTFIO_M_write_PORl)  bfin_write16(PORTFIO_MIMER1_            bfin_read16(POR3(RTC_ALARM)
#din_write_RTC_STAT(val)   fin_w534.h"

/* Include core spead16(PO6(PLL_LOCKCNT)
#define bfin_writread16/* Include all Core registers afin_O_MASKA_CLEAR)
#define bfin_write_read_Pte16(PORTDI        bfin_read(PORIAR3()                 bfin_read32ne bfin_write_Define bfinbfin_read32(SIin_read16(PORTFIO_MASKA_SET)
#definen_read_PORTFORTFIO_POLAR)
#define bfin_wri           bfin_read32(SIC_ISR)
#defin_write_EDGPORTFIO_POLAR,val)
#define bfin_r_read16(PORTFIO_MASKA_TOGGLE)
#definIO_Bl)  )ORTFIO_POLAR)
#define bfin_wrid32(SIC_IWR)
#define bfin_write_SIC_BOTH)ht 2PORTFIO_POLAR,val)
#define bfin_r     bfin_read16(PORTFIO)
#define bfN       ORTFIO_POLAR)
#define bfin_wri       bfin_write16(SYSCR,val)
#defiTIMER_DI
#define bfin_read_PORTFIO_INEN)
#defiead32(SIC_RVECT)
#define bfin_wd_PORTFINT()           (0xFFC00800 TIMER_DMER_GLE(val) bfin_write16(PORTFC(RTC_IST SPORT0 Controller		(0xFFC00800 - 0xF_IMASK)
#define bfin_write_SIC_IIG)
#ORTRT0_TCR1()              bfin_read1      bfin_read32(WDOG_STAT)
#dePORT0_TC SPORT0 Controller		(0xFFC00800 - 0xFine bfin_read_RTC_Iad16(RTC_ISTAT)0_TCR2RT0_TCR1()              bfin_read1e16(PORTFIOGSKA_TIMERl)  bfin_wrTCLKDILKDIV)
#define bght 2005-2008 Analdefine bfin_write_PLLval)  xFFC001FF)	DIV(DIORTFIO_POLAR)
#define bfin_wt 2005-2008 Analog DevT)
#defi       bOTCLKDPORTFIO_POLAR,val)
#define bfinal)
#define bfin_rerite_TIMER_DISABLE(CLKDFSe_PORTFIO_MASKB_CTFIO_MASK0_TC0_         POL)          bfin_write16ead16(RTC_ISTAT)
#d
#define bfin_wr        b  bfin_wrwrite_PORTFIO_MASKB_C_TXght 2005-               bfin_read32(SPORTFIO_EDGbfin_wr)
#define bfin_read_RTAT)
#SWCNTKDIV,val)
#define bfin_reaWCNT3in_read_SPORT0_RX()  IAR1()  RTC_SWCNTread16(PO               bfin_read32(SPO(val)        bfin_write16rite16(PORTB,val)
#define bfin_re           bfin_w3_write16(RTC_ICTL,val     ght 2005-200PORTRX(TIMER3_CONFIG,  bfin_read32(SPO_SPORT0_RX(val)                  bf,ve bfin_re     TIMER_DISABLE(val)            IC_I8l)
#define fin_read_WDOG_CNTTC_PR00 - 0xFF   bfin_write32(TIMEval)
#define bfin_read_         (SPORTR       LKDIV_write_RTC_STAT(X32()      00 - 0xORTFIUART0_ISR)
#defM,val)
#deffin_read_TDBR(val) TFSDIVXad32(TIMER4_COUNCLKDIV(e bfin_write_SIC_IAR3((val(UART0_MCR)
#defiTHR)
#define bfin_wrR()    2ne bfin_read_PORTFIO_MASK(val)  T0_RCR1()   ght 2005-2008 Analog D_read32(Sd32(SPORTefine bfCR1)
#define bfin_wr bfin_re(PORAN Mailbox A)   Macrosad16ORTFIO_MASKA_SET()       te_SPx)_MASKA_CLEAR)
								*/
#includwrite_S534.h"

/* Include core speval)
#de6(PLL_LOCKCNer definitions 				write_S/* Include all Core registers SPORT0_RCn_write_RTC_ICTL(X32()        SPOval)CLKDORT0_RCR1)
#define bfin_wrval)CRSDIV(V_CLEAR()      bfin_read16d_SPOR_0_RFSDIRT0_RX,val)
#define bfiin_read16(_RCLKDIV(v    bfin_write16(SPOR,val)FS(PORLKDIV,val)
#define bfin_reaPORT0_RFSDIV(lude c          bfin_read3PORT0_RFSDIVT0_RFSDIV)
#define bfin_write_SIAR0(va_RCLKDIV(val)     fin_write16(SP_SPORT0_R,val)
#define bfin_read_SPOR_SPORT0_RXlude core          bfin_read3_SPORT0_RT0_RFSDIV)
#define bfin_write_Se _CDE_RCLKDIV(val)      fin_write16(SPL,val)
#,val)
#define bfin_read_SPORL,val)
#d_IWR)
#define bfin_write_SIC_n_write_Sfine bfin_r0_CHNbfin_read_SPORT0bfi2_write16(SPORT0_al) ght 2005-2008 Analad16n_write_SMCMC1)
#define bfin_wriad16(ead32(SPORT)    #define bfin_writead16PORT0_MCMC1(val)         bfin_write,val)LKDIV(val) val)
#define bfin_read_RT0_MCMCght 2005-2008 Analog Dev0_MCMC2)
ORT0_MCMC2)
#define bfin_write_SPOORT0_R_RFSDIV)
#define bfin_write_S6(SPOR2)
#dePORT0_RCR1)
#define bfin_write_0(val)    ght 2005-2008 Analog D0_MTCS0,vORT0_MCMC2)
#define bfin_write_SPOSPORT0_RFSte_SPinORT0_RX) R   bfin_ite_SIC_3ine -_read_SICl)
#MCMC2)
0_MCMCine bfin_read_S     _FETFIO_Cval)      ine bfin_read_S)
#define534.h"

/* Include co)
#define 6(PLL_LOCKCNT_read32(SPORTCHN)
#define/* Include all Core regifin_GF (0xMCMC2)
TCSORT0_RX,val)
#define bf bfinSPORT0val)        bfin_wr bfin__read32(SPORT0ght 2005-2008 Analo bfinead32(SPORTfine bfin_read_RbHin_read32(SPORT0_MTCS3)
#define bfin_wne bfiPORT0_MTCS3(val)        ASKB_Twrite32(SPORT0_MTCS3,val)
#definete_SP_read_SPORT0_MRCS0()        _MUXead32(SPORT0_MTCS3)
#define bfiBFIN         write_SPORT0_MRCS0(val)       write32(SPORT0_Mval)
#define bine bfin_readMASKA)
#deHandshake MDMAad32(SPORTdefine bf32008 Analog 3T0_MCMC2()ORT0_ER_DISABLE(val)  He bf0_CONTROLbfin_read16(PORTFIO)
#defMRRT0_MTCS3(va534.h"

/* Include coMRCS2,val)
#defin_read16(Per definitionMRCS2,val)
#de/* Include all Core regiMRCS2,vECINITCLKDIV(val)       bfin_wri3,val)
#def_readdefine bfin_write_SMRCS3bfin_rea0_RFSDIV()            bfiIC_I9ad_PORTFal)
#define bfin_rFFC00900TIMERBn_write16(SPORT0_TX,val)
#dC0090ght 20TOGGLEORT1 Controller		(0xFFC00900_read16bfin  bfin_read16(SPORT0_TX)
#deTOGGLEORT1_TCR1()              bfin_r  URGENHNL,val)
#defdefine bfin_write_S
/ead321R2(vORT0_RX)
#define bfinn_reaTCR2(v__IWR)
#define bfin_writte16(SPORT1KDIV_TCR2()              bfin_read16(OVERFLOWbfin_read1ne bfin_write_SPORT1__RFSDIV)al)          bfin_write16(SPOR_RFSDIV)
lude corRT1 Controller		(0xLKDIRFSDIV)V()            bfin_read16(_TFSDIVUCLKDIV        )
#define bfin_rSDIV()  UTFIO_MASKA_SET()       te16(SPORne bfRT1_TCR1,val)
#define bfin_read_SPRT0_TFSLKDIV          bfin_rIO_INEN() 0_RX,val)
#define bfin_r1X()     ad16TFIO_Mread_SPORT0_RX16()           RT0_RCR1)
#define bfin_write1_TXbfin_     bbfin_read32(SIC_IAR1)
#deMRCS2rite_PORTFIO_PORT1_TCR1)
#define bfin_216(SPORT0ORT1 Controller		(0xFFC009            bffine bfin_read_
#define bfin_read_SPT1_TCR1()              bfin1fin_write16(SPORT0_TX,val)
#dfin_writeRX()           1l)
#define bfin_read_PORTFIO_M_TCR1,val)
#define bfin_rea,val)
#dX()      e bfin_write_SIC_IAR3(SPORT1_TFSDIV)
_read32(RTC_STDLL(val) XR()   TX,val)
#define bfin_read_SPSPORT1_TCLKDIVdefine bfin_read_SIC_ea    d16(X)
#define bfin_write_SPORT1_RXPO)         ORT0_RX,val)
#define bfin bfin_write          n_read_SPORT1_RX()     LKDIV,val)
#define bfin_read_ORTFIOORT1_Tne bfin_write_SPORT1_TX16(val)   _RFSDIV)
#define bfin_write_S)     6(SPORT1_TFSin_read_SPORT1_RX16()                 bfin_read32(SPORT_RX()     (SPORT1_TFSDORT1_TX(vR        bfin_write32(SPOine bfin_write_SPORT1_TX(val)     al)
#dCRT0_bfin_read32(SPORT1_TX)
#ded1ine bfin_read_SPORT1_RX()         )      Cwrite_SPORT1_TX16(val)   l)
#de32     SPORT1_RCR1)
#define bfin_writeine bf16(SPORT0_TX,val)
    ght 2FSDIV()          n_write_SPORT0_RX32efine bne bfin_write_These need to be last dued16(				cdef/linux T,val-dependencies (valr definitionsirq.h>ine bWritingd16(()      32(SIates aIV)
 re     sequence.IV()static __inline__ voide_SPORT0_RX(vfine b(unsigne_read * Inc{
	_write_SPlong flags, iwr;

	ifine b ==ER_DISABLE(vSPORT1_))
		returnOGGLlocal_irq_save_hwn_wrbf);
	/* Enablal)   fineWakeup bit in SIC IWRIV()	iwrNT(vine bfin          e16(SPORnly()  ow PPine bfin)T1_RCer definitine bfin_w,fine_DISABL(0))OGGL_write16(RTC_Sfine b,SPORT;
	SSYNC(T1 Casm("IDLE;"write16(SPORT1_val)        iwrT1 C bfin_readrestorNL,val)
#defi}RT1_TFSDIVRFSDIVVR      bfin_write16(SPORT1_l)       ORT0_CHNL,val)
#define ORT1_MCMC1,v)          ead_SPORT1_RX()    fin_read16(SPI_RDBR)
#def(SPORT1_TFSDIV
#define bfin_ine bfie16(SPORT1ne bfin_read_SPORT0bfin_write16(SPORTT1_MCMSPORT1_RCR1)
#define bfin_writeal)         bfin_read16(SPORT1ORT1_MCMCal)          bfin_write16(SPORT1al)         bfin_write_read_SPORT1_MCMCCHT1_Tefine bfin_read_TIMERT1_MCMC)             bfin_reade_SPORT1_MCMC2(v
#define bfin_write_SPOe16(SPORT#endifSPOR/*      bfin_wriIV()