...
#define MCF_EPORT_EPPAR*****2_BOTH *********3*******************/
...
/*
 *	m532xsRIS/****ColdFir4 5329 registers
 */

/**********FALL*****oldFir8 5329 registers
 */
...
/*
 *	m53********2EG32(x)**********tile unsigned long  *)(x))
#3**********REGF_RE/
#ifndef*******im_h********4*)(x))
#define MCtile unsigned long  *)(x))
#5*)(x))
#defin***********/
...
26RT0 */
#  /* 7*)(x))
#defin8re 5329 registers
 upt number for UART1 */
#defineIEupt number for UART1/

#dMCFINTIEdefinine MC(*(volatile unsigned longe MCFINT_U***********fine6pt number for UART2 */MCFINT_U *)(x)**************REG08pt number forMCFINT_U/

#char532x SIM ************INT_VECBAMCFINT_U648004
#define	MCFor UART0 */
#define MCFINT_UInterrupt number**** or UARCF_R*******MCFINT_UART1RT0 */
#d7M_IPRL
#define	MCFSIM_IMRL		0xFC04800C1#define	MCFSupt number for UART1      e*****Interrupt n number for UART2 */

#define*****************REG16(0xFC098000)

/*
 *	Defi_ICR1	32x SIM regegister set addresses.
 */
#dl*****FSIM_IPRL				0xFC048004
#define	MCFSIM_IS*****C048000
#dedefine	MCFSIM_IPR		MCFSIM_IPRL*****e	MCFSIM_IMIMRL		0xFC04800C
#define	MCFSM*****	0xFC048008
8
#define	MCFSIM_IMR		MCFSIM_IMRL
#define	MCFSIM_ICR0			0xFC048040	fine	MCF	MCFSIM*	Som91	
/*
 *	Som1umber for UART2 */

#defineFC04theM_WCR	MCF_REG16(0xFC098000)

/*
 *	DefiFSIM_ICR32x SIM register set addresses.
 */
#dFSIM_ICRFSIM_IPRL		0xFC048004
#define	MCFSIM_IFSIM_ICRC048000
#define	MCFSIM_IPR		MCFSIM_IPRFSIM_ICRe	MCFSIM_IMRL		0xFC04800C
#define	MCFSFSIM_ICR	0xFC048008
#define	MCFSIM_IMR		MCFSIM_IMRL
#define	MCFSIM_ICR0		FxFC048040	
#define	MCFSIM/
#deFabove...
 * symbol defines _ICR2 above..fines 1 ICR */
#define	M3 above...
 3 symbol dfines ine	M4 above...
 4A 1 ICR */
#define	M5efines 	Som5A 1 ICR */
#define	M6 above...
 6	
fines */
#define	M7 above...
 7 symbol defines ines  above...
 8A 1 ICR */
#define	M9 above.48040
 1 ICR */
#define	M10		ymbol definINTC1ne	M0 above..C04048004
#defineefine	M_TIMER1	(/*
 */
#endif	/*  (*(volatiupt 