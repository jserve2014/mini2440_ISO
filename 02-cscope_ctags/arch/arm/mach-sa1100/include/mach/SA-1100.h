...
#define LCD_Int26_7	0x3 Vers	/*SA-1 Intensity =  26.7%  	C4/15 *	FILE    	SA-1100.33_3	0x4Version 	1.2
 *	Author  	C33.3ight 3/9
 *	FILE    	SA-1100.40_0	0x*
 *sion 	1.2
 *	Author  	C40.0ight 2/*
 *	FILE    	SA-1100.44_4	0x6nuary 1998 (April 1997)
 *	4.4ight (c, Palo Alto, CA
 *	Dat5    	J7nuary 1998 (April 1997)
 *5System  1/2n of constants related5_6	0x8 StrongARM
 *	        	SA-15.6ight 5ion of constants relate6    	J, Pasion 	1.2
 *	Author  	C6System  3/*
 *	FILE    	SA-1100.6
 *
 *Athe
 *	        	StrongARM Spyright 6ion of constants relate7
 *	  Bthe
 *	        	StrongARM 7Laborat11c) Marc A. Viredaz, 1998    	JCthe
 *	        	StrongARM 8System  4/*
 *	FILE    	SA-1100.88_9	0xDdif

#include "bitfield.h"
8.9ight 8ion of constants relate10    	JEthe
 *	        	StrongARM10100 microthe
 
#define SA1100_CS1_PHYA	0xF08000000
#define SA1100_CS2_PHYS	0x10000000
the
 fine SA1100	 SA1100_C/* (Alternative)define SA1100_0000000
ILE    	SA-CR0		__REG(0xB010ciat)  n 	1.2
Control Reg. 0000
#define SASRnational Associat4on (PCMCIAStatusts
 */	FILE    	SDBAR1national Associa1ion (PCMCIADMA Base Addreson Spacchannel 1ce [byte]   *C
#define PCMCIASp	(4* PCMCIA Pap)	/CurrentMCIA Space [byte]             */
#deBAR2efine PCMCIASp	(48PCMCIAPrtSp)	/* PCMCIA Space [byyte]     2       */
#defintrSp	PCMCIAPrtSp	/CPrtSp	/* PCMCIA I/O Space [byte]         */ne PCMCIAMemSIntedefine PCMCIASp	(2ion (PCMCIA) sockets
 */        */
#dIntetrSp	PCMCIAPrtSp	2* PCMCIA Pa) sockets
 */A0Sp	PCMCIASp	/* 3AIOSp	/* PCMCIA 0* PCMCIA At) sockets
 */3 Memory Card Inter_LEN	0xciati001on 	1.2
ENable Personal Computer 00000
#define SA
#deCMSe PCMCIA0M20x48Color/Monochrome display SelectSpace [byte]    */
	PCM	(    */

#*0)0x48Sp	PCMMCIA 1 SpCIA 1 I/O Space [pace [byte]    */IASpne PCMCIA1IO1p	PCMCIASp	/* PCMCIA 1 SpI/O Space [byte]       */
#deSD#define PCM40x48Single/Dual pa     PCMCIA 1 Attr000
#define SA1100_CS5_PHYS	0x48ace [byb)	        	/* PCMCIA [0.Space [byte] */
#dnglne PCMCISDIOSp	PCMCp	PCMCSp	/* PCMCIA 1 Memoryry Space [byte]    */AMem*/ \
       Sp	PCMCAMemSp	/* PCMCIA 1 MemoryCIASp)
#define _PCMCIAILDMe PCMCIA0M8on 	1.2
DisMemSpdone (LDD* Personal 000
#define SA1100_CS5_PHYS	0x48interrupt Mask (dCMCIA * Personapace [byte]    */BAttr(Nb)	  100x48* PCMCIA Spacupdate (BAU* Person    */ \
                	(_PCMCIA (Nb) + 2*PCMCIAPrtSp)
#define _PCMCIAMem(Nb)	 ERttr(Nb)	  2MCIA PCMCIRror (BER, IOL, IUfineOU,                	(_PCMCIA (Nb) + 3IUU, OefinO _PCOCIA0and OU  */ \    */ \
                	(_PCMCIA (Nb) + 2*PCMCIAPrtSp)
#define _PCMCIAMem(Nb)	 PA#define PC8MCIA Passive/Ac/*
 MCIA 1 Space [by*/
#define _PCMCIA0Masne PCMCIPAIOSp	PCMC	/* PCMPCMCIA 1 (STN[0..1]        e [byte]    */ActCIA1	_PCMCIASp	PCMCIA 0 Memory    (TFT* Personal C _PCMCIAMem(Nb)	  LEe PCMCIA10MCIA Mig/Little Endian sCIA(Nb)	     */
#define _PCMCIAtlEndne PCMCIBLEOSp	PCMC(1)	/* PCMCIA frame bufferefine _PCMCIAMem(Nb)	  ige _PCMCIA1Mem	_Sp	PCMCBig	/* PCMCIA 1 Memory      Sp)
#define _PCMCIAIOPDe PCMCIA2CMCIAADouemSpPixel Data (mASp	/* PCM_PCMCIA0Attr	_PCMCIAAttr (0)	/* PCCIA 1 Spmod * Personal Computer Meme [byte]    */4Pixfine PCMCIA1DPDOSp	PCMC4-r0UDC/clockCIAAttrSp	/*(UDC) con
#define SA1100_CS5_PHYS	0x48[0..1]                             */
#define _PC8 (read/write).
 *  Sp	PCMC8CAR 	Serial port 0 Universal Serial Bus (USB) Device
 *              	Controller (UDC) Address Register (read/wPDD	Fld (8, 12p	PCMPalettePCMCIrequest DeA 1 Memory Space [byte]    */

#define _PC[Tmem]b)	        	/* PCMCIA [0..1]               DMADel(Tcpu* Perso     p(read/write).
 *    Ser0UDCIMP*/ \ial Bus (USB) Device
 *        [0..510 MaxiSB) Device
 *      read/write).
 *    Ser( Maxim/2 << FShft IA1	_PCMDD))mory Card InSR_LD*
 * Regi0MemSp	PCMCPCMCIA ADtrib	/* PCMCIA [0..1]           SR_BAUdefine PCMCIA1S* PCMCIA SpacU       read* Perso Ser0UDCCS1	SeriaERine PCMCIA1MemSBus              	/* PCMCIA [0..1]           SR_ABCtr(Nb)	        AC Bias rial pCounNb)	        	/              	(IOL    	/* PCMCIA Input FIFO Over-run Lowler (UDC)erial Bus (USB) Device
 *       p	/* Pb)	        	/* PCMCIA [0..1]           eriaU Bus (USB)      e
 *       Und     	Controller (DC) Control/Status register end-point 2
 *              	(input, read/write).
 * O port 0 Un4Device
 *              	CUpproller (UDC) Control/Status register end-point 2
 *              	(input, read/write).
 *   port 0 Unem (0)ial port 0 Universal C 	Serial pDC) Control/Status register end-point 2
 *              	(input, read/write).
 *Ol Bus (USBPCMCIAAOut *              	Controller (
 *    Ser0UDCDR 	Serial port 0 Universal Serial Bus (USB) Device
 *                Ser0UDCsters
 ) Data RegisUniversal Serial Bus
 *    Ser0UDCDR 	Serial port 0 Universal Serial Bus (USB) Device
 *               port 0 U4r (UDC) Data Register (read   	(read).
 *    Ser0UDCDR 	Serial port 0 Universal Serial Bus (USB) Device
 *             unt regist8UDC) Status Register (read/wC 	Serial DC) Control/Status register end-point 2
 *              	(input, re	PCMCIASp	/* P_PPL *    6, 4     	0UDCs Per Line/16 -x100000UDC) control registe1_DisWdth(0010)* Per	/* PCIA 1 SpWidth [16..1024 pix.] (USB) Device
 *          0 */
#de- 16)porttroller (UDC) 0UDCC))Status reg. endHSWS0	__REG(1Sp	PCMHorizontal Syn	/* nizationler (UDC) Control/Status register end-pulse	__REG( 0 U[Tpix] (L_LCLK)ol/Status reg. endHorSnchint 0__RE)ne Ser /* Ser. port 0 UDC Control/Staread/write).
 *    Ser0UDCCS0	Seriadefine Ser0U[1..64 __REG( Bus (USB) Device
 *          reg. en- 1)oint 1 (output) *HSWdefine Ser0UDCCS2EL_REG(0x    6p	PCMEnd-of-er. 4)  el  Ser0UWaiNb)	 erial Bus (USB) Device
 *       cCCS2	DCD0	__REG(	/* PCMCIA [0..1]             1_EndLnput Mg. enfine Ser(0x80000030) Ser0UDCIMP	 0 */
#define Ser0UDCDR	__REG0UDCCS0	Serial1..256-point 0 */
#erial Bus (USB) Device
 *          x80000028)  /* Ser. port 0 UEL Data Reg. */
#defBne Ser0UDCS20x8000Beginning80000030)  /* Ser. poDC Status Reg. */

#define UDCCR_Urt 0 DD	0x00000001	/* UDC Disabl                 Beg#define UDCCR_UDA	0x             	    UDC Active (r             */
#define UDCCR_RESIM	0x00000004	/* Resume Interrupt Mask, per errata */
#define UDCCR_EIM	0x00000008	/*BEnd-pCIA0IOSp	PCMCI_LPP *    10, Sp	PCM0030)/* SP	/* P 0 UDC ControDC) control registe2d-poHght(er. * Perse Ser0UDCCS1	HeightM	0x000014lines]t Mask, per errata */
#defsk   *28)  /* Ser. port 0     define Ser0UDCC2_V__REG(0x80000018) Vertic port 0 UDC Controldefineble)                       */
#defSer0UDCD0	_lnG(0x8F000010	/* Suspend/Resume inteVrtDC Data reln)       nd */
#define UDCCR_REM	0x00000read/write).
 *    Ser0UDCCS0	Seriaunt reg. end-pefinume Interrupt Mask, per errata */
#defi    ne UDCCR_SUSIM	UDCCR_VC Data Reg. */
#d2_EFe Ser0UDCSR	__REG(0x8000FA 1 MisabSer. port 0 UDC Status Reg. */

#define UDCCR_UDD	0x0#defin     	/* PCMCIA [0..1]             2 */
Frmput M     _UDA	0x0000000acket UDC Active (read) read/write).
 *    Ser0UDCCS0	Serial po255                	  Bus (USB) Device
 *               CCR_SUSIM	UDCCR_EFUDCOMP_OutMaxPkt(SBze)  	/* Ou */
                acket size      *able)                       */
#define UDCCR_                   */              	((Begze) - 1) << FShft (U   	/* Input Maximu Ser0UDCIMP	SeNMAXP	Fld (8, 0)	/* INput MAXimum Packet size - 1   */
                	        	/* [byte]                   B     define PCMCIA0_PC
 *       Sp	PCMr0UDCCCial pDivisor/2 - roceIMP	Serial port 0 Universal Serial Bu0x0005G(0x8PCAR_ADD	Fld STall                      */
#define Ufpix = fcpu/(2*(PCD + 2) */ \
                	(_PCMCIA (Nb) + 3e UD = 0x00000010	*Maxi         */
#define _PCM3_PixClkDiv(Div< FShft (U0_SST	0x00000004	/* [6port4     Mask, per errata */
#def   */- 4	Controller (UDC)     *))ial Bus (USB) Device
 *        ne UDCCS0_DE	0xFlo    Div/0	/* erial Bus (USB) Device
 *        efine UDCCS0_SSE	0x00000000020	tup End (read)   Ceil             *	PCMCIeil. ofe UD      40	/* Servicced Output packet ready    */
   3            	        	/* (write)                         */
#define UDC   *SE	0x000000080	/* Serviced Setup End (write)      */

*/
#define U00000020	/tup End (read)   ACB *       8r mor).
 *    Ser0Uhalf periodM	0x000Serial port 0 Universal Serial Busefine UBIAS* Personal ComputerDCCS1_SST	0x00000008s       */
#d       ).
 *    Ser0Ux000000402port2e)                       */ */
   2            	       ACB* (write)                         acDCCSln UDCCS0_SSE	0x000000CS1_RPE	0x00000004	/* Receive Packet Serv

#define UDCCS1_lol/Status 0001	/* Receive FI00000020	/* Re more   */
   0000002*/

#definrrupt Mask, per errata */
#def */
   1it FIFO 8-bytes or less   */
                	        	/* Service req*/
#define UDCCS     */
#define UDCCS2_TPC	0x00000002	/* Trread)     */
#omplete fine UDCCS1_RNE	0x0PI *    4CSR	__REGAC b*   Pin trauthoions   *all                      */
#define U *	ANb) +        	/* PCMCIA [0..1]             0x0000CntOffce
 *        ).
 *    Ser0Uld (8, 0)	UDCCS2	
#define UDCCS0_OPR	0x00000001	/* O    */

#de     	/* PCMCIA [0..1]B) Device
 *         0FIFO 8-bytes or lePIdefine Ser0UDCC         (Td (8< FShft (UUDCDR_DATA	Fld (8, 0)	/* receive/transmit DATA FIFOs     */

#defi   	/5SB) Device
 *            USB) Device
 *            Inter   */
#define UDCSR_RIR	0x00000002	/VSPe PCMociatiuspend */
#define UDCCR_REM	0x00000080	/* REset interrupt Mask (disaPolarhor e UDCAR_ADD	Fld /* Write Count          n ADDreHne PCMR_RESOSp	PCMC  */

#define UDCOMP_OUTMAXP	Fld ial Bus (USB) Device
 *        aA 0 MeHighC	Fld (4, 0)	/* Write Count          n ADDreLal AsynchronSp	PCMCeiver/Transmitter (UART) control registers
 *
 * Registers
 *    Ser1UTLowWC	Fld (4, 0)	/* Write Count          HESIR	0x20000010	/ /* Ser. port 0 UDC Control/Status reg. end-point 2 (input) */
#define020	/* ReSeT000001erial port 1 Universal Asy UDC Dsal AsyncHronous Recnt 0 */
#define Ser0UDCWC	__REG(00000020)  /* Ser. port 0 UDC Write Co Ser1UTCR0 	Serial port 1r1UTCR2 	Serial port 1 U         AsynSp	PCMCs
 *              	Receiver/Transmitter (UART) Control Register 2
 *             Ser1UTCR1 	Sertup End (read)    CSIR	0x40000010	/0_SST	0x0000020	/* ReSeT00000008tup End (read)      RsEdgal AsyncPConous Recr0UDCCrial pRis    Edgead/writetup End (read)      Fler/Transmitter Sp	PCMCData RegisteFall*                     */
#defineOESIR	0x80000010	/) Data EnMemSp020	/* ReSeT    ,ansmitter (UART) Control Register Ser1UT *              	Controll         	ReceiverutEnsal AsyncOEonous RecT) Status Regi Ser1UTCR0 	Serianchronous
 *                   iverSp	PCMCitter (UART) Status R    Ser1UT*/
