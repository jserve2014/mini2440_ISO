...
#define  Copyread_07-2008 AnalogOUNT()	* Copycens 2007-2008 AnalogL-2 s Inc.
 *
 * Lirighted under the GPL-2 o/*
 * Copyright 2007-2008 AnalogL-2 evices Inc.
 *
 * Licensed under theTXTYPEor later.
 */
...
/* inc core s/*
 * Copyright 2007-2008 Ana core */
#include "defBF549.h"

/* include cINTERVAL( * Copyd_()ecific register nclude cter definitions */
#include <asm/cnclude cdPBlackfin.h>

/* SYSTEM & MMR Anclude cevices Inc.
 *
 * Licensed under the Gore sbfin_read_()ecific registedefine_H
#define _CDEF_BF549_H

/* includef_LPBlackfin.h>

/* SYSTEM & MMRimer Revices Inc.
 *
 * Licensed under the Gnclude cdefBF54x_base.h for the seG)
#define_H
#define _CDEF_BF549_H

/* inclu54x bfin_read_()rocessors */
#include fine bfin_*/
#include "defBF549.h"

/* include cPL-2 or later.
 */

#ifndef _CDE_COUNTEter definitions */
#include <asm/cde all Core registers and bit defin_PERIODevices Inc.
 *
 * Licensed unDMA_ncludRUP or later.
 */

#ifndl)		bfin_writ_H
#define _CDEF_BF549_H
l)		bfin_write/*
 * Copyright 2007-2l)		bfin_writevices 
/* USB Channel 0 Config Registers */
_write_TIMER8_PERIOD(val)	0CONTROcdef(TIMER8_PERIOD, val)_CONFIG(fin_read_TIMER8_WIDTH()		bfi_CONFIG()/*
 *_WIDTH)
#define bfin__CONFIG(e bfin_write_TIMER8_PERIOD(val)	0ADDRLOW)		bfin_read16(TIMER9_CO)		bfindefine bfin_write_TIMER9_CONF)		bfin_	bfin_write16(TIMER9_CONFIG)		bfin#define bfin_read_TIMER9_COUNTER()		bHIGH_read32(TIMER9_COUNTER)
#defead3 bfin_write_TIMER9_COUNTER(val)		ead32MER8_WIDTH)
#define bfin__write32(#define bfin_read_TIMER9_COUNTER(ions fin_read32(TIMER9_COUNTER)
MER9_WIDdefine bfin_write_TIMER9_CONFIGR9_WIDTIMER9_PERIOD, val)
#define_WIDTH, ad_TIMER9_WIDTH()		bfin_read32(TIMER9_ead32(TIMER9_PERIOD)
#define
#define DTH(val)		bfin_write32(TIMER9_WIDTe32(TIMER9_PERIOD, val)
#defineal)
#defiR8_WIDTH(val)		bfin_wri1e32(TIMER8_WIDTH, val)
#define bfin_read_TIMER91CONFIG()		bfin_read16(TIMER9_Cwrite32(fin_read_TIMER8_WIDTH()		bfiwrite32(T	bfin_write16(TIMER9_CONFIwrite32(e bfin_write_TIMER8_PERIOD(val)	1)		bfin_read32(TIMER9_COUNTER)te32(TIMfin_read_TIMER10_PERIOD()		bfl)		bfin_write32(TIMER9_COUNTER, vead32(TIte_TIMER10_PERIOD(val)		bfin_write32(ead32(TIMER9_PERIOD)
#definMER10_WIDread_TIMER10_WIDTH()		bfin_read32e32(TIMER9_PERIOD, val)
#definad_TIMER_te_TIMER10_PERIOD(val)		bfin_writ_WIDTH, vIMER10_COUNTER, val)
#defER9_WIDTH(val)		bfin_write32(TIMERLE1(val)		NABLE1()		bfin_read16(TIMER10_CONFIG()		bfin_read16(TIMER10_CONFIG1)
#de_WIDTH, val)

/* Timer GroubG(val)		bfin_write16(TIMER10_CONFIG, l)
#define	bfin_read16(TIMER_DISABLE1)
#debfin_read32(TIMER10_COUNTER2e32(TIMER8_WIDTH, val)
#define bfin_read_TIMER92CONFIG()		bfin_read16(TIMER9_Crs */

#fin_read_TIMER8_WIDTH()		bfirs */

#d	bfin_write16(TIMER9_CONFIrs */

#e bfin_write_TIMER8_PERIOD(val)	2)		bfin_read32(TIMER9_COUNTER)bfin_rea		bfin_read16(SPORT0_TCR1)
#dl)		bfin_write32(TIMER9_COUNTER, vte_SPORTite16(SPORT0_TCR1, val)
#define bfin_ead32(TIMER9_PERIOD)
#defin0_TCLKDIVPORT0_TCR2)
#define bfin_write_SPead32(TIMER_STATUS1)
#define bLKDIV(valite16(SPORT0_TCR1, val)
#define bE1(val)		bfin_write16(TIMER_ENAV()		bfin		bfin_read16(SPORT0_TCR1)
#defLE1()		bfin_read16(TIMER_DISABLE		bfin_wr)
#define bfin_read_SPORT0_TFSDIV()		bKDIV()		bfin_read16(SPORT0_TG(val)		bfin_write16(TIMER10_CONFIG, SPORT0_TX(ite16(SPORT0_TFSDIV, val)
#definbfin_read32(TIMER10_COUNTER3e32(TIMER8_WIDTH, val)
#define bfin_read_TIMER93CONFIG()		bfin_read16(TIMER9_CRX, val)fin_read_TIMER8_WIDTH()		bfiRX, val)
	bfin_write16(TIMER9_CONFIRX, val)e bfin_write_TIMER8_PERIOD(val)	3)		bfin_read32(TIMER9_COUNTER)e bfin_r)			bfin_read16(SPORT0_RCR1)
l)		bfin_write32(TIMER9_COUNTER, vrite_SPOwrite16(SPORT0_RCR1, val)
#define bfiead32(TIMER9_PERIOD)
#definRT0_RCLKD(SPORT0_RCR2)
#define bfin_write_
#define bfin_read_SPORT0_RX()RCLKDIV(vwrite16(SPORT0_RCR1, val)
#defineE1(val)		bfin_write16(TIMER_ENADIV()		bf)			bfin_read16(SPORT0_RCR1)
#dLE1()		bfin_read16(TIMER_DISABLEl)		bfin_al)
#define bfin_read_SPORT0_RFSDIV()	CLKDIV()		bfin_read16(SPORT0G(val)		bfin_write16(TIMER10_CONFIG, write_SPORwrite16(SPORT0_RFSDIV, val)
#defbfin_read32(TIMER10_COUNTER4e32(TIMER8_WIDTH, val)
#define bfin_read_TIMER94CONFIG()		bfin_read16(TIMER9_C_write16fin_read_TIMER8_WIDTH()		bfi_write16(	bfin_write16(TIMER9_CONFI_write16e bfin_write_TIMER8_PERIOD(val)	4)		bfin_read32(TIMER9_COUNTER)T0_MCMC1_read_SPORT0_MCMC1()		bfin_rel)		bfin_write32(TIMER9_COUNTER, v_MCMC2)
T0_MCMC1(val)		bfin_write16(SPORT0_MCead32(TIMER9_PERIOD)
#definl)
#defin_MCMC2()		bfin_read16(SPORT0_MCMCSTAT, val)
#define bfin_read_Se bfin_wrT0_MCMC1(val)		bfin_write16(SPORTE1(val)		bfin_write16(TIMER_ENA_read_SPO_read_SPORT0_MCMC1()		bfin_readLE1()		bfin_read16(TIMER_DISABLEORT0_MTCS(SPORT0_MTCS0, val)
#define bfin_read_efine bfin_read_SPORT0_MTCS0G(val)		bfin_write16(TIMER10_CONFIG, #define bf1(val)		bfin_write32(SPORT0_MTCSbfin_read32(TIMER10_COUNTER5e32(TIMER8_WIDTH, val)
#define bfin_read_TIMER95CONFIG()		bfin_read16(TIMER9_C_MTCS3(vfin_read_TIMER8_WIDTH()		bfi_MTCS3(va	bfin_write16(TIMER9_CONFI_MTCS3(ve bfin_write_TIMER8_PERIOD(val)	5)		bfin_read32(TIMER9_COUNTER)	bfin_wr val)
#define bfin_read_SPORTl)		bfin_write32(TIMER9_COUNTER, vbfin_reane bfin_write_SPORT0_MRCS0(val)		bfinead32(TIMER9_PERIOD)
#defin2(SPORT0_e bfin_read_SPORT0_MRCS1()		bfin_rite32(SPOORT0_MRCS1)
#define bfin_wte32(SPORT0_MTCS0, val)
#define bfin5E1(val)		bfin_write16(TIMER_ENAval)
#def val)
#define bfin_read_SPORT0_LE1()		bfin_read16(TIMER_DISABLEine bfin_al)		bfin_write32(SPORT0_MRCS2, val)
#RT0_MRCS1, val)
#define bfinG(val)		bfin_write16(TIMER10_CONFIG, PPI0_STATUwrite_SPORT0_MRCS3(val)		bfin_wrbfin_read32(TIMER10_COUNTER6e32(TIMER8_WIDTH, val)
#define bfin_read_TIMER96CONFIG()		bfin_read16(TIMER9_C6(EPPI0_fin_read_TIMER8_WIDTH()		bfi6(EPPI0_H)
#define bfin_write_SPORT6(EPPI0_e bfin_write_TIMER8_PERIOD(val)	6)		bfin_read32(TIMER9_COUNTER)AY)
#def0_HCOUNT(val)		bfin_write16(El)		bfin_write32(TIMER9_COUNTER, v, val)
#HDELAY()		bfin_read16(EPPI0_HDELAY)
#ead32(TIMER9_PERIOD)
#definbfin_writ)		bfin_write16(EPPI0_HDELAY, valfine bfin_write_EPPI0_STATUS(v bfin_reaHDELAY()		bfin_read16(EPPI0_HDELAE1(val)		bfin_write16(TIMER_ENA0_VDELAY(0_HCOUNT(val)		bfin_write16(EPPLE1()		bfin_read16(TIMER_DISABLE0_FRAME()_VDELAY)
#define bfin_write_EPPI0_VDELwrite_EPPI0_VCOUNT(val)		bfiG(val)		bfin_write16(TIMER10_CONFIG, ine bfin_r			bfin_read16(EPPI0_FRAME)
#defbfin_read32(TIMER10_COUNTER7e32(TIMER8_WIDTH, val)
#define bfin_read_TIMER97CONFIG()		bfin_read16(TIMER9_Cin_read1fin_read_TIMER8_WIDTH()		bfiin_read16)
#define bfin_write_SPORTin_read1e bfin_write_TIMER8_PERIOD(val)	7)		bfin_read32(TIMER9_COUNTER)PPI0_CONite_EPPI0_CLKDIV(val)		bfin_wl)		bfin_write32(TIMER9_COUNTER, vPPI0_CONd_EPPI0_CONTROL()		bfin_read32(EPPI0_ead32(TIMER9_PERIOD)
#defin1W_HBL)
#CONTROL(val)		bfin_write32(EPPI0_I0_LINE)
#define bfin_write_EP1W_HBL, vd_EPPI0_CONTROL()		bfin_read32(EPE1(val)		bfin_write16(TIMER_ENAL)
#definite_EPPI0_CLKDIV(val)		bfin_wriLE1()		bfin_read16(TIMER_DISABLEVPL, val)PL()		bfin_read32(EPPI0_FS1P_AVPL)
#deL)
#define bfin_write_EPPI0_G(val)		bfin_write16(TIMER10_CONFIG, al)		bfin_
#define bfin_read_EPPI0_FS2W_LVbfin_read32(TIMKey * License()adER8_WIDTH, val)
#define bfin_readKPAD_CT()		bfin_read16(T	bfin_wr_H
#define _CDEF_BF54	bfin_wri/*
 * Copyright 20	bfin_wrevices Inc.
 *
 * License	bfinPRESCAL sbf2(EPPI0_FS2P_LAVFCLIP(valal)
#define bfin_read_EPPICLIP(val)IP()			bfin_read32(EPPICLIP(valLIP)
#define bfin_write_EPPI0_MSErite32(EPPI0_FS2P_LAVF_wrial)
#define bfin_read_EPPI_writIP()			bfin_read32(EPPI_wriLIP)
#define bfin_write_EPPI0_ROWCG()		bfin_read16(Tne bfin_wrial)
#define bfin_read_EPPIin_writIP()			bfin_read32(EPPIin_wriLIP)
#define bfin_write_EPPI0_STA or later.
 */

#fin_writeal)
#define bfin_read_EPPIrite_IP()			bfin_read32(EPPIrited16(UART2_GCTL)
#define bfin_wrOFTEe cdefBF54x_base.hne bfin_writeite16(UART2_GCTL, val)
#defn_write_bfin_read_UART2_LCR()			n_writeR8_WIDTH(vaPixel Com_LAVF)
#defiositor (PIXC)ER8_WIDTH, val)
#define bfin_read		bfn_write32(EPPI0_FS2P bfin_re_H
#define _CDEF_BF54 bfin_rea/*
 * Copyright 20 bfin_reevices Inc.
 *
 * License bfinPPead_UART2_LSR()			bfinPPead16(UART2_LSR)
#define bfe bfrite_UART2_LSR(val)		bfPP_write16(UART2_LSR, val)
#definLPFad_UART2_LSR()			bfinLPFad16(UART2_LSR)
#define bf#defrite_UART2_LSR(val)		bfLPFwrite16(UART2_LSR, val)
#definAHSTAR or ART2_LSR()			bfin val)
#ad16(UART2_LSR)
#define bf val)
#drite_UART2_LSR(val)		bf val)
#(val)		bfin_write16(UART2_SCR, vENDad_UART2_LSR()			bfinR_SETSET()		bfin_read16(UART2_IERSET,#define bfin_write_UART2_END(val)		bfin_write16(UART2_SCR, Val)
#define bfin_read_UARTn_writSET()		bfin_read16(UART2_IEn_write#define bfin_write_UART2n_writwrite_UART2_IER_CLEAR(val)		bfinSET, val)
#define bfin_reritedefine bfin_read_UART2_RBR()6(UART2_IER_CLEAR)
#define bTWI1(val)		bfin_write16(UART2_SCR, TRANSPdefine bfin_read_UARTin_reaSET()		bfin_read16(UART2_IEin_read#define bfin_write_UART2in_reawrite16(UART2_LSR, val)
#definBval)
#define bfin_read_UAR_FLG)
#ad16(UART2_LSR)
#define bf_FLG)
#drite_UART2_LSR(val)		bf_FLG)
#d_SPI2_FLG()		bfin_read16(SPI2_FSET, val)
#define bfin_r bfinval)	bfin_write16(SPI2_FLG, 6(UART2_IER_CLEAR)
#define defind_SPI2_FLG()		bfin_read16(SPI2_n_write16(UART2_IER_CLEAR,n_writeval)	bfin_write16(SPI2_FLG,)			bfin_read16(UART2_RBR)
#debfin_re_read16(SPI2_TDBR)
#define bfin_fin_write_SPI2_STAT(val)	 Two Wire Interface Registers 2_RDBRd_SPI2_RDBR()		bfin_read1fin_read16(SPI2_TDBR)
#define bfinin_read16(SPI2_CTL)
#definUD(val)DBR, val)
#define bfin_readite16(SPI2_CTL, val)
#define bSHADOW(write16(UART2_LSR, val)
#definINTRrite_UAART2_LSR()			bfinl)	bfin_ad16(UART2_LSR)
#define bfl)	bfin_write_UART2_LSR(val)		bfl)	bfin_write16(UART2_LSR, val)
#definRYCON	bfin_write1632l)		bfte_MXad16(UART2_LSR)
#define bfte_MXV/*
 * Copyright)		bfin_writewrite16(UART2_LSR, val)
#definGU_MXVR_CONFIG(val)		bfin_fin_wad16(UART2_LSR)
#define bffin_wrn_read_MXVR_STATE_0()		fin_w_read16(SPI2_TDBR)
#define bfin__MXVR_CONFIG(val)		bfin_#defiDBR, val)
#define bfin_read_)
#define bfin_read_MXVR_STTATE_write16(UART2_LSR, val)
#definCCBIASVR_CONFIG(val)		bfin_VR_INTad16(UART2_LSR)
#define bfiR_INT_n_read_MXVR_STATE_0()		n_writwrite16(UART2_LSR, val)
#definTCVR_CONFIG(val)		bfin_TCad16(UART2_LSR)
#define bfTCEPPI0_CLKDIV, valMXVR_INT_SR8_WIDTH(vaHandshake MDMA 0ER8_WIDTH, val)
#define bfin_readH, va0_CONFIG()		bfin_read16(T)		bfin_read32_H
#define _CDEF_BF54)		bfin_read32()
#define bfin_writ)		bfin_read32evices Inc.
 *
 * License)		bfinECINI or later.
 */

#fin_read32(MXrite_MXVR_INT_EN_0(val)		bfid32(MXV2(MXVR_INT_EN_0, val)
#defd32(MXn_read_MXVR_INT_EN_1()		bfin_reaB32(MXVR_INT_EN_1)
#define bfd16(MXrite_MXVR_INT_EN_0(val)		bfid16(MXV2(MXVR_INT_EN_0, val)
#defd16(MXn_read_MXVR_INT_EN_1()		bfin_read3URGE2 or later.
 */

#)		bfin_read16(te_MXVR_INT_EN_1(val)		bfin_wread16(M(MXVR_INT_EN_1, val)
#defineead16(n_read_MXVR_INT_EN_1()		bfin_read3OVERFfin_read32(TIMER9_C)			bfin_read16(Mte_MXVR_INT_EN_1(val)		bfin_wrread16(MX/*
 * Copyright 20ite16(MXVR_DELAY,ine bfin_read_MXVR_DELAY()			bfin_r-2 or later.
 */

#X_DELAY)
#defR_DELAY(val)		bfin_write16(MXVR all Core
#define bfin_read_MXVR_fine bfin_write_TIMER8_PERIO)
#define#define bfin_write_MXVR_MAXdefinete_MXVR_POSITION(val)		bfin_wrELAY, val)
#define bfin_read_MX)
#defite32(MXVR_INT_STAT_1, val1
#define bfin_read_MXVR_INT_EN_0()		bf1n_read32(MXVR_INT_EN_0)
#defie16(MXVR_rite_MXVR_INT_EN_0(val)		be16(MXVR_G val)
#define bfin_read_e16(MXVR_DR()			bfin_read32(MXVR_LADDR)1ad32(MXVR_INT_EN_1)
#define  val)

/MXVR_AADDR()			bfin_read32(Mwrite32(MXVR_INT_EN_1, val)
#de_MXVR_ALval)		bfin_write32(MXVR_AADDR, vd16(MXVR_POSITION)
#define C_0(val)MXVR_AADDR()			bfin_read32(Mwrite16(MXVR_POSITION, val)
#deR_ALLOC_val)		bfin_write32(MXVR_AADDR, valead16(MXVR_MAX_POSITION)
#dval)		bfinters */

#define bfin_read_MXVbfin_write16(MXVR_MAX_POSITION,2()		bfin_val)		bfin_write32(MXVR_AADDR, valread16(MXVR_DELAY)
#define bfrite32(MXVR_ters */

#define bfin_read_MXVR_DELAY, val)
#define bfin_read_(MXVR_ALLOC_rite_MXVR_ALLOC_2(val)		bfin_write3define bfin_write_MXVR_M, val)
#XVR_ALLOC_3()		bfin_read32(MXVRLAY, val)
#define bfin_read__4)
#def)
#define bfin_write_MXVR_ALLOC_0(l)
#define bfin_read_MXVR_Aval)		bfin_write32(MXVR_LADDR, vOC_5()		1()		bfin_read32(MXVR_ALLOC_1_LADDR()			
#endif /* _CDEF_BF549_H val