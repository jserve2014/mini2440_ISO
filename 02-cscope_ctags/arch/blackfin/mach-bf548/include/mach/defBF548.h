...
#defineright 2 under the ADEP7*
 * Co8yright 2007-2008 Analog7Devices Inc.
 
/* Bit masks for USB_INTRTXEndef *
 * Licensed under the AEP0_TX_E* Co1 under t/*008 Analog0Devices IncEnablec.
 *
 * Licensed under the AEP1ers and b2t definitioT2008 Analog1Devices Incdef_LPBlackfin.h>

/* SYSTEM & MMR ADD2ers and b4TIONS FOR ADSP-BF548 */2
/* Include defBF54x_base.h for the set of #defin3ers and b8TIONS FOR ADSP-BF548 */3
/* Include defBF54x_base.h for the set of #defin4ers and biyright 2007DSP-BF548 */4
/* Include defBF54x_base.h for the set of #defin5ESS DEFINIr Registers */

#define5
/* Include defBF54x_base.h for the set of #defin6s that arer Registers */

#define Devices Incdef_LPBlackfin.h>

/* SYSTEM & MMR ADD7 followingr Registers */

#definer)
 */

#ifndef_LPBlack _DEF_BF548_H
#define _DEFRBF548_H

/* Include all Core regis1_RS DEFINITIONS FOR A-2008 Analog

/* Include defBF54x_base.h for the set of #defines/
#define common to -2008 Analog4x processors */
#include "defBF54x_base.h"

/* The /
#defing are the #d-2008 Analogd by ADSP-BF548 that are not in the common header *//
#definer Registers-2008 Analog                    TIMER8_CONFIG  0xffc00600   /* T/
#defineyright 2007-2008 Analog
#define                   TIMER8_COUNTER  0xffc0060gister */yright 2007-2008 Analog Devices Inc                  TIMER8_PERIOD  0xffc00Register e or the GPL-2 (or later)
 */

#ifn                    TIMER8_WIDTH  0xfUSB548_H

/* Include all Core reSUSPEND_Bnd bit definitioSuspend indicatorc.
 *
 * Licensed under the ARESUME      e            esume_WIDTH  0xffc0062c   /* Timer 1RESET_OR_BABLter */
/
#define    eset/babLPBlWIDTH  0xffc0062c   /* Timer 10 Width 
#deOF      g are the #dStart of framBlackfin.h>

/* SYSTEM & MMR A  CONN       yright 2007ConnectionTimer Group of 3 Enable Register */
#deDISCODisabler */
#defineDisc#definTimer Group of 3 Enable Register *SESSION_REQIMER_ENyright 2007Sesse   Requesnc.
 *
 * Licensed under tVBUS_ERR    icense or the GPVbus threshol0_WIDTH  0xffc0R10_PERIOD  0xffc00628   /* TF548_H

/* Include all Core refine    and bit definitioTIMER10_WIDTH  0xfalogef_LPBlackfin.h>

/* SYSTEM & MMR Registerdefine            up of 3 Register      SPORT0_TCLKDIV  0xffc008             TIMter */
#define    00640   /* Timer Group      SPORT0_TCLKDIV  0xffc00808   /* fine    ister */
#define IMER_DISABLE1   Sync Divider Register */
#define        3 Disgister */
#define
#define                   SPORT0_TCLKDIV  0xffc00808   /* 0648   /gister */
#define 3 Status Register */      SPORT0_TCLKDIV  0xffc00808 /

#define   ration Register *   SPORT0_TCR1        SPORT0_TCLKDIV  0xffc00808  ransmit Conf0 Counter Registester */
#define                SPORT0_T _DEF_BF548_H
#define FRAMF548_H

/* Include all Core  0xf_NUMBER* Co7ffdefinitioFLE1  numbe              SPORT0_TCR2  0xDEX548_H

/* Include allSELECTED_ENDPOINT* Coider Renitioselected e8 Analog           SPORT0_RCLKDIVGLOBAL_CTL548_H

/* Include all Core rSPORT0_ENAnd bit definitio  SPORsfine moduPBlackfin.h>

/* SYSTEM & MMRDDRESS Dister ITIONS FOR ADransmi        TIMER  SPORT0_TCLKDIV  0xffc00808   /*ines thaister e common to aRegister */
#defi2e                     SPORT0_MCMC1  e follister g are the #deRegister */
#defi3e                     SPORT0_MCMC1  */

/*ister *r Registers Register */
#defi4e                     SPORT0_MCMC1   TimerT0 Curr
#define                     5e                     SPORT0_MCMC1  604   0838   
#define                     6e                     SPORT0_MCMC1  00608        
#define                     7e                     SPORT0_MCMC1   */
#der 2 */
yright   /* ceiver */
#define                     SPORT0_MCMC1  0xt Select R2gister 2 */
#define         guration Register 1 */
#define         t Select R4gister 2 */
#define         * SPORT0 Multi channel Configuration Ret Select R8gister 2 */
#define         SPORT0_MTCS0  0xffc00840   /* SPORT0 Mut Select Regiyright */
#define         /
#define                     SPORT0_MT/* SPORT0 Mule Select Register 1 */
#del Transmit Select Register 1 */
#define    SPORT0_MRe Select Register 1 */
#de00848   /* S _DEF_BF548_H
#define OTG_DEV_STAT  0xffc00830   /* SPORT0 Stive Confignd bit definitios  SPORTWIDTH  0xffc0062c   /* Timer 10 Width HOSTine  Current ChannelHost negotiane   r_TCR1  0xffc00800   /* SPORT0 TI0 StatuMODter */
#define   WIDTH        DRC is a he    of 3 Enable Register */
#definrans0      SPORT0_MCMster level   EPPI0_S[0]e                     EPPI0_HDELAY  1ister */
#definePPI0 Horizontal Delay1Count Register */
#define        LSDEV* Timer Group ofLow-spee0_WIDTH  0xffc0062c   /* Timer 10 Width eivester */
00844   /* SFull or High             EPPI0_VDELAY  0xffc01010   /* EPBelecIC0 Counter RegisteA'iste'B' devic Timer Group of0 Multi channel Receive SeransmIRQ548_H

/* Include all CorDRIVEPPI0_L#define           WIDTH  0xfto drfinerans control circuine                     Eamples per LFF Current Channeldefine       shu_DISf charge pumpe                     CHREPPI0_LSTARFramental Transfer Countor
#defexternaI0_CLKDIV     MER_D EPPIing      .
 *
 * Licensed under PPI0 ContrEND      SPORT0_MCMe                   EPPI0_FS1W_HBLR10_c01024   /* EPPI0 FS1 Width Regi0648PI0 Control Regist/
#define   ine           MER_Ddisc01024   /* EPPI0 FS1 Width Regist0xffc01028   rizontal Transmit Segister / EPPI0optive Video Samples Pee                       EPPI0_LMASK548_H

/* Include allamples per Liegister */
#define        Samples per Linevices Inc.
 *
 * Licensed u Clock Divide ORT0 Current ChannelPI0_FS2P_LAVF  0xffFF01030   /* EPPI0 FS2 Period fc01028   /* EPc00838   /* SPORT0 M  SPORTfc01028   /* EPPevices Inc.
 *
 * Licensed undefine                 SPORT0_MCMPPI0 Clipping Regrizoevices Inc.
 *
 * Licens0xffc01028   /* EPster 2 */
#define   PI0_FS2Pxffc01028   /* EPPevices Inc.
 *
 * Licensed/
#define       i channel Transmit ST2_DLH  0xffc02104     /* Divisor Lat _DEF_BF548_H
#define CSR0548_H

/* Include all Core regRXPKTRDYnd bit definitiodata packet r#defineWIDTH  0xffc0062c   /* Timer 10 Width Tc0210c   /*ITIONS FOR Al Register *in FIFOne                        UART2_MCR  STALL_SE Framee common to   0xf handshake sedefine*
 * Licensed under the ADDATArizontal Blanking SD RegR10_WIDTH  0xffc0062c   /* Timer 10 Width SETUne  PI0 FS1 Period RSetupem Stne                        USENDtus Re           EPPISR10_tus Register */
ne                 SER1014D_fc0210c   /*00844   /* Sused_HBLclear the RxPktRdy bIV  0xffc0101c   /* EPnable Reg          UA           S              UARTfc021EndEAR  0xffc02124   /* Int0 ReceiveLUSH
#deft Register 2 */flushr */
#defi
#defne                    0xffRECEIVED_H14   /* Line Status Register */
/
#defiddefinemodBlackfin.h>

/* SYSTEM & MMR     PKT      g are the #dsT2_IEc0211token0
#define                      TWI1_CMC1 t Con     /
#define   timeout errdefinDTH  0xfer */
#define                     TWI1REQ  0xffc02r */
#define _TCR1  an IN tRegiaine   
#define                      TWI1_STATUS  0xffc02             tatusPI0 geControl Register */
#define                  TNAK_TIMEOU0xffc022yright 2007EP0 halisteafter a    ster */
#definegister */
#define     OUNT                 UART2_LCR isteRX      ck Divright 2007
#definof0xffc02200byt Rein210  nterface _DEF_BF548_H
#define NAKLIMI     TWI1_MASTER_CTRL  0xffiste    c0221ffer ster Mode Control RegBLE1 s/micro  TWI1_I Slavewhich210  * TWI Csfine                      TX_MAX_PACKET548_H

/* Include allefine     _SIZE_TWI Masider Regismaximumtrol Regy loa0_WI aABLE1  0xf _DEF_BF548_H
#define R#define                    TWI1_INT_STAT  0xffc02ock Divider Regisrrupt Status Register */
#define                    TWI1_ITXCSR548_H

/* Include all Core rffc021102220   Line Control Register * */
#define                        UAR
#de_NOT_EMPT    TWIITIONS FOR A
#defnot empty /* Scratch Register */
#deUNDERRUN2220  e common to alIER_CLE0xffset 
#defMode Coegistne                       eceive Bu2220  g are the #d

/* Two Wire Interface Registers (TWI1)_LSR  0xffc02D   TWI1       EPPI0ssue a /* llT  0xffc02120   /* Interrupt E2_LSR  0xffc021       ffc0220c   /* IFO Receive Dontromitistene                CLEAR_T2_MTOGGL02220  00844   /* S       */
#defil RegtoggPBlackfin.h>

/* SYSTEM & MMRINCOMPTXTransmi       EPPI0_FS2W_er */at a lPPI0_C0222c  s splIV  0xffc0101c   /* EPPI0  DMAREQ0 Ho Byte Reister 2 */DMAfine  (0iste1)er Regie   ne                FORCEData Double Byte ine         Forcesters */

#define                    ntrol Sele_DATA8      SPORT0ef_LPBl          EP#defDSP-Pe                     EPPI0_HDELIS Transm      SPORT0  SPORTIsochronoer *Regiferer Mo*
 * Licensed under the AUTO    ter */
#e Select allows/
#define to b/
#dt automaticall80   /* TWI FIFO Transmit Da1_CONTROT                 ntrol condiRegister */
#define                */

#define   xffc02             TWI1_RCV_DATA16xffc02200
#define                      TW    TWI1_SLAxffc02xffc02400
#dode * TWI CoAddress Register */
#define        TX /* TW48_H

/* Include all Core regT   /* TWI M1f/* TWI ers ntrol Reg#definer Regwrc022n    UARTr Register */
#defTx            TWI1_MASTER_STAT  0Rtrol Register */
#define        fc0210c ter */1_FIFO_STAT  0xffc0222c   /* TWI FIFO Status Register */
#defi#define   FU

#d     TWI1_XMT_DATA8  0xffc02280   /* TWI FIFO Transmit Da OVSingleegist Register */
#define                  TWI1_XMT_DATA16  0xffc02284   /* T2_MSt Conegistg are the #dOut        can0xffbeister     toe   er */
#define                  TWI FIFO T      yright 2007le Byte Register */
#define                   TWI1_RCV_egiste 0xffc02288   /* TWI FIFO Receive Data Single Byte Register */
#define /* CA            TWI1_RCV_DATA16  0xffc0228c   /* TWI FIFO Receive Data Double     CAegister */

/* SPI2  Registers */

#define                     SPI2_RERX        ister 2 */efine                         SPI2_CTL  0xffc02400   /* SPI2 Control Regis       #define                         SPI2_FLG  0xffc02404   /egister */
#NYE8   /* s Register *dis_LPBlNyetegister */                     SPI2_   /* SPI2 nowledgRegister */
#define                        SPI2_TDBR  0xffc0240c   /* SPI2  /* CAit Data Buffer Register */
#define                        SPI2_RR  0eive Dox Trans/* SPI2 Receive Data Buffer Register */
#define                        SPI2_BAUD  0R                 
#define                  TWI1_XMTer */
#define                     TWICTRL  0      dge Register      EPMode Control Register */
#define                */

#define          xffc02418   /* SPI2 Receive Data Buffer Shadow Register */

/* CAN Cage Lost RegiL  0xff */
#define                      CAN1_MBTIF1  0xf
#define                      TWIler 1 Mailboonfig 1#define                         SPI2_F
#define                      TWI1_CR  0/* S     CAN   /* CAN setsWI SPkter */
#define  Address Register */
#define        Rxffc03200   /* CAN Controller 1 Mail4   /* TWI Mation Register 1 */
#dister */
#define  UARTc0222c   /UART2_            TWI1_MASTER_STAT  0TXTYPF548_H

/* Include all CoTARGET_EP_N Transm Sync DivideEP/
#define  *
 * Licensed under thePROTOCOLc02410cSync Divideefine    typ                 CAN1_MC1  0xINTERVAAT  0xffc00830   /* SPOTX_POLL _DEN1_RMP    ster Mode Cpoll4   eviceval     r Registe         1_TRR2  0xffc0324c   /* knowledge Register 2 */
#define          egist          CAN1_AA2  0xffc03254   /* CAN Controller 1 Aboregistnowledge Register 2 */
#define                     R  CAN1_RMP2  0xffc03258   /* CAR Controller 1 Receive Message Pending Register 2 */
#define  -200                  CAN1_RML2DMAoller RUP3200   /* CAN Controller 1 MailDMA0 _DE               C     ER10ng Regists Inc.
 *
 * Licensed under the ADMA1        ITIONS FOR AMaskc03268   /* CAN Controller 1 Mailbox Interrupt Mas2        e common to * CAc03268   /* CAN Controller 1 Mailbox Interrupt Mas3        fc02118   /* MA3c03268   /* CAN Controller 1 Mailbox Interrupt Mas4        C            MA4c03268   /* CAN Controller 1 Mailbox Interrupt Mas5 Registere Shot Transmi5c03268   /* CAN Controller 1 Mailbox Interrupt Mas6N Controle Shot Transmi6c03268   /* CAN Controller 1 Mailbox Interrupt Mas7         e Shot Transmi7c03268   /* CAN Contro1 Mailbox Receive InterruxCONTROegister 3 */

/* EPPI0 Registersrrupgister */
#define      818   /* SPORT0 Receive Data RegisteRECT
#defin* Modem Contrir SPI2_Fof 1 Deister 2 *0_VDELAY  0xffc01010   /* EPPI0 0 Horizontal Transfe    BusI2 Baudne                        UARIN         g are the #dIvices Incc Divider Register */
#define         EPNUMeceivR  0xffc02210_AA2  0xffc03254   /* CAN Controll  BUS     ffer Register */            CAN1_g Register */
#define     ADDRHIGH  0xffc01018   /* EPPI0 SaMA_3298_   /*ceiveion RegistUpper 16-bits   /memory source/destin      addresH
#defUART     aslavechannel              CAN1_GIM  0xffc03298LOW200   /* CAN Controller 1  Interrupfinek Register */
#Lowine                         CAN1_GIF  0xffc0329c   /* CAN Controller 1 Global Interrupt Flag Register */        /* CAN Controller 1 Globa Int     pt Mask Register */
#define           #def coun_DISA* CAN Control#def              CAN1_INTR  0xffc032a4   /* CAN Controllfine                     CANter */
#de 0xffc032a0   /* CAN Controller 1 Ma  0xffc032ac   /* CAN Controller 1 Mailbox Temporary Disable Register *HM    _                  CAN1_DEBUG  0xffc0320xffcEdefine           Hister */
xffcdef_LPBlackfin.h>

/* SYSTEM & MMR A Shot TPegister */
#defin              I Slave Polari               CAN1_TRR1  0xffmit DatTister */
#define Urgency T/
#define     CAN1_UCCNT  0xffc032c4   /* CAN ConOIgister */
#defineOverflowter Registe     CAN1_UCCNT  0xffc032c4   /* CAN CoBDine    Registers *Block DoneCAN1_UCCNF  0xffc032cc   /* CAN Controller 1 UniveMBDI* Copyright 2007Maskuration Register */

/N1_UCCNT  0xffc032c4   /* CAN ConDRRegis3ine         Counter Register */
#dT
#definUCCNT  0xffc032c4   /* CAN ContBCtatus Register *      Rester of Bffc03200 UCCNT  0xffc032c4   /* CAN Con PS */
#define     Pin /* TWI er 1 Mailbox 0 Acceptance Mask LowOsters *   /* CAN         CAN1_UCCNF Genera228c   /* TWI FIFO Rectroller 1 Universac0322c   /* CAN ration Register */

/ceptance Mask _DE*ler 1 Mailbox 1 Acceptance Mask Low Regist    /*nce ReULTI BIT MACRO ENUMERA    S */
#define  */
#dler 1 Mailbox 1 Acceptance Mask Low Register */

#3268fgist_DEF_BF548_/* CA