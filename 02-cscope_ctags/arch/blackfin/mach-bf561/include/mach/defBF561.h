...
/* EBIU_SDGCTL Masks */
#define SCTLE			0x0vices 1	/* Enabl09 ALK[0], /SRASundeC the AWE, SDQM[3:0]ht 2005-2009CL_2og Devices I8c.
 SDRAM CAS latency = 2 cycleght 2005-2009CL_3og Devices ICef _DEF_BF561_H
#define 3DEF_BF561_H
/*
#if PFlog Devices 10c.
 *
 * LicEF_BFprefetchd only be inclPog Devices 21 chiP* includhas priority over AMC requestght 2005-2009TRAS_1og Devices 41 chiif
*/
tRAS = 1DEF_BFin.h>
...
#if8******************_DEF_BF561_H
/*
#if *****fined(__ADSPC******************.h should only be in*****4og Devices10******************4************************5******************************5************************6****************** */
/* Syste6************************7******************************7************************8og Devices2************* */

/8************************9 (16-bit) ********************9************************10 (16-bit) ******** */
/* Syste10(16-bit) */
#define PLL_S***********2*******************1*******fin.h>
...
/1m MMR Register Map */
/**1fined(__ADS3*********************************************1***********3      0xFFC0000C	/* * Clock and System Contro1l (0xFFC0003e PLL_LOCKCNT       
#define PLL_CTL      P************8************* P************************P***********10define SYSCR      m MMR Register Map */
P***********1#define SYSCR      **********************P***********2UBLE_FAULT         * Clock and System ConPol (0xFFC002#define SYSCR      SWRST                          0xF3UBLE_FAULT         l register (16-bit) */Pdefine PLL_3#define SYSCR      004	/* PLL Divide RegiCD***********8UBLE_FAULT     CD************************CD**********OUBLine SICA_SWRST    m MMR Register Map */
CD**********
#deine SICA_SWRST    **********************CD**********RST_ine SICA_SWRST    * Clock and System ConCDol (0xFFC0T_WDine SICA_SWRST    
#define PLL_CTL      CD          SWRSine SICA_SWRST    l register (16-bit) */CDdefine PLLler ine SICA_SWRST    004	/* PLL Divide RegWR**********ests************WR***********************WR*********ResetInterrupt Mask rem MMR Register Map */WR*********0104	Interrupt Mask re.h should only be incUPSDog DeviICA_R1 chPower-up start delayd only be incSMog Devi4            0xFpt AssignmPBlance =efincharge, mode register set, 8 CBR refreshh should only be incSS	og Devi1 */
1 chie.
#endif
*/
/ 0xFFC00128	/* SIon next*******accesght 2005-2009 RF   00x1      ******ent Rif
*/
self-define Sssignt 2005-2009EBUluded foC Inte1 chip.
#endexternal buffering timIC It 2005-2009FBBRW  0xFFAR1   1 chiFast back-to-A_IA read writeIC Interer 3 */
#defMREN  0xFC00130	1 chipxtendedAssignment RegiFC00138	/* SIC IntTCSR  0xFAR4    1 chiTemp compensatedt Ass#define Svalue 85 deg C61_H
/*
#if !DDBG  0xF4 */
#dIC Intristatndif
*/
controls duSIC Ibus grant8	/*
.
 *BIU_SDB* Copyright 2005-2009EB0_log  Devices Inc.
 *
 * LicEF_BF0xFFC00134ank 0       0xFFC0011SZ_1       0xFF*/
#define SIer 0 */
#definsizSIC 16MB SICA_ISR1         3er)
 */

#ifn28	/* SIC Interrupt Status regis32r 1 */
#define SICA_I6***********0048	/* SIC Interrupt Status regis64r 1 */
#define SICA_I12r (16-bit) 0068	/* SIC Interrupt Status regist28r 1 */
#define SICCAWer (16-bit) 0118	/* SIC Interrupt Statucolumn addrA_IAwidth			  bikfin.h>

/****r registtage Regula561 chiFFC0 1100-0xFFC0 11FF) */
#define SICB_SWRS9              0xFFC01100	STAT         bit define SICB_SYSCR              0xFFC01104	/* reserved */
#define SICB_RV************3    0xFFC01108	/* SIC Reset Vector Address Register */
#de      0xFFC114	/* SIC Int*******Status register 0 */
#defin1ter 3 */
#defi1_          0xFFC00118	/* SIC Interrupt Status register 1 */
#define S SICB_WR0         */
#define VR11C	/* SIC Interrupt Wakeup-Enable regi SICB_0 */
#define4B_IAR1               0xFFC01128	/0	/* SIC Interrupt SICB_Ip-Enable reg6118	/* SIC Interrupt Status registerrupt Controller 1_egisters for Core B (0xFFC0 1100-0xFFC0 11FF) */
#define SICB_SWRST              0xFFCFFC0113tage RegulOUBLE_FAULT   ICB_SYSCR              0xFFC01104	/* reserved */
#define FFC0113STAT       RST_DBL_FAULT_nt Register 4 */
#define SICB_IAR5               0xFFC01138	/* SI**********SWRST_OCCURRED* SIC Interrupt Mask register 0 */
#define SICB_IMASK1    2_14	/* SIC IReset regStatus register 0 */
#defin2ter 3 */
#defi2SICB_IAR0               0xFFC01124	/* SIC Interrupt Assignment Regist    0xWR0       ICA_RVECT      11C	/* SIC Interrupt Wakeup-Enable regi    0x0 */
#defiAR1  /
#define SICB_IAR2               0xFFC0112C	/* S    0xFp-Enable r600118	/* SIC Interrupt Status registerrupt Controller 2FC01130	/* SIC Interrupt Assignment Register 3 */
#define SICB_IAR4               0xFFCWakeup-tage Reg             0xFICB_SYSCR              0xFFC01104	/* reserved */
#define Wakeup-STAT     C InterruTL 				0xFFC00200	/* Watchdog Control register */
#define WDOGA_CNT 				********010C	xFFC0110C	/* SIC Interrupt Mask register 0 */
#define SICB_IMASK1    3Interrupt C00130	/* SStatus register 0 */
#defin3ter 3 */
#defi3SICB_IAR0               0xFFC01124	/* SIC Interrupt Assignment Registr */
#WR0     AR4        xFFC0011C	/* SIC Interrupt Wakeup-Enable regir */
#0 */
#de4 */
#definefine SICB_IAR2               0xFFC0112C	/* Sr */
#dp-Enablene SISICB_IWR1               0xFFC01120	/* SIC Interrupt 3FC01130	/* SIC Interrupt Assignment Register 3 */
#define SICB_IAR4               0xFFC BFIN_Utage Rignment Regifine SICB_SYSCR              0xFFC01104	/* reserved */
#define  BFIN_USTAT   3C	/* SIC InFFC00400  /* Receive Buffer register */
#define BFIN_UART_DLL			0xFFC00******ister r */

/* Watchdog Timer registers for Core B (0xFFC0 1200-0xne SICA_ISSTATopyright 2005-2009 DCI/* SIC Interrupt rrupt Assignmler is idle FIN_UART_IIR		SRA0               0xFFC00errupt Ass#define Sis activ38	/* SIC IntSDPU BFIN_UART_LCICA_IWR1   ssign upRegisterr */
#define BR   0xFF

#ifndef _DEF_BFtionn resetnmenter */
#define BEASE		    eserved */
#define SEAB sticky error/* Lius - W1CA_IAR7      BG
#deCT              0Ber 7 */
edSICB_Iendif	/* /* _DEF_BF561_H8	/*