...
#define MCF_EPORT_EPPAR*****2_BOTH *********3*******************************1_LEVEL*********0******************/
...
/* Bit *****itions and macros for*************DDR */*********************DD****DD1**************2**********************efine MC2EG32(x) *****************************efine MC3efine MCF_REG1***/
#ifndef	m532xsim_hefine MC4efine MCF_REG1***********************efine MC5efine MCF_REG************************efine MC6efine MCF_REG4NT_UART0        26          /* 7efine MCF_REG80*************************************************IE********************/

#dIE****IEF_REG32(x) (*(volatile unsigned long       /* define MCF_REG16(x) (*(volatile unsign     /*  *)(x))
#define MCF_REG08(x) (*(volati     /* ned char  *)(x))

#define MCFINT_VECBA     /* 64
#define MCFINT_UART0        26          /* Interrupt number for UART0 */
#define      /* ART1        27          /* Interrupt number for UART1 */
#define *********************/

#deine MF_REG32(x) ) (*(volatile unsigned long  *ine Mdefine MCF_F_REG16(x) (*(volatile unsigneine M *)(x))
#dedefine MCF_REG08(x) (*(volatiline Mned char  * *)(x))

#define MCFINT_VECBASine M64
#define e MCFINT_UART0        26      ine MInterrupt n number for UART0 */
#define Mine MART1          27          /* Interrupt number for UART1 */
#define 	0xFC048040	
#define	MCFSIM0480491		0xFC048041(*(volatile unsigned long  for the define MCF_REG16(x) (*(volatile unsignfor the  *)(x))
#define MCF_REG08(x) (*(volatifor the ned char  *)(x))

#define MCFINT_VECBAfor the 64
#define MCFINT_UART0        26     for the Interrupt number for UART0 */
#define for the ART1        27          /* Interrupt number for UART1 */
#define F********************/

#dF****F	0xFC048041	
#define	MCFSIM_ICR2		0xFC04MCFSIM#define	MCFSIM_ICR3		0xFC048043	
#defineMCFSIMM_ICR4		0xFC048044	
#define	MCFSIM_ICR5	MCFSIM48045	
#define	MCFSIM_ICR6		0xFC048046	
MCFSIMe	MCFSIM_ICR7		0xFC048047	
#define	MCFSIMCFSIM		0xFC048048	
#define	MCFSIM_ICR9		0xFC0MCFSIM
#define	MCFSIM_ICR10		#define	MCFINTC1_ICR0		0xFC04C040

#define MCFSIM_ICR_TIMER1	(0xFC0/
#endif	/* m532xsim_h****