 ...
 *  Copyright ((0x00)
#define MPI2_SASPHY3_EVENT_CODE_INVALID_DWORD*  Copyright (c) 2010-2009 LSI Corporation.
 *
 *
 *  RUNNING_DISPARITY_ERRORht (c) 2020-2009 LSI Corporation.
 *
 *
 *  LOSS  Name_SYNC Copyright (c) 2030-2009 LSI Corporation.
 *
 *
 *  PHY_RESET_PROBLEMopyright (c) 2040-2009 LSI Corporation.
 *
 *
 *  ELASTICges
BUF_OVERFLOWht (c) 205       Title:  MPI Configuration meX
 *  Creati*  Copyright (c) 206----------------------
 *  04-30-07  ADDR_FRAME 02.00.00  Corr(0x200-2009 LSI Corporation.
 *
 *
 *  TX_AC_OPEN_REJECTopyright (c) 22        Title:  MPI Configuration me *                      Added Mate:  November 10, 2006
 *
 *    mpTX_R                     Added M *  Version History
 *  -----------R                   define.
 *  Description
 *  --------  --------     IP_PARTIAL_WAITges ONd defin-----------------------
 *  04-30-07  agesCONNECTCONFIG_PAGE_MANUFAon-MPT MPI Specification Rev A.
 * TX_BREAK/*
 *  Copyright (cdefin7                      Manufacturing ped MPI2_BIOSPAGE2_BOOT_DEVICE80-2009 LSI Corporation.
 *
 *
 *  ed MP_TIMEOU         AddT_DEVICE90-2009 LSI Corporation.
 *
 *
 *   of BIOIGE_MAOSPAGE2_BOOT_DEVICEA*  Version History
 *  ------------EAKTX_PATHWAY_BLOCKEe:  mpied MBdified configuration pages dealing with IARBCONFIPage _BOOT_DEVICECdified configuration pages dealing wit Volume Pages 0 and 1,      D                    RAID Physical Disk  of BIOSnd 1, RAID Con     Eion page.
 *                      FixSSP07  02SOSPAGE2_BOOT_DEVIC400-2009 LSI Corporation.
 *
 *
 *  Rof SAS Device
 *                       Title:  MPI Configuration m of SAS *  CS Device
 *         ate:  November 10, 2006
 *
 *    mpZATION)                   MPI2_C *  Version History
 *  -----------TX_CREDITed
 *                  *                      Manufacturing pfor
 *                      N-----------------------
 *  04-30-0 of ATAS Device
 *          (0x5       Page 0 (_SATA_NEEDS_INITIALIZATI  SASBroadcastPrimitiveMasks        Title:  MPI Configuration mONFIG-------------PrimitiveMasksER0_FLAGS_CONNECTOR_END_DEVICE
 *     SMAS Device
 *              6       Page 0 (_SATA_NEEDS_INITIALIZATI-character unique.
 *       anufacturing Page 11.
 *              *                      MPI2_6 *  Version History
 *  -----------HOTPLUGPage 8 and Driver
 * (0xD00-2009 LSI Corporation.
 *
 *
 *  MISALIGNED_MUX_PRIMITIV 0 an*   anufacturing Page 11.
 *               IPI2_BIOSPAGE2_BOOT_DEne MPI2)

/* values for the CounterType field */-2009 LSI Corporation.COUNTER_TYPE_WRAPPING*
 *  Copyright (c) 2000-2009 LSI Corporation.xed define MPSATURAIG_P Corresponds to Fusi        Title:  MPI Confxed define MPDisk VALU            reation Date_MANPAGE4_PHYSDISK_TimeUnitsION.
 *                      Fiage _UNITS_10_MICROSECONDce
 *         ) 2000-2009 LSI Corporation.            MModified structure layout asAddresses field to
 *                 _MILLId stru*  Copyright (c) 20ate:  November 10, 2006
            Modi_RD_PDISKcture layout for
 3.
 *                  hresholdFlaged SAS Port Page 0.
 *           FLAGS-----
 *
             Added defifor
 *                MPI2_RAID_00FFFF
 *
 *NOTIFY             to 0x000000FF1.
 * 
 * Host code (drivers, BIOS, utilities, etc.) should leave this 009 LSIset toon Sone and check Header.ExtPageLength or NumPhyEvents at runtime.
*    ifndefI Corporation.----
 *
 *MAX-2009 LSI Corporation.            M_EXPAND    endif

type 31.struct _ CorpCONFIG_PAG AddFF
 * 3 {
0x00          drEXTENDEDrives HEADECreat      ;           Added defi/*  200*   0x00U32                to 0x00  Page 1 tReserved1o AdditionalControlgs of 8AS IO Uni8                    Page 1 toionalpecific Manuo AdditionalContgs of Cn.
 *                      Added additional  control2Invalid Topology CorrectiDAS IO Uni16         VolumeStatusFlags field.
 *     3Invalid Topology CorrectiEAS IO Unlags bits for controlli     dtional ific ManConfig
	Adde[lags bits for controlling ];e 0
 *1SAS I} 1.
 *       ives in IO Uni,nfigurPOI def PTR           drives in IO Uni,
  Mpi2SasPhydded3_t       added rep     Added PhysDi;
odified Flags bits for AGEVERS *  08-31-07  0) 2000-
 * e 0.
 *                      Added MPI2_SAS_PHYINFO_PHY_VACANT define.
 *  
*   SAS Port        ddeds
 ...
 *                      drives in IOORT_0
 Page 1.
 *                      Added new bit to AdditionalControlFlags of SAS IO Uni                  Added additional     Numb to AdditionalControrrection.
 *                      Added additional Physical    RAID Volume Page 0
 * 9aitTime field to SAS IO Unit Page 4.
 *         WidthInvalid Topology CorrectiAss Resolved bit from PhyInfo and from
 *                w AccessStatus vgs of BaitTime field to SAS IO Unit Page 4.
 *     ZoneGroupInvalid Topology Correcti                     VolumeStatusFlags field.
 *      Invalid Topology Correctimeaning of RAID Volume Page 0 VolumeSettings
 *                       Modified  auto-conU64                Added additional SASAddres RAID Volume Pagedded 3 olume O Unit
 *                      Page 1 toDeviceInfoo RAID Volume Page 0
 * on.
 *    t
 *                      Page 1 to control                define fo1          t
 *                      Page 1 to control4Invalid Topology Correct2lume Page 1 and
 *           exing       added related defines.
 *         wnstre        AddorAdded0DiskAttributes field (and outing modefines) to
 *       ORT0            RAID Physicl Disk P/* see mpi2_sas.hPHYSDPAGE4_PHYSDS Expander Page s.
 *     s of SAS0.
 age 0.
 *                      Added MPI2_SAS_PHYINFO_PHY_VACANT define.
 *            EnclosurK_12   Added three new DiscoveryStatus bits for SAS IO Unit
 *                      Page 0 and SAS Ex          r Page 0.
 *                      Removed multipENCLOSUREng information from SAS IO Unit pages.
 *                      Added BootDeviceWaitTime ft
 *                      Page 1 to control Invalid Topology Correction.
 *                   Added more pending t         Log    IDo Addition0  Fixed defines RAID Volume Page 0 VolumeSettings
I2_RAo AdditionalControlFlaAdded a4--------------------------------------------         Handleo AdditionalCdded a6--------------------------------------------NumSlor RAID Volume Page   Added MPI2_PHYSDI RAID Volume Page 0 VolumeSettings
Startigur                  Added aevice Pagereserved field into structure for IOC
 *                      Page 6a new Disco************************************EPDev****************************
 *       SK0_STATUS_FLAG_NOT_CERTIFIED define.
 *                      Added S ExpaDiscoveryStatus bit for SAS IO Unit Page 0
 *                      and SASifndePage 1 and
 *          r IO Unit Psimpl    added related defines.
 *        , MPI2_POINTER P    Ad         ing mode.
 *                  POINTER pMpi2Conefines) to
 *      r IO Unitnes for DiscoverySt
 *  10-02-08  02.00.0age 0.
 *  05-06-09  I2_RAID_PGAD_CONFIGNUM_MASK fronfigPS0_00FFFFMNG_MASPI2_BIOSPAGE2_B0000FFF0-2009 LSI Corpora       Word16[2];
UNKNOWoveryStatus
 *   000-2009 LSI Corpora       Word16[2];
IOC_Sice
 *        Disk CoeI2_CONFIG_PAGE_HEADER_UNION,
  Mpi2ConfGPIO  to 0x000000FF.
 *                      Word16[2];
EXP

/* Extended Config  *  Version History       Word16[2];
SEonfigPageHePOINTER PTRDescription
 *  ---EADER_UNION,
  Mpi2Con/* Extended CUnion, 5k Page 0.
 *                      Added MPI2_SAS_PHYINFO_PHY_VACANT define.
 *        Log     Added Phree new DiscoveryStatus bits for SAS IO Unit
 *                      Page 0 and SA    r Page 0.
 cion Size
 *                      bits in the Flags field of Manufacturing Page 4.
 *                      Added product-specifiufacturing pages 16 to 31.
 *  LOG_0_NUM,
  MENTRIESI2_POINTER pMp
  MPI2_POINTER PTR_M           ache on SATI2_CONFIG_EXTENDED_
  MD  SALENGTH             1C)
 *                    
  MPIR PTY inform*               Stam*  01-19-09  02.00.1ntrolFlags of SAS IO Unit
 *        control Invalid Topology Cooved Zone Address Resolv RAID VolumLogSequenc  U8              Page 3.
 *  -----------------------LogEntryQualifi to AdditionalControlage 6.
 *                  VP_PHY Page 3.
--------------------
 */

#WaitTime field to SASVFEADER_UNION, MPI2_POINTER PTR_MPI2_CONFI1                    OC
 *                      P**************2MPI2_CONFIG_EXT_PAGELogData Suppo2_POINTER pMpi2Config]; */

#ifndePage 1 PI2_CONFIG_       added related defdefine MPI2_       Log0     DiskAttributes field (10)
#define;
 *               /* 0x04 *        2                 ION.
 *                PI2_CONFIG__QUALdefine UNUS            ER PTR_MPI2_CONFIG_PAG0)

#define MPI2_POWER_O               nion, MPI2_POINTER pMp0)

#define MPI2_age STAMP_UPDAT 0 and 0000FF.
 *            0)

#define MPI2_MIN_IMPLEM*
 *SPEion: (0x8             (0x00)
#define MPI2_COMAXGETYPE_RAID_VOLUME    FFFFder_t;

typedef union _M     drives 
  MPage 5 and IO
 *                      Unit Page 6.
 *                      Added expander reduced functionality data to SAS
 *                      Expander Page 0.
 *t
 *                      Page 1 to control                 Modified                PageVersion;                /*Num       ie---------------- 0
 *            RAID Volume Page 0 VolumeSettings
 *                      define fofield valu2)
#define MPI2_ MPI2_POINTER PTR_MP        CONFIG_PAGEA2_POINTER PTR_Mo RAID Vo*/
} MPI2_CONFIG_PAGE_HE
  MP       added related defines.
 *    E_LOG     (0x10)ing mode.
 *               GETYPE_ENCefines) to
 *   
  MPI           RAID PhysicaANDER_0.
 age 0.
 *                      Added MPI2_SAS_PHYINFO_PHY_VACANT define.
 *        RAID      PageType;                   /* 0x03 */
    U16                 ExtPageLength;            ETYPE 0x04 */
    U8                  ExtPageType;                /* 0x06 */
    U8                  Reserved2;                  /* 0x07 */
} MPI2_CONFIG_EXTENDED_PAGE_HEADER,ETYP     d0PAGETEPE_RAIMPI2_CONFIG_EXTOLUME_PGAD_FORM_MASK    2ConfigExtendedPageA
 *                 OLUME_PGAD_F        PE_RAIEXT_PAGE RAID Volume Page 0 VolElement---------------------gs of SAS IO Uni RAID Volume Page 0 VolVol00 */
    U8                 P0ield values */
#definrmat */
#defHotSparePool000)

#define MPI2_RAIifndef MPI                  Added MPIDiskNumo AdditionalContrgs of 5_VOLUME_PGAD_HANDLE_MASK        fine MPI00 */
    U8        gs of *****Page 1 0000000)
#define MPI2_RAIDTER PTR_MPI2_CONFIG_PAGE_H         (0x10000000)
#define Mpi2Raid    Ad0    Ad    (0xDiskAttributes field (000)

#define MPI2_PHYSDIST             (0xISK_    (0x10000ION.
 *                OLUME_PGAD_FEord16[2ASKPI2_RAIDine M                 Word32;
} MP   (0x0000FFFF)


/VOLU02.0PE_RAIYPE_IO_UNIT                (0x00PI2_SAS_EXPAND_PGAD_FOr coS andAS Expand                  (0x01)
   (0x0000FFFF)


/HOID_VAR_MASK           0000FF.
 *               (0x0000FFFF)


/OC_MASK              PAGE_HEADER

 *                      Removed muETYPefine Md misONng information from SAS IO Unit pages.
 *                      Added BootDeviceWaitTime field to SAS IO Unit Page 4.
 *     Numne MPI2_ RAID Volume Page 0
 * on.
 *                      Added additional definee MPI RAID Volume Page 0
 * Flags field.
 *                      Added twNumVolum(16)


/* SAS Devito SAS Device Page 0
 *                      for indi    Ad2_PHYSDISK_PGAD_FORMdded 3 reserved wot
 *                      Page 1 to---------------------------
 */

xed defines for GPIOVal field of IO Unit Page     AdGUID[24]o AdditionalCo 0
 *                      VolumeStatusFlags define control Invalid Topology Correct2on.
 *                      Added additional def    (0x------------------AD_FOR                     VolumeStatusFlags field.
 *                      Modified2meaning of RAID Volume Page 0 VolumeSettings
 *                      define fo2 auto-configur0000000)
#define MPI2_RAID               (0x SuppoOLUME_PGAD_FORM_MASK    o RAID V3lume Page 1 and
 *      ANDLE_MASK          TER PTR_MPI2_CONFIG_PAGE_HEADER,
  Mpi_FORM_PORT_NUM           M_MASK       urationing mode.
 *                      (0x00000FFF)


/*efines) to
 *   OLUME_PGAD_F           RAID Physical Disk PMANPAGE4_PHYSDETYPE_SAS_P00000FF        Bytes[4];
   U16            OLUME_PGAD_F00FF_FOREIGNves.
 *       IT      sk Coerage 0.
 *                      Added MPI2_SAS_PHYINFO_PHY_VACANT define.
 *        D      Persistent Mappin       PageTythree new DiscoveryStatus bits for SAS IO Unit
 *                      Page 0 and SA Configuration PageAddressr Page 0.
 *                      Removed muDRIVER_MAPCONFIG_EXT_PAGE_HEADER_UNI PhyInfo and from
 *            Ident               I2_RAID_VOLUME_PGAD_HANDLE_MASK        GAD_CONFIGNUeAddres    rm000FFNFIG           (es
******************************************s.
 *   dexHYSDISK_PGAD_FORM_GET_Nevice Paget
 *                      Page 1 to        BitseAddreso Additiot */
#define MPIt
 *                      Page 1 to control Invalid Topology Correctolume Page 1 and
 *      ORM_CONFIGNUM    TER PTR_MPI2_CONFIG_PAGE_HEADER,
  MpiDPM_PGAD_ENTRY_COUNT_Spi2 ConfiMap
#define MPI2_CONFIG_PAGEATTSK              (;x00000000)
#define MPI2_RAID_PGAD_FORM_CONFIGOCPAAID_PHYSDISK          (0x0A)
#define MPI2_CONFIG_PAGETYPE_EXTENDED               (0x0F)
 (16)
#define MPI2_DPM_PGAD_START_****tryS PHY PageAddress format */
#on.
 0000)
#define MPI2_DPM_PGAD_E******UNT_SHIFT             (16)
#define MPI2_DPM_PGAD           ************dresing mode.
 *                                   efines) to
 *   ORM_CO 0x00 *_MASK              (0x00000)
#define MPI2_SAGAD_FORM_GET_NEXT_CONFIGNUM      _MASK             ION.
 *                DRVFIGNUMAPINFO_SLO     U32                7F00-2009 LSI Corp              ExtPageSHIFonfiguration
 *Description
 *                ExMISS****Length;                 
he on SAT