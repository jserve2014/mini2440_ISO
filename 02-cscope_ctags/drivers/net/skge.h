...
static inline void gma_write16* Definitions for the new Marvell Yukon / , u16 vsKonnfor tfine  PCSKGE_H
#define _SKGE_H), ve  PCI_PHY_COMA	0x8000000
#deset_addr(itions for the new Marvell Yukon / Sy,
				     Definu8 *EV_DsKonn
#define  PCew Mll Yuks */  (u16) EV_D[0] I conY | \
			1]#def8));_BITS (PCI_STATUS_DETECTED_+4, PCI_STATUS2      PCI_STATUS3SIG_SYSTEM_ERROR | \
			       PCI_ST8TUS_REC_MAST4      PCI_STATUS5SIG_SYSTEM}
