...
struct ixgbe_phy_operations {
  ...
  Intel reseght(c) 1999 - 2009 Intel Corporaad_reg*******************, u32e it and16**

  Intel writere; you can redistribute it and/or mod

  Intel setup_link*******************

  Intel  License,
_speedyou can redistribute ******ee Softwar, bool,
	 n the hope it will be ubute

  Intel checknse,
  version 2, as pubis program is dist evebute**

  Intel get_firmware_versionyou can redistribute iodify it
  undftwari2c_byteyou can redistribute i8ore detaify it
  under theeral Public License for
  more details.See the GNU Generaleepromlic License for
  more  ils.

  You should have rewith
  this program; if not, l Publi*****************with
 _info*****h Floor, Boston, MA*********** ops;
	enumor, Boston, MAtypen the hopeded ;
	u32n the hope it will be usCOPYIsemaphore_delaybuti16 in
  the file called "COPYINword_sizibutirmation:
  e1000-devel Mailing address_bits - Fifth Floor, BosmacA 02110-1301 USA.

  Tm Yo GNU General al Public License im Yoded in this di distributi8 in
  the file called "COPYINIntel[IXGBE_ETH_LENGTH_OF_ADDRESS]***********************************perm_*/
...
#include <linux/mdio.h>
#include ****Device IDs */
#define IXGBE_mc_filter*****bution in
  the file called "COPYINmcft <e1000-d* Device IDs */
#define IXGBE_DvID_82598_BX            0x1508
#define IXGBnum_rar_entrieubli         0x10B6
#define IXGBE_DEVax_tx_queu_82598AF_SINGLE_PORT 0x10C7
#define IXGBErDEV_ID_82598EB_SFP_LOM     0x10DB
#define IXGBEmsix_vector82598AF_SINGLE_PORT 0x10C7
#define Iorig_autoc8AT2            0x150B
#define IXGBE_DEV_ID_82;
	ty of        0x150B
#define IXGBE_DEVee Sofettings_stored_82598_CX4_DUAL_PORT 0x10EC
#define_ID_try_restart*********************** 02110-1301 USA.

  T***************7

*******301 USAmdio_ifdefin		 IXGblic License i****************************** Device IDs */
#define IXGBE_DiUAL_c License isfpx10F7
#define IXGBD_82599__82598_CX4_DUAL_PORT 0x10EC
#defineD_82 LicenneedDUAL_D_82599_KX4_MEZZ      0x1514
#dereviSS F***************ediax10F7
#define IXE_DEV_ID_8_82598_CX4_DUAL_PORT 0x10EC
#defineratio_disabl 0x1******_ID_neg_advertisedBE_DEV_ID_8200
#define IXG_82598_CX4_DUAL_PORT 0x10EC
#definemultiftwar_fiber - Fifth Floor, Boshw****u8 __iomem			*hw.h>
#;
	void	0028backF4
#defineE. Elam Young 		ma8259301 USA.

  Tntel_ID_8259GBE_Lfine ctrlL    0x00200
#defIXGBE_LEfTL    0x00200
#de1
#defin		ph Infth Floor, Boston, MA 021	with
 RE 0x00600
#defibusBE_COREbu8259816_I2Cdevice_fine efine IvendorEC       0x10subsystem_XGBE_EEC       0x10ERD      0010
#define I8_I2C   0x10FEC    bute_I2Cadap8259stoppfine***************** 02110-1*******************LEDCTL   32 _I2CABILITinvariants*******************

  Iay, Hillsboro, OR 97124-64	*o, OR 0F4
#define.

  The full GNU Gener	*he full G   0x1013C
#defin**************	*******ation, 
/* Error Codes */
#define ifndef RR_EEPROMCX4_DUAL_PORT 0x10EC
#de-1* Manageability Enable */_CHECKSU/
#define IXGBE_-2* Manageability EnaPHYCX4_DUAL_PORT 0x10EC
#defin-3* Manageability EnaCONFIG0204
#define IXGBE_VPDDIA4efine IXGBE_VPDDIAG0ARA/
#define IXGBE_GRC_APME  -5* Manageability EnaMAC_TYPEine IXGBE_I2C_CLK_OUT  6* Manageability EnaUNKNOWNG0  0x10204
#define IXG-7* Manageability EnaLINK_SETUPe IXGBE_I2C_CLK_OUT  8* Manageability EnaADAPTER_STOPPED008

/* Interrup9* Manageability EnaINVALID IXGB_
#dXGBE_GRC_APME 0x0* Manageability EnaDEVICE_NOT_SUPPORTne IXGBE_EIM-1x00000002 /* AdvanceMAS808
REQUESTS_PENDINt Masks -1define IXGBE_VPDDIAGBE_EIMC ne IXGBETINGS    0x00890G1  0x10208

/* I2CCAUTONEGne IXCOMPLET2C_DATA_IN -12C_CLK_IN    0x00000RESET_FAILne IXGBE_EIMS    fine  0x00000002
#define SWFW_SYNCefine IXGBE_GRC_APME 0x#define IXGBE_I2C_DAPHY  0x0(_i)   (XGBE_GRC_APME 0xt Registers */
#defiI2 limits based on the m * 82598ine IXGBE_EICS      SFPne IXGBE_EIAM      0x008fine  0x00880
#define IXG_RATE 48P(0x0NTent Enable */

#dBE_EIAC      0x00810_RATE _INIT_SEQAX_EITR     0x0-2x00000002 /* AdvanceFDI  (0#defiD0 + (_i) * 4)
/*
-2G1  0x10208

/* I2CCd PowerVERSION0008

/* Interrup22C_CLK_IN    0x0e IXI(_i)MENdefine IXGBE_MINne IXG0x7FITR_LL

#endif /* _ifndefE_I2_H_1 /*