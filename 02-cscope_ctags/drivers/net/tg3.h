...
#define TG3_FLAG_JUMBO_CAPABLE		0x20v 1.37
#define TG3_FLAG_CHIP_RESETTINGg3.h4v 1.37.2.32 2002/03/11 12INIT_COMPLETtg3.h8v 1.37.2	u32				tg3_flags2;2.32 2002/03/11G218 dTART_TIMERg3.hv 1.37.1ight (C) 2001, 200TSO_BUExp $v 1.37.2ight (C) 2001, 200NO_ETH_WIRE_SPEED Copyright4ight (C) 2001, 200IS_5788* Copyright8ight (C) 2001, 200MAX_RXPEND_64* Copyrigh1.2.32 2002/03/11hat.com $Id: tg3.hyright e TG3_64BIT_REG_HIGPHY_ADCm)
 * Copyrigh464BIT_REG_LOW		0x04UL

5704_A0m)
 *fine TG3864BIT_REG_LOW		0x04UL

BERm)
 * Copyrig17.2.32 2002/03/11x04UCI_EXPRESSdefine TG2N_FLAGS		0x8UL /* 32ASF_NEW_HANDSHAKE_ADDR		04N_FLAGS		0x8UL /* 32HW_AUTONE * Copyrig8N_FLAGS		0x8UL /* 32IS_NIC	define T137.2.32 2002/03/11x04UL

SERDEefine  BD,v 1MAXLEN_MASK	 0xfff $IdCITIVE_COUPLm Exfine T
 * MAXLEN_MASK	 0xfffFLASHBDINFO_FLetheer_desc */
#define  B.com1define AGS_BDINFO_SIZE			0x10U0
#def_PREEMPHASISINFO_N,v 1.MAXLEN_MASK	 0xfff5705_PLUefine  B
 * tZ_5906	32

#define R50STD_MAX_SIZEetherMAXLEN_MASK	 0xffffROTECTED_NVRAMINFO_OPY_Tdefine RX_JUMBO_MAXUSING_MSIdefine,v 1.3/

/* First 256 bytes are aXdefine
 * tg/

/* First 256 bytes are a_ORfine T(st 256 bytes are a | \
er.
	 space. */
#define ).
 */
...
#ifndef _T3_II00
#define  Bethern_FLAGS_USE_EXT_RECVN000
#definR_BROADCOMf0000
#def |	efine TG3PCI_DEVPCI_DEVICE000002
#define  TG3PARALLEL_DEZE		INFO XXX *ED		 0x00000002
#defCH_WORKAROUNDdefin,v 1.37Z_5906	32

#define R80_CLAdefine 
 * tg3DINFO_SIZE			0x10UL

#def2definetherneDINFO_SIZE			0x10UL

#de	  TG3PCI_DEVL

#defi |5761S	 0x1688
#def000002
#define  TG31SHOTre a mir/* BCM564BIT_REG_LOW		0x04UL

JITTTG3_BDINFO,v 1.37.2.32 2002/03/11arzik FWARE_REPORTox.co
 * tg3.h: Definitions x04UL

/*JUST_TRIeef ethernet driver.
 *
 * Cop3right (C) 2001, 23zik eadbe_ADDR_TRANERNAL_RS. Miller (davem@redh3_ENd: t_AP#define TG3t (C) 2001 Jeff Ga3e RX1_DMAm)
 * Copyrightc.
 */

#ifndef _3_USEVICELIB3_H

#define TG3_64BIT_REG_H3_MDIOBUSr BroEIGON3_e TG3_64BIT_REG_LOW		0x3VICE_CONNE		0xdefine TG30UL /* 64-bit */
#3_RGPCI_DTD_IBND_DISd: tgFO_MAXLEN_FLAGS		0x8UL /* ne TG3PCEXTSI_DATRX_ENine  BDINFO_FLAGS_USE_EXT_Rused */
#define TT3PCI_MISC_HOuffer_desc */
#defi3_CLKREQm)
 * CopyrigBLED		 0x00000002
#8S	 0xdefine  T0x04 --> AGS_MAXLEN_MASK	 0xf16555_STD_MAX_SIZEINFO_FLAGS_MAXLEN_SHII_DEVICE_Tdefine TC_ADDR		0xcUL /* 32-3_TOGGLE_10_100_L1PLLPx.com)
 G3_BDINFO_SIZE			0x18S	 0xIS_FETne RX_COPY_THRESHOLD  		256

#define Rdefine  BING_SZ
	struct timer_list		fine ;
	u16er.
 ine  count_CTRL_INDIR_ACCESSmultipli_CTRL_iver.
 ine  offsetTRL_INDIR_asfS	 0x00000080
#defefinISC_HOST_CTR
	/* 1 second 	 0x000 for transient serdes link events */RL_IRQ_MAHIPREVS	 0x00000.32 2002define AN, 200OUT_BDINS		 (C) 2001 define TTIGON3_3		 define  	iller (davIFT	 16
#define  GET1CHIP1000040
#defg3_	 0x_config		ST_CTRL_CHI; \
	  MISC_HObufmgSS	 _CHIPV_ID_5700_A0		 0x000cache h/w values, often passed straight toID_57
#define  Mrx_modeTRL_IRQ_MAS00
#define  CHIPmacV_ID_5700_B1		 0i101
#define  CHIPsc_host_ctrlTRL_IRQ_MAgr7101
#define  CHV_IDlocal#define  CHIPREdma_rwdefine  CHIPREcoalesce0
#define  CHIPpwrmgmt_thresh	 0x000PCI block700_B0		 0x7pci_chip_rev_idTRL_INDIR_		 0xmine  8IPREV_ID_REV_line_sz01_B2		 0x010lat_OST_CTR
	intIPREVm_cap;05
#definms102
IPREunion {05
#definecix CHIPREV_ID_57pcieA0		 0x}0105040
#demii_bus			*mdioD_57PREV_ID_570		 0irq[UL

_H
#GON3]0105B2		 0xhy_addS	 0x000PHY infoV_ID_5701_B0	hyefine.32 2002KREG_D_MASKBDINFf2001
#_DEVICE_TI_ID_570BCM5400BDINF6definck info. */PREV_ID_5704_12		 0x2002
5define  CHIPREV_ID_5701_A3		 0x20037define  CHIPREV_ID_5774_A3		 0x2001ne TG3_64BICHIPREV_ID_5735_A1		 0x3061
#define  CHIPREV_ID_545_A1		 0x3091
#define  CHIPREV_ID_555_A1		 0x30a1
#define  CHIPREV_ID_5A2		 0x200210UL /* 64-bne  CHIPREV_Iver.50_A1		 57760	 0x16CHIPREV_ID_515705_A3		 03#define  CHIPREV_ID_5778A2		 0x20023
#define  CHIPREV_ID_575_5750_bc050cc 0x4202
#define  CHIPRE7PREV_ID_575ex4001
#define  CHIPREV_NDIRV_ID_57ed 0x4202
#define  CHIPRE5705_AID_57fx4000
#define  CHIPREV_6_A3		 EV_ID_714_A2		 0x9002
#defin90CHIPREdc00ac#define  CHIPREV_ID_5800ID_5750_A101#define  CHIPREV_IINVALID		 0x2001
#df  CHIPREV_ID_570REV04_A1		 0x0x16a0 V_ID) >> 12)
#ine D_5704__B0CE_TI	 0x07
#define   ASIC_REV_fine 3	 0x07
#define   ASIC_REVC5701	6	 0x07
#define   ASIC_11_X5701		 /* Found on Netgear GA302T700_.32 2002/03/PREV_ID_5700615701		43bd002
#define#define   ASICAC13ine R			 c0
#define  #define   ARTL8211CC_REV_1cc9ne TG3_64BIT_RE_5714			 0x001#define T8NFO_FLAGS_USE_EX0
#define  CREV_I0x03625d3003
#definb
#definOUI04_A1		0x2001
c5787			 0x0b
#defin_REV_A3		 P	 0x200	 0x0f
#define   ASICID_57508
#de 0x5784
#define   ASIC_705_A206			 0x5RL_IRQ_MAled#define  CHIPRE#defotp0105charne Tboard_part_number[24]right (C) 2001VER_SIZE 320
#define fw_ver[ne  GET_CHIP]TRL_IRQ_MAnic_sram_data_cf#def5701_B0		 0xIPRE#define 040
#de		 0dev03_Apdev_peUS	 0x000This macro assumes the1
#definID_5ID is already masked
	 * withV_ID_5704_A1.ine 0			 0x04
KNOWNdefine (X)			 0((X) ==IPREV_ID_5704_A || 0x20
#define   CHIPR1V_57\
	704_BX		 0x21
#defin1   CH0x20
#define   CHI7e   CHIPREV_5750_AX		 0x40
#703ine   CHIPREV_5750_BX		 4x41
#define   CHIPREV_5784_A5ine   CHIPREV_5750_BX		5EV_57#define   CHIPREV_5784_52ine   CHIPREV_5750_BX		1PREV_5761_AX		 0x57610
#defi8EV_5704_BX		 0x21
#defi787ID)	((CHIP_REV_ID) & 0xff)
#e  GET_METAL_REV(CHIP_REV6ID)	((CHIP_REV_ID) & 0xff)90METAL1
#define   METAL_R6   CHIPREV_5750_AX		 0x40
7780)> \
	  MISC_HOhw_stats		*f
#defin;
V_ID_e  C_defidefin_mappin#define  CHwork_040
#d		reset_task0105
#definnv CHIfine  n00000)
#defie  DMsizeright (C) 2001ICE_TICHIP_64Kine  TG3OPY_THRESHOLD  		2ine  DMA_RW128RL_READ_BING_SZ_5906	32

#dine  DMA_RW256RL_READ_B			1536
#define RXine  DMA_RW512RL_READ_B12
#define RX_JUMB0
#define  DMine  TG XXX */

/* First 2	 0x00000100PCIX	 0xr of PCREAD_BNDRY_DISApageB	 0x0EAD_BNDRY_DISAjedecnum;
			 0x04
JEDEC_ATMELHIPRE1V_ID) >> 100
#deSTHIPRE_64BIT_REG__BNDRY_AIFUNHIPRE4WCTRL_READ_BNDRY__128	 0bf	 0x000003fine _AT24C642:18:1CHIP TG3PCine  DMA_RWCTRL
#define  DMA_RWCTRL_REPAGENDRY_51(3_DMA#define  DMA_RWCTRL512EAD_BNDRY_5_BNDRY_32	 0x0000020700
#define  DMA_RWCTRL_RY_1024	 0(12800700
#define  DMA_45DB0X1BE_BNDRPOS	900000000
#define  DMA_RWCTRL_WRDRY_52640700
#define  DMA_R5FRITE_BNDRY_DIS2560700
#defiST_M45PEX0DRY_1024	 0xefine  DMA_RWC DMA__SA25F0XX00000800
#define  DMA_RWCST_25VF0TE_BNDRY_32	 04098x000nsigned 
#defiirq_max 0x10ITE_BNDRY_64	 0x0TRL_RPREV_5700ethtool_
#define00
#de	 0x000firmware5704_A0		 const #define*fw_needeine BNDRY_040
#de DMA_RWC0x000WCTRL_READfw_len;	 0xincluREV	BSS0x10fine#endif	 0x!(_T3_H)0x10