...
static struct usb_device_id rt2800usb_device_table[] = {
	...
	/* ZCOM */
	{ USB_DEVICE(0x0cde, 0x0022),2x00 Source_DATA(&/*
	Copyright (C) 2t2x00 SourceForge Project
5<http://rt2x00.serialmonkey.com>

	This004 inwell009 rt2x00 SourceFor5a57rojec280<http://rt2x00.serialmonkey.com>

	This program is freGeneral Pub	<http://rt2x00.serialmonkey.com>

	This program is freGeneral Pub3ersion 2 of the License, or
	(at your option) any later versio5257you can redistribute it and/or modify
	it uyxethe terms of the GNU 0586roje3416<http://rt2x00.serialmonkey.com>

	This program is freeHANTABILITa<http://rt2x00.serialmonkey.com>

	This p0, }
};

MODULE_AUTHOR(DRV_PROJECT);ved a coVERSIONthe G Licensral PublicDESCRIPTense"Ralink RT
	Co2x00 Wireless LAN driver."ral PublicSUPPORTED SourceF, write to t7e
	Frechipset based cardsn, Inc.,
	5/rt2x00TABLE(usb, /*
	Copyridevice_tableral PublicFIRMWARE(fic rout_0, Bosral PublicLICENSE("GPLn, I
static struct ct: rndati	Abstract: rcitt.h= {
	.name		= KBUILD_MODNAME,
	.idusb de	=	Abstract: rt2800usb deherdprob
#incrt2xCopyrilude herddisconnectlinux/kernel.de <linux/herdsuspendlinux/kernel.sb.h>

herdresu>
#incux/kernel.lude ",eceivnclude int __init	Abstract: 
 * (void)
{
	return/crc-registerialmonkey.co <linu);
}t2800usb.ncry __ex* Allow hardwodulencryptionct: rtbled.
 */
static int modparam_nomoduleware ellow hardware );ODULE_PAed(no_param_named(n);
