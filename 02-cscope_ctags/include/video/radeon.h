...
#define MDLL_RDCKA__Mefine0_REF_SEL_MASK ADEON_REGSIZE			0x0x#ifn0030ef _RADEON_H
#define _RADEON_HFB#define RADEON_REGSIZE			0x44000


#dcfine MM_INDEX                  


#dKEWine RADEON_REGSIZE			0x000


#70fine MM_INDEX                  SIN          0x0000
#define MM_DATA   8           0x0030
#define HI_STAT       0x0000
#define MM_       0x004C
#define BUS_CNTL1                  efine BUS_CNTL                   70           0x0030
#define HI_STABP           0x0000
#define MM_DATA  8E0
#define CNFG_MEMSIZE                         0x0034
#define e CNFG_APER_0_BASE                     1_SLEEP       0x0000
#define MM_      1

#d             0x0104
#define CNFG_AP
#define CNFG_APER_1_BASE       0x0108
#define CNFG_REG_1_BASE    RESETER_SIZE                        2FG_REG_APER_SIZE                     0x               0x010C
#define C                     0x0164
#define ANGEER_SIZE                        cFG_REG_APER_SIZE                    
#define RADEON_REGSIZE			0x4000
3
...
#d             0x0104
#define CN             0x0000
#define MM_DATAe PADD_CTLR_MISC                         efine BUS_CNTL               0E0
x0108
#define CNFG_REG_1_BASE                                     0APERTL		               0x09c0
#define VIPH_              0x010C
#defineine VENDOR_ID                        CNTL                             G_CNTL	                    0x0174
#def                 0x00F8
#define Cine VEN   0x0F04
#define STATUS                           0x010C
#defin#define RE
//N_H
#definBf _RADEON_H
#definB _RADEOB0NFG_APER_SIZE                        0A
#1ef _RADEON_H
#definne SUB_CLASS                   0x010C
#define CA
#define BASE_CODE                   0x0110
#define PAD_AGPINPUT_DELAY    2                           0x0F0C
#         0x0F0B
#define CACHE_LINE            0x0F0D
#define HEADER                      0x016C
#defin#ifndef _RADEON_H
#defin        0x0F0
#define RADEON_REGSIZE			0x4000


#define MM_INDEX       ne SUB_CLAS             0x0000
#define MM_DATA                                    0x0F1efine BUS_CNTL                               0x0030
#dene SUB_CLASS                                0x004C
#define BUS_CNTL1                 0x0        0x0F0B
#define CACHE_LIN                   0x0F34
#defineCNTL                              0x00E0
#define CNFG_MEMSIZne SUB_CLAS                 0x00F8
#define CNFG_APER_0_BASE                             
#define CNFG_APER_1_BASE                       0x0104ne SUB_CLCNFG_APER_SIZE                         0x0108
#define CNFG_REGI_CAP_ID                       0x010C
#define CNFG_REG_APER_SIZE       I_CAP_ID      0x0110
#define PAD_AGPINPUT_DELAY                     0x0   0x0F52
#definCTLR_STRENGTH                      0x0168
#define PAD_C   0x0F52
#d                      0x016C
#define PAD_CTLR_MISC            0x0F52
#de    0x0aa0
#define AGP_CNTL                               I_CAP_ID   ine BM_STATUS                              0x0160
#define CA      0x0F5C
#de      0x0950
#define CAP1_TRIG_CNTL		               0x0I_CAP_ID    VIPH_CONTROL			       0x0C40
#define VENDOR_ID                      0x01D8
#0x0F00
#define DEVICE_ID                              ine AIC_CTRL   COMMAND                                0x0F04
#define STI_CAP_ID                             0x0F06
#define REVISION_ID                    0x01E   0x0F08
#define REGPROG_INF          _RADEON_H
#de300defin _RADEON          0x0F51
#define PMI_000


#ddefine BASE_CODE  GEN_CNTL                                        0x0F0E
#define BIST    GEN_CNTL       B                  0x0050
#define MEM_C4                0x0140
#define EX0x0140
#define MC_CNTL               8                0x0140
#define C                  0x0050
#define MEM_1                                  0x0140
#define MC_CNTL              2                    0x0178
#defiD                  0x0050
#define MEM_4   0x0178
#define MEM_INIT_LATENCY0x0140
#define MC_CNTL              8007c
#definepllCLK_PIN_CNTTL2                       #define CN            PPLL 0x0158
#define AGP_BASE                                  0xC
#dDIVefine MEM_IO_CNTL_A1              3               0xDIV_0#define MEM_IO_CNTL_A1              4     0x017C
#define M1#define MEM_IO_CNTL_A1              5     0x017C
#define M2#define MEM_IO_CNTL_A1              6     0x017C
#define M3#define MEM_IO_CNTL_A1              7            V    ECP 0x0158
#define AGP_BASE         000

8            HTOTA0x0170
#define MEM_IO_CNTL_A1       000

9            M_S17C
#defFBfine MC_READ_CNTL_AB        000

A            AGP_  0x0170
#define MEM_IO_CNTL_A1      000

       0x0pll     0170
#define MEM_IO_CNTL_A1              C                 0170
#define MEM_IO_CNTL_A1              DCNTL           0x0170
#define MEM_IO_CNTL_A1              ECNTL         H
#dCKO
#define MEM_IO_CNTL_A1         N     F    0x003C
#definefine#define MEM_IO_CNTL_A1             10x0138
#define SW_SEMABHORE                           0x013             M 0x0130
#define MEM_VGA_WP_SEL              1           0x0LL_TEST                   0x0188
#define MC_1      0x017C
     WRMG                   0x0B00
#definSURFA 0x0180
#definLL                  0x0B04
#define SURFACE1_L80
#define MECG      MACRO_RW_WRITE    0x0B00
#define SURFAefine MC_IOPA           0x0B24READ     0x0B00
#define SURFA MC_DEBUG               0x0B24DATPHORE                SURFATATUS                   0x0B240x0158
#define AGP_BASE SURFA_CNTL        DISP         0x0B24
#define SURFACE3_LOWESURFACNTL_AB      efine SURFACE7_LOWEine SURFACE4_LOWER_BOUSURFA             efine SURFACE7_LOWEURFACE5_LOWER_BOUND   SURFA             efine SURFACE7_LOWE0x0158
#define AGP_BASSURFA          0x0  0x0130
_B1                         0x0184
#1     0x003C
#d    MISCE_ADDR                0x033c
#define 0x0138
#definTV     FINE0130
#define MEM_VGA_WP_SEL   000
2C
#define CRT                      0x0150
#define MEM_IO_O2                       0T_MISC_LAT_TIMER              OUND            0xTV_DTO_INCREMENTS#define SURFACE7_UPPER_BOUND       0x017C
     AUX                   0x0188
#define MC_2 0x0180
#defi038
#fine SURFACE2_INFO                       80
#define MEM2  0x0170
#define MEM_IO_CNTL_A1             CNTL_AB      SURFAC#define MC_READ_CNTL_AB                              SURFACne MEM_IO_CNTL_B0                                    PIXCLKS 0x0158
#define AGP_BASE              2          0x0      2                 0x0B7C
#define SURFACE     0x003C
#S       0x0148
#define HOST_PATH_CNTL          S_CLR             FO                          0x0B5C
#def3                                          0x0B6C
#define S3           0xSS_IN                   0x0B00
#define TL             0x0B1CS_T                    0x0B00
#define TL      0x0180
#defi  0x0MOR     0x0B58
#define SURFACE6_UPTL     57c
#defineixMC_PERF 0x0158
#define AGP_BASE                                   CNTL2                                                     REGIONMEM_IO_CNTL_B0                                        0x174T_MISC_LAT_TIMER                     0x01           OUNTMEM_IO_CNTL_B0                    0x0180
#d    0x0E44
#defiT_MISC_LAT_TIMER            0x0180
#define    0x0E44
#defi_B1                        84
#define MC_I    0x0E44
#defi                       0x01efine MC_DEBUG     0x0E44
#defiMEMCH_ACE5_LOWER_BOUND         STATUS     ne RBBM_CMDFIFO_ADDR  TL                   IO_OE_CNTL          IM                    0x0188
#define_IO_OE_CNTL_AB        CHP_IO    0_AEM_IO_CNTL_B0                           IFO_STAT          T_MISC_LAT_TIMER                        IFO_STAT         B            0x0E7C
#define CRT                                    0x005C
#define GPIO_VG     0x003CMDFIFO_DATAHMEM_IO_CNTL_B0                     0x0138
#deixTC    MATCHIT_MISC_LAT_TIMER             0x013C
#define           0x00_B1                         08
#define CRTC2     BI    TR158
#define AGP_BASE               SURFACE_CNixREG_COLLAR4
#define SURFACE3_LOWER_efine SURFACE0_LOWER_00B8
#define ine SURFACE4_LOWER_BOUND SURFACE1_LOWER_BOUNDix    0DFIFO_DATAH                     0x0E              0fine CRTC_TAT                      0x0E7C
#         0x0B64 CRTC_V_SYNC_STRT_WID  T_MISC_LAT_TIMER         aefine CRTC_VLINE_CRNT_VLINE         0x0060
#define G     be CRTC_CRNT_FRAME                            0x0210
#deficefine CRTC_VLINE_CRNT_VLINE    C         0x0214
#define CdEBUG                                         0x0210
#defieefine CRTC_VLINE_CRNT_VLINE    D         0x0214
#define Cf                         0x0224
             0x0210
#defBOUND      fine CRTC_V_TOTAL_MEM_IO_CNTL_B0           OUND           fine CRTC_ELPIDA    0x0B68
#define SURFACE7                CRTC_V_SYNC_STRTO     0_C SURFACE4_LOWER_B             0xfine CRTC_ine WID_TOP_BOTTOM                       0x0B2C
fine CRTC_DFIFNIT_WR_LAT_TIMER                0x0B3C
#defifine CRTC_DEBUG    0x0B68
#define SURFACE7_       0x0E50
#dene CRTC_0B4
#d#define OVR_CLR                 08
#define CRTC_V_SY          T_MISC_LAT_TIMER            define CRTC_VLINE_CR          _B1                         ne CRTC_CRNT_FRAME                                        RTC_GUI_TRIG_VLINE            4     0x0B7C
#define SURFACEDEBUG                         5     0x0B7C
#define SURFACEET_RIGHT            FO_DSTATUURFACE1_INFO                                     efine  0x0B58
#define SURFACE6_UPPER_B          NB_TOMDP_DEBUG                         8
#def15C
