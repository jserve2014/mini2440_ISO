...
#/*
 *	PCI CVENDORVendSCALEMP		0x8686*	Please keeplass, Vend*
 *	Do_VSMP_CTL	0x1010 *	Please keep sorted.
 COMPUTONE not e0e new entries to this fi multiple_IP2EX	0x0291.
 */

/* Device classes and subcPGs */302*	Please keepSUBed between multiple rivers.
 */

/* DevSUBASS_NOT_DEFINED		0x0004s */00#define PCI_CLLASS_STORAGE		0x01
#defin8 PCI_Cine PCI_CLASS_NOTASS_NOT_DEFINED		0x0006 PCI_C3 *	Please keep sorted.
 KTI drive2e *	Please keep sorted.
 ADAPTEC not9004 new entries to this fiI_CLASS_7810finit78_RAID		0x0104
#define PCI_CLASS_S21	0x21SATA		0x0106
#define PCI_CLASS_ST38602	0x_STO_RAID		0x0104
#define PCI_CLASS_S5ORAG5_SATA		0x0106
#define PCI_CLASS_STOR55OTHE5A_AHCI	0x010601
#define PCI_CLASS_STO	0x603ATA		0x0106
#define PCI_CLASS_ST1480AET	0x75_RAID		0x0104
#define PCI_CLASS_SRNET	0xSATA		0x0106
#define PCI_CLASS_STOR6GE_S6TA_AHCI	0x010601
#define PCI_CLASS787NET	7202
#define PCI_CLASS_NETWORK_ATM		07GE_S7#define PCI_CLASS_NETWORK_OTHER		0x02RAGE72efine PCI_BASE_CLASS_DISPLAY		0x03
#3e PC3efine PCI_BASE_CLASS_DISPLAY		0x03
#e PC74SATA		0x0106
#define PCI_CLASS_STOR9WORKBASE_RAID		0x0104
#define PCI_CLASS_S8NET	8202
#define PCI_CLASS_NETWORK_ATM		08GE_S8#define PCI_CLASS_NETWORK_OTHER		0x08RAGE8I_CLASS_DISPLAY_XGA		0x0301
#define 8CI_C8ASS_DISPLAY_3D		0x0302
#define PCI_C8e PC8ISPLAY_OTHER		0x0380

#define PCI_BA8WORK8	0x02
#define PCI_CLASS_NETWORK_ET788RAGE86	0x0500
#define PCI_CLASS_MEMORY_FLA7H		07	0x0500
#define PCI_CLASS_MEMORY_FLALASS8878E_IPI		0x0103
#define PCI_CLASS2_STORAG_MULTIMEDIA	0x04
#define PCI_CL2_2940URAGE0tionPCI_CLASS_BRIDGE_ISA		0x0601
#def3ne PCI_CL#define PCI_CLASS_NOT_DE0x0601
#d7890 IDs0013GE_MC		0x0603
#define PCI_CLASS_BRIDE_PCI	fSS_BRIDGE_EISA		0x0602
#define P3fine PCI_C5ASS_BRIDGE_EISA		0x0602
#define P3950U2D0606
#DGE_MC		0x0603
#define PCI_CLASS_BRIRAGE_F50605
#define PCI_CLASS_BRIDGE_NUB7892RING008ASS_BRIDGE_EISA		0x0602
#define PfineGE_PCI8DGE_MC		0x0603
#define PCI_CLASS_BRI
#defin8	0x0604
#define PCI_CLASS_BRIDGE_PCM2PPCI_BAI_CLASS_BRIDGE_OTHER		0x0680

#defin9 PCI_BcSE_CLASS_COMMUNICATION	0x07
#define 9GE_PCIcDGE_MC		0x0603
#define PCI_CLASS_BRI9#definc	0x0604
#define PCI_CLASS_BRIDGE_PCM9fine Pc0605
#define PCI_CLASS_BRIDGE_NUBOBSIDIAN   0x050ASS_BRIDGE_EISA		0x0602
#define PSCAMfine 5LOPPY	0x0102
#define PCI_CHOLTEK_STOR41ine PCI_CLASS_lass, Vend0
#def_656WORKne P *	Please keep sorted.
 NETMOS_STOR7LASS_BRIDGE_EISA		0x0602
define_970WORKPCI_SS_SYSTEM_RTC		0x0803
#define PC1_CLASS1SYSTEM_PCI_HOTPLUG	0x0804
#define3_CLASS3SYSTEM_PCI_HOTPLUG	0x0804
#define4_CLASS4SYSTEM_PCI_HOTPLUG	0x0804
#defineTWORKASS_SS_SYSTEM_RTC		0x0803
#define P8I_CLAS8_SYSTEM_PCI_HOTPLUG	0x0804
#defin8 PCI_C8ASS_SYSTEM_SDHCI		0x0805
#define 8CI_CLA8S_SYSTEM_OTHER		0x0880

#define P8I_BASE8CLASS_INPUT		0x09
#define PCI_CLAETWORKTHERSS_SYSTEM_RTC		0x0803
#define P90GE_SING	 *	Please keep sorted.
 3COM_0
#dea727 *	Please keep sorted.
 DIGIUM notd16#define PCI_CLASS_NOT_DEING_OT_HFC4SIDs
4ions
 *	are sharNOT_DEFINED_VEXSYe PCId84dASS_STORAGE_SCSI		0x0100
#R_386_401e PC		0x
#define PCI_CLASS_PROCESSOR_486		TWORKM	0x *	Please keep sorted.
 TIGERJET note159SS_BRIDGE_EISA		0x0602
R_ALPHA	_30CIA		0CLASS_STORAGE_SASS_PROCESSOR_POWER1C	0x0b20
 *	Please keep sorted.
 XILINX_RM1

#eaAS		0x0107
#define PCI_CLRMECLASS3RAGE989d new entries to this fiIAL		0x0c
_PRO#defin7 PCI_CLASS_SERIAL_FIREWIRE	0x0c00
LASS9898
