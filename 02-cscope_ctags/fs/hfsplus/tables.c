...
u16 hfsplus_compose_table[] = {
	...
	0x1e74, 0x0000,
	/* linu65 lin330 */
	0x1e1b* linux/fs/hfsplus/9ables.c
 *
 * Va2d* linux/fs/hfsplus7tables.c
 *
 * Va75* linux/fs/hfsplus42ables.1
 *
 * Va06ble taken from Appl4 Technote #1150
 eble taken from Applb Technote #1150
3 * linux/fs/hfsplus4ce[] = {
/*
 *  Tha lower case table ce Technote #1150
48* linux/fs/hfsplus5e Technote #1150
5fsplus_case_fold_ta5Format)
 */

u16 6 high-byte table cona Technote #1150
9 * linux/fs/hfsplus/e Technote #1150
 7* linux/fs/hfsplus/Format)
 */

u16 hf* linux/fs/hfsplus/8ble for character*  (HFS Plus Volume6le[] = {
/*
 *  Thable taken from App6onsists of a 256-eious data tables
 */ followed by
 *  s9_fs.h"

/*
 *  Unictry subtables. Thegs or ignored chara7tains either an
 *0x0000, 0x0300, 0x04able for characterable taken from Appaters i42
 *
 * Vfc1* linux/fs/hfsplu3b10, 0x0000, 0x000b*  (HFS Plus Volum3b70, 0x0000, 0x00000x0000, 0x0000, 0x00

#inc0000, 0x000d0x0000, 0x0000, 0x0ctables0000, 0x000e0x0000, 0x0000, 0x00  0x0000, 0x0000,f*  (HFS Plus Volu1fbf0, 0x0000, 0x0000gs or ignored cha1ff follo00, 0x0000, gs or ignored char39/ 0x0605, 0x0000, c* linux2, , 0x013* linee,
    /*  * lineeax0000, 0x0000, 0x0000, 0x000c, 0x0000,
    /* 3 */ 0xf000, 0x0000, 0x0f00, 0x0000,a  0x000000, 0x000f, 0x0000,
    /* 3 */ 0f0,
    /*  * linf000, 0x0000,*/ 0x060000, 0x00003 */ 0005
    /*000, 0x01,
    /*0, 0x00f000,x0000,
    /*16,
 * x0000, 0x01ex0000, 42x0000,2x00000, 0x0000, 0x0 0x0000, 0x0000, 0x0000, 0x0000,
  28        0x0000,2ax0000, 0x0000, 2c0000, 0x0000, 0he l0, 0x0000, 0x3    00, 0x0000, 0x0000, 0x0nux/f linux1        0x0000,3e
    /* 2 */ 0x070000, 0x00000000, 0x0, 0x0000000,
  40x0000, 0x0000, 0000/ 0x0000, 0x0400, , 0x0000, 0x52 0x0000, 5d00, 0xb7
 *
 * fb2fsplus_case_fold_t5fe Tec0x0000,
    1gs or ignored charx0000, 0x8000,
    / 0x0000, 0x0000, 0x0table5b9000,
    4ious data tables
 x0000, 0xc000,
    300,
     0x0000, 0x0/ 0x00x0000,
    /, 0x0000,
    /* 15d0, 0x000000,
    /000, 0 0x0000, 0x0003, 0x0000, 0x0000,0000, 0x 0x0000, 0x0Forma0x0000,
      * linux/fs/hfsplu000, 0x000000,
    /able taken from Ap5d600, 0x0000,
    /*  (HFS Plus Volum5dters 0000, 0x0000,ome number of 256-5d

#in0000, 0x0000,ables )


    /* 05dable 0000, 0x0000,ntry high-byte tab5dle[] 0000, 0x0000, 0x0000, 0x0000, 0x0onsis0000, 0x0000,, 0x0000 0x0000, 0x0 foll0000, 0x0000,* 7 */ 0x0000, 0x00e000, 0x0000,
    
    */ 0x0000, 0x0000, 0x0000, 0x00004 0x0000, 0x0000, 0xe0, 0x0000, 0x00004 0x0000, 0x0000, 0xe000, 0x0000,
    4* 9 */ 0x0000, 0x00e000, 0x0000,
    4       0x0000, 0x00e00, 00000, 0x0000,*  means that ther5e0, 0x0000, 0x0000some number of 256-5e000, 0x0000,
    rables )
0, 0x0050, 0x00f50, 0x005c 0x0000,000,
    /5e0, 0x0000, 0x00004 0x0000, 0x0000, 0x00, 0x00f 0x0000,
  0x0000, 0x0000, 0x0000, 0x0x0000, 0x0s_fs.h"

/*
 *  Unx0000, 0x0x0000, 0x0* B */ 0x0000, 0x000000, 0cote #115fb, 0x, 0x0000, 0x0000, 0x0000000, 0x0fb2ious data tables
 91table930000,
  095ome number of 256-91000, 00, 0x0000,
 ables )


    /* 09100, 000, 0x0000,
            0x0000,91onsis00, 0x0000,
 000, 0x0000, 0x00002/ 0x000, 0x0000,
  0x0000, 0x0000, 092e Tec00, 0x0000,
 s_fs.h"

/*
 *  Un92ters 00, 0x0000,
2000, 0x0000, 0x00002le[] 00, 0x0000,
 fsplus_case_fold_t9200, 000, 0x0000,
 gs or ignored char93000, 00, 0x0000,
, 0x0000, 0x0000, 0930, 0x0E, 0x000F,
  * linux/fs/hfsplu9a 0x090000, 0x0009d    // Table 1 (forahigh b6, 0x0017,
    /* 0 */ 0xFFFF, ax0000,6, 0x0017,
b 0x0000, 0x0000, 09ax0009,6, 0x0017,
 00B, 0x000C, 0x000Dc 0x000be 0x0017,
c000, 0x0000, 0x0000, 0x002d0000,
  09x0000, 0x/fs/hfsplua0x0000a0, 0x0000,a0000, 0x0000, 0x000a, 0x002E, 0x002F,
            0x0000,a0x00002E, 0x002F,
 ious data tables
 a, 0x092E, 0x002F,
 02B, 0x002C, 0x002D, 0x002E, 0x002F,
 fsplus_case_fold_tb, 0x09b0, 0x0000,b003B, 0x003C, 0x003b high , 0x0062, 0x0s_fs.h"

/*
 *  Unb0x0009, 0x0062, 0x0gs or ignored charb400, 0b3, 0x0027,0, 0x0000, 0x0000, 0D, 0x00656 0x006F,
 ome number of 256- 0x0071, 0x002A, 0x0000, 0x0000, 0x000bc000, b6, 0x0027,bc           0x0000,b, 0x00, 0x007A, 0x0   /* 5 */ 0x0070, 9 0x006 0x002A, 0brs with that high b 0x0079, 0x0062, 0x002B, 0x002C, 0x002c4000, c 0x0072, 0c0073, 0x0074, 0x007c0x0079c 0x0000, 0c005B, 0x0/* 6 */cdable tf586C, 0x006Dx0000,cdx0000, 0xcc 0x0000, 0x0000, 0D, 0x0060x0074, 0x00*  means that ther,
       0x006A, 0xcome number of 256-d0x0069dE, 0x006F,d            0x0000,d, 0x00* 8 */ 0x0080ious data tables
 ,
    /*6, 0x0077,d0000, 0x0000, 0x000e4d8A, 03, 0x006F,e, 0x0000, 0x0000, 0ec008B, bx008C, 0x0x0000, 0x/fs/hfspluf*/ 0x0f7ote #1150f7, 0x0091, 0x0092, 0xForma 0x0094, 0x00able taken from Apf8000,  0x0094, 0x08, 0x0000,
    /* 1fb0093, 8c
 *
 * 0f7*  (HFS /* 6 */f70000, 0x00, 0x0000fb0, 0x* A */ 0x00A0ome numb, 0x00A2, 0x00A3,, 0x0000, f4009B, bx0000, 0xf6ables )


    /* 0f9, 0x00AB, 0x00AC,b0x00AD, 0x00AE, 0x0le Tecfx0000,
  0f, 0x0000, 0x0000, 0fconsis0B3, 0x00B4, s_fs.h"

/*
 *  Unf5/ 0x00B3, 0x00B4,5       0x0000, 0x0f5000, 0BB, 0x00BC, *  means that therf5le[] 0BB, 0x00BC, 02B, 0x002C, 0x002f0x00610B3, 0x00B4,9, 0x0091, 0x0092, 09B7,
            0900B8, 0x00B9, 0x00B, 0x000B3, 0x00B4,a0x00BD, 0x00BE, 0x0aBF,
    /* C */ 0a00C0, 0x00C1, 0x00Ca, 0x00C3, 0x00C4,a02B, 0x002C, 0x00300x00630900, 0x0030rs with that high 3able[]00DB, 0x00DC,0000, 0x0000, 0x0030x008B    /* E */ 0xfsplus_case_fold_30400, 00DB, 0x00DC,5 0x0000, 0x0000, 30A, 0x            0x       0x0000, 0x3050, 0            0x0x00DD, 0x00FE, 0x05tabl            0x*  (HFS Plus Volu30500,             0xome number of 256305

#i            0x           0x0000302, 0x            0x00E0, 0x00E1, 0x00E5, 0x00E3, 0x00E4,    /* 4 */ 0x0040305E7,
            0600E8, 0x00E9, 0x00E6, 0x00EB, 0x00EC,60x00ED, 0x00EE, 0x0 are             0xable taken from A306, 0x00DB, 0x00DC,6*  means that the3acters    /* 1 */ 0xables )


    /* 306E7,
            0700E8, 0x00E9, 0x00E*/ 0x            0x, 0x0091, 0x0092,3icode             0x0x00F5, 0x00F6, 0x07, 0x0113, 0x0114,70x0115, 0x0116, 0x07FF,

    // Table700E0, 0x00E1, 0x00E9, 0x00E3, 0x00E4,90100, 0x0101, 0x0102, 0x00DB, 0x00DC,f0x00DD, 0x00FE, 0x00D7,
00DB, 0x00DC,x00F8, 0x00D9, 0x00Da, 0x00E3, 0x00E4,a0x012D, 0x012E, 0x01E7,
            0    /* 2 */ 0x002030*/ 0x013B, 0x013C, 0x00ED, 0x00EE, 0x000A5,013B, 0x013C, 0x00DD, 0x00FE, 0x0b1F,
    /* 2 */ 0 0x0000, 0x0000, 030000,             0x00F8, 0x00F9, 0x00F   0x            0x0x00FD, 0x00FE, 0x0b, 0x0133, 0x0134,0, 0x00000149, 0x014B, 0x00E3, 0x00E4,b0100, 0x0101, 0x010x000000DB, 0x00DC,075, 0x0076, 0x00730c40,
    /* 4 */ 00000, 0, 0x015E, 0x01, 0x010B, 0x010C,c0x010D, 0x010E, 0x00x0070163, 0x0164, 0111, 0x0111, 0x011c, 0x0113, 0x0114,c0x0115, 0x0116, 0x0c, 0x015B, 0x015C,d0x015D, 0x015E, 0x00000,    /* 7 */ 0x0x011D, 0x011E, 0x000, 0    /* 7 */ 0x0148, 0x0149, 0x01400, 0    /* 7 */ 0x0x0115, 0x0116, 0x0, 0x0    /* 7 */ 0x0x0155, 0x0156, 0x0e, 0x015B, 0x015C,f0111, 0x0111, 0x011f000,0183, 0x0185, 00F8, 0x00F9, 0x00Ff40,
    /* 4 */ 0f0x0115, 0x0116, 0x000, 0018C, 0x018C, 0x00FD, 0x00FE, 0x0f, 0x00E3, 0x00E4,f0100, 0x0101, 0x010117,
   a        0x, 0x0000,
    /* 11A, 0x011         0x0x00DD, 0x00FE, 0x011F,
            0x0111, 0x0111, 0x0112, 0x012         0x0x00FD, 0x00FE, 0x0127,
            0xs_fs.h"

/*
 *  Ux016F,
            0d0199, 0x0199, 0x0192, 0x017B, 0x01AD, 0x00DD, 0x00FE, 0x0177,
   B, 0x01AD, 0111, 0x0111, 0x011A, 0x017B, 0x01AD, 0x00FD, 0x00FE, 0x017F,
   B, 0x01AD, s_fs.h"
 ...
 *  Un3000, 000EF,
   0ther an
 * * linux/fs/hfsplu01BF,
  7 /* C */ 0x01C0, 0able taken from Ap30000, 04/ 0x060000, 0x00ea0x0000, 0x0000, 0x00/ 0x01C9, 0x01C9, 0x01CC,x01C1, 0x01C2, 0x01C0, 0x1C9, 0x01C9, 0x01CC,           0x0000,30

#in1C9, 0x01C9, 0x01CC,ome number of 256-    0x01Ctables1C9, 0x01CC075, 0x0076, 0x0077x01CD, 0xx01DC, 0x01DD, 0xx0158, 0x0159, 0x0x01D1, 0x0x01DC, 0x01DD, 0x0x01C1, 0x01C2, 0x01Cx01D7,
x01DC, 0x01DD, 0x0       0x0000, 0x0    0x01C00, 0x1C9, 0x01CCd01EC, 0x01ED, 0x01EE1CD, 0xF,
    /* F */ 0x01DE, 0x01DF,
    /* D1, 0x0F,
    /* F */ 0x0 0x01CC, 0x01CC, 0x0x01D7,
F,
    /* F */ 0x0x01C1, 0x01C2, 0x01C  0x01107,
x01C9, 0x01CC,*  means that ther3, 0x01Fh byte 0x03)
 ...
 1FC, 0x0h byte 0x03)
    ...
    /* 0(for highx01DC, 0x01DD, 0x0, 0x0000,
    /* 1 01, 0x0301E0, 0x01E1, 0x010x0000, 0x0000, 0x0x0307,
 x01DC, 0x01DD, 0x0, 0x01C9,
          30B, 0xx01DC, 0x01DD, 0x0, 0x0091, 0x0092, (for highF,
    /* F */ 0x020, 0x0321, 0x0322, 1, 0x03F,
    /* F */ 0x02, 0x0313, 0x0314, 00307,
 F,
    /* F */ 0x0* 0 */ 0x0300, 0x03030B, 0xF,
    /* F */ 0x0, 0x01C9,
           0x01F3, 0x01F3d by
 *  s02B, 0x002C, 0x00230ters x0337,
            0E2, 0x01E3, 0x01E5, 1CD, 02, 0x
            A7,
     x0327,
            0x0328,          00x01BD, 0x01BE, 0x01A, 0x0x0345, 0x0346, 0x03          0x0318, 0x1CD, 0code ca340, 0x0341,0E, 0x030F,
    /* 1 */ 0x 0x01EA,4
 *
 * Varx01C1, 0x01C2, 0x01CE */ 0x01E0, 00x0354, 0x0 0x01CC, 0x01CC, 0x0, 0x01EF,
    0x0354, 0xx00E8, 0x00E9, 0x0x0336, 0x0337,
  , 0x035E, 001EC, 0x01ED, 0x01EEA, 0x0 */ 0x030x0354, 0x 0x01A5, 0x01A6, 0* 1 */ 0x0310, 0x0x0354, 0x00x0334, 0x0335, 0x0336, 0xA, 0x036B, 0x036C, * 0 */ 0x0300, 0x0300x0323, 0x0324, 0x035E, 02, 0x0313, 0x0314, 0x0315, 74, 0x0375, 0x037620, 0x0321, 0x0322, A, 0x0 0x034F,67,
        0x0309, 0x030A, 0x0  0x01C9, 0x010x0072, 1e    /* 2 */ 0x0020,x01CD, 0x01CE, 00383, 0x03x0138, 0x0139, 0x0x01D1, 0x01D2, 0x0383, 0x038           0x01E8, 0x01E9, x038C, 0x038D, 0x001EC, 0x01ED, 0x01EE, 0x01h byte 00383, 0x0382, 0x0313, 0x0314, 0x0315,             0x0388          0x0318, 0x0319, 0 0x03B6, 0x03B7,
 31C, 0x031D, 0x031E, 0x031F 0x03B6, 0x03B7,
 20, 0x0321, 0x0322, Forma0x0390, 03, 0x00B41e4, 0x0385, 0x0386, 0      3, 0x03C, 0x03C9, 02, 0x0313, 0x0314, 0        0x03C80000,
  01d, 0x033E, 0x033F,
    /* 44

#inc3B2, 0x031e/* 7 */ 0x0000, 0x00381, 0x */ 0x03B2, 0x03B3, 0x0309, 0x030A, 0x0  /* 4 */ 0x03B2, 0x03B3,* 0 */ 0x0300, 0x030      C */ 0x03C0, 0x03C1, 0x01C9,
          onsis 0x03C5, 0x03C6, 0x00E, 0x030F,
    /* 1C, 0x03AD, 0x0B2, 0x03B3,B, 0x034C, 0x034D, 0x034E,/

#inc                      0x0318, 0x  0x01 0x034F,B2, 0x03B3,x0338, 0x0339, 0x033x034E, 0x034F,B2, 0x03B3,, 0x01D9, 0x01DA, 0x      C, 0x03DD, 0x03DE,  0x01CC, 0x01CC, 0x03C8, 0C, 0x03DD, 0x03DE,      0x0368, 0x0369, 0x03    0x00          f01F0, 0x01F3, 0x01F3, 0x013EB, 0x03EB, 0x03ED,20, 0x0321, 0x0322, 008B,3EB, 0x03EB, 0x030394, 0x0385, 0x0386, le TechEB, 0x03EB, 0x03ED,x0371, 0x0372, 0x0373, 0x0000, 0x3EB, 0x03ED000003ED, 0x03EF, 0x03EF,
 0x03FE, 0x03FF,

  0x03F1, 0x03F2, 0x03F3, 0x0x03FE, 0x03FF,
0384, 0x0385, 0x0386, le Tech0x03FE, 0x03FF,

  * 0 */ 0x0300, 0x0301, 0x0x0390, 0        01x025B, 0x0192, 0x00301, 0x0302, 0x0, 0x040E, 0 0x0309, 0x030A, 0x0BF,
    /* C *0000,
  1e6 0x01CC, 0x01CC, 0x03, 0x01C6, 0x037,
       , 0x03FB, 0x03FC, 0x03FD, 000, 0x1         0000// Table 4 (for high byt  /* 2 */ 0x0440, 0x0338, 0x0339, 0x03le Tech  /* 2 */ 0x0440, 00x03B8, 0x03B9, 0x03BA, 039tables*/ 0x0440, 1x0441, 0x0442, 0x0443, 0x04044E, 0x044F,
    x0338, 0x0339, 0x03344D, 0x00, 0x*/ 0x0440,             0x0000,443, 0x04            0x0438, 0x0447,
            0x044            0x0438 0x044B, 0x044C, 0x044D, 0x

#inc*/ 0x0440, , 0x0000, 0x0000, 0443, 0x04 0x0446, 0x0447,
 , 0x0447,
            0x044 0x0446, 0x0447,
  0x044B, 0x044C, 0x044D, 0x00, 0x*/ 0x0440,             0x0000,443, 0x04, 0x0454, 0x0455, 4, 0x0435, 0x0436, 0x0437,000, 0x*/ 0x0440, 6x0441, 0x0442, 0x0443, 0x045D, 0x045E, 0x045F, 0x0447,
            0x0445D, 0x045E, 0x045F 0x044B, 0x044C, 0x044D, 0*/ 0x06*/ 0x0440, 0 0x03ED, 0x03EF, 0x03EF,
  46B, 0x046D, 0x046x01C1, 0x01C2, 0x01    0x0346B, 0x046D, 0x04659, 0x035A, 0x035B, 0x0353147,
, 0x044F,
     0x03ED, 0x03EF, 0x03EF,
  0479, 0x047B, 0x04,

    // Table 3 (for hi0000, 0x      0x0438 0x03ED, 0x03EF, 0x03EF,
  0x0483, 0x0484, 0x, 0x0473, 0x0473, 0x0475, 00x0483, 0x0484, 0x477,
            0x0479, 0x 0x0446, 0x0447,
  0x03ED, 0x03EF, 0x03EF,
    /* F6, 0x0447,
 , 0x0473, 0x0473, 0x0475, 097, 0x0497,
      477,
            0x0479, 0x, 0x0454, 0x0455,  0x03ED, 0x03EF, 0x03EF,
  , 0x0454, 0x0455, */ 0x0481, 0x0481, 0x0482,000, 0x*/ 0x0440, x0363, 0x0364, 0x0365gh byte 0x04)04A9, 0x04AB, 0x0473, 0x0473, 0x0475, 0x04AF, 0x04AF,
   477,
            0x0479, 0*/ 0x07045E, 0x045F  // Table 4 (for high byte
            0x04B /* B */ 0x04B1, 0x04B1, 0x
            0x04B477,
            0x0479, 0  /* 2 *0x0354, 0f0D, 0x03BE, 0x03BF,
    /*C5, 0x04C6, 0x04C8,
0x01BD, 0x01BE, 0x0   0x0448, 0x046, 0x04C8,
03D5, 0x03D6, 0x03D7,
   x0432, 0x6, 0x04C8,rious data tables
 0431, 0x0432, 0xD4, 0x04D5,0x01BD, 0x01BE, 0x01x0437,
       6, 0x04C8,0000, 0x0000, 0x0000x043B, 0x043C, 04DE, 0x04Dx04CC, 0x04CD, 0x04CE, 0x04E1, 0x04E2, 0x04E304D0, 0x04D1, 0x04D2, 0x04D
      6, 0x04C8,        0x0000, 0x0 0x0449, 0x044A,x04EC, 0x04x04CC, 0x04CD, 0x04CE, 0x04F */ 0x04F0, 0x04F04D0, 0x04D1, 0x04D2, 0x04D, 0x0456, 0x04C8,085, 0x0086, 0x0087          0x04580x04FA, 0x00x04DA, 0x04DB, 0x04DC, 0xa  0x04D8, 0x04D9,            0x0038,61, 0x046)

    /* 0 */ 0x0x04CC, 0x04CD, 0x04CE, 0x03, 0x0504, 0x0505, 04D0, 0x04D1, 0x04D2, 0x0445D, 0x06, 0x04C8,6500, 0x0501, 0x0502, 0x05030D, 0x050E, 0x050F0x0506, 0x0507,
           0D, 0x050E, 0x050F04D0, 0x04D1, 0x04D2, 0x040x0475, 6, 0x04C8,
x0326, 0x0327,
          x051B, 0x051C, 0x051, 0x01C9,
         x0475, 0x0475, 6, 0x04C8,
, 0x03FB, 0x03FC, 0x03FD, , 0x047FD4, 0x04D5,D, 0x051E, 0x051F,
    /* 20529, 0x052A, 0x05, 0x01C9,
            0x08C, 0x04804DE, 0x04DD, 0x051E, 0x051F,
    /* 20x0563, 0x0564, 0x, 0x0522, 0x0523, 0x0524, 00x0563, 0x0564, 0x527,
            0x0528, 0xF */ 0x04F0, 0x04FD, 0x051E, 0x051F,
    /* 2F */ 0x04F0, 0x04F, 0x0522, 0x0523, 0x0524, 0F */ 0x04F0, 0x04F527,
            0x0528, 0x, 0x04FF,

    // D, 0x051E, 0x051F,
    /* 2, 0x04FF,

    // */ 0x0530, 0x0561, 0x0562,0x04AF, /* 0 */ 0x0D, 0x051E, 0x051F,
    /* 558, 0x0559, 0x055A, 0x0522, 0x0523, 0x0524, 558, 0x0559, 0x055A, 0x03FB, 0x03FC, 0x03FD, 00D, 0x050E, 0x050F, 0x055B, 0x055C, 0x055D, 00D, 0x050E, 0x050F /* 6 */ 0x0560, 0x0561, 0x0D, 0x050E, 0x050Fx0371, 0x0372, 0x0373, 0x01FD, 0x1b* F */ 0x03D9, 0x03DA, 0x03DB, 0x03D5, 0x0576, 0x0577,
x0441, 0x0442, 0x044        0x01F76, 0x0577,0x03AA, 0x03AB, 0x03AC, 0x01FD, 0x76, 0x0577,
0x03B8, 0x03B9, 0x02E, 0x057F,
    /* 8 */ 0x01EC, 0x01ED, 0x01EE, 0x01 */ 0x0  /* 8 */ 0xx0441, 0x0442, 0x0443, 0xx058D, 0x058E, 0x058, 0x01D9, 0x01DA, 0xD1, 0x058D, 0x058E, 0x0580x03B8, 0x03B9, 0x03x01D7,058D, 0x058E, 0x058x0338, 0x0339, 0x03       058D, 0x058E, 0x05f4, 0x0385, 0x0386, 00x0323, 0x03276, 0x0577,
0x01BD, 0x01BE, 0x01  0x0378, 0x076, 0x0577,
500, 0x0501, 0x0502,, 0x032D, 0x0  /* 8 */ 0x2, 0x0313, 0x0314, 0 0x0331, 0x0376, 0x0577,
0x0000, 0x0000, 0x0       E, 0x05AF,
    /* B20, 0x0321, 0x0322, 0x0323code ca  /* 8 */ 0x500, 0x0501, 0x0502, 0x055BC, 0x05BD, 0x05BE,0E, 0x030F,
    /* 1D1, 0xBC, 0x05BD, 0x05BE,          0x0318, 0xx01D7,BC, 0x05BD, 0x05BE,0x01BD, 0x01BE, 0x0       BC, 0x05BD, 0x05BEf2, 0x0313, 0x0314, 0e TecC, 0x0402          x00F8, 0x00D9, 0x03B6, 3, 0x05D4, 0x05D5, 0x0 0x0000, 0x0000, 0x005D3, 0xtables0x05D5, 0x00, 0x0000,
         0, 0x03Bonsist0x05D5, 0x0, 0x0000, 0x0000, 0 0x05DD, 00, 0x0x05D5, 0x0 0x03DF,
    /* E */ 0x03E0ntry su0x05D5, 0x0 0x00C5, 0x00E6, 0x35, 0x0436, 0x00x05D5, 0x065E4, 0x05E5, 0x05E6, 0x05E3, 0x030x05D5, 0x050x01BD, 0x01BE, 0x01    0xF5, 0x05F6, 0x05F7b* 0 */ 0x0300, 0x030, 0x05F0x05DE, 0x05DF,
  , 0x03C2, 0x03C3, 0x03C4, High-by 0x05E3, 0x00E, 0x030F,
    /* 1, 0x05F,
            0x05CB, 0x03CC, 0x03CD, 0x03CE*/ 0x01C, 0x05ED, 00x01BD, 0x01BE, 0x01BF,
  1C6, 0x, 0x05F1, 0x0E, 0x030F,
    /* 11CD, 0xx100E, 0000,
  1e05E4, 0x05E5, 0x05E6,    0x00x05DE,x1013, 0x134, 0x0435, 0x0436, 0x03D2, 1012, 0x1013, 0x100E, 0x030F,
    /* 1 0x05F9
            0x1010x01BD, 0x01BE, 0x01       ,
     B2, 0x03B359D, 0x059E, 0x059F, 0x03CE,, 0x1026, 0x1027,
0x01BD, 0x01BE, 0x01 /* C 000, 0x0000, 0x0008ome numb30x0000, 0x0000,          0x0000, 0x00, 0x0000, 0x6 0x0000, 0x055 0x102F,
    /* 3 */ 0xables )
1031, 0x1032, 0xx04B, 0x1034, 0x1065, 0x1036, 0x103, 0x0072, 02E, 0x105 */ 0x0000, 0x0091030, 0x1031, 0x1032, 0xF,
 , 0x1034, 0x10c5, 0x1036, 0x103x0000, 0x00    0x100x1043, 0x1044, 0x, 0x103B, 0x103C, 0x103Dx011      0x0000,70, 0x0000000, 0x74, 0x1041, 0x1042,000, 0x0000, 0x0008, 0x01D9 5 */ 0x1050, 0x1    /* 4052, 0x10, 0x000054, 0x10500, 0x0000,    0x1
            0x1058,
    /* 5 */ 0x1050, 0x10x1049, 052, 0x100000, 0x0000, 0x80x0519, 0x051A, 0x051B, 0, 0x0000, 0xD, 0x046F, 0x046F,
    /* 7 */ 0x, 0x0000, 0xx01C1, 0x01C2, 0x012E, 0x1 */ 0x1070, 0x10718 0x0000,1031, 0x1032, 0x8         0x0000,80, 0x0000, 0x0008000,
    /*    0x1x1075, 0x1076, 0x10, 0x0000        0x1078, 0, 0x0000, 0x00008        107C, 0x1, 0x0000, 0x0475, 0x0475,, 0x0000, 0x527,
            0x0528, 0x5 */ 0x0000, 0x0000485, 0x0486, 0x0487,
           x0000, 0x000 0x1072, 0x1073, 0x1074, 0x0x1043, 0x1044, 0x77,
            0x1078, 0033, 0x1034, 0x1, 0xx1086, 0x108797,
            0x1            0x1098,80, 0x1081, 0x1082, 0x10rs w09C, 0x109D, 0    /* 4 */ 0x1090, 0x1041, , 0x056C, 0x05x0000, 0x000* 0 */ 0x0300, 0x0301, 0x0x0000, 0x0000, 01fx0130, 0x0131, 0x07, 0x04B7,
     000, 0x0000,  // Table 4 (for h2E, 0x110E5, 0x10E6, 0x10a77,
            0x1078, 9         0x1048,90x1049, 0x104A, 9x104B, 0x104C, 0x10E9, 0x10EA, 0x10EB80, 0x1081, 0x1082, 0x10B, 0, 0x1067,
   x00Fx1086, 0x1087a5, 0x1056, * 7 */ 0x0570,000, 0x0000,       0x0000, 0x0015F,
0x0000, 0x0000,
    043E, 0x043F,
    /, 0x0x10D2, 0x10D3, 0x10D4,s_fs.h"

/*
 *  Un    006D, 0x006E, 0x006F,
 ious data tables
  0x009F,
    /* A */ 0x00A000C0, 0x00C1, 0x00C */ 0x100A5, 0x00A6, 0x00A0E, 0x030F,
    /* 1 */ 002E, 0x102F,
    /* 3 */ 0xx0441, 0x0442, 0x0443, 0x02E, 0x102F,
    /* 3 */ 0x, 0x0447,
            0x042E, 0x102F,
    /* 3 */ 0x 0x044B, 0x044C, 0x044D, 0    0x1038, 0x1039, 0x103A500, 0x0501, 0x0502, 0x050    0x1038, 0x1039, 0x103Ax04CC, 0x04CD, 0x04CE, 0x0    0x1038, 0x1039, 0x103A04D0, 0x04D1, 0x04D2, 0x040x1042, 0x1043, 0x1044, 0x0ED, 0x10EE, 0x10EF,
    /* F */ 00x1043, 0x1044, 0x0F2, 0x10F3, 0x10F4, 0x10F5, 0x10F0x1043, 0x1044, 0x     0x10F8, 0x10F9, 0x10FA, 0x10F0x1043, 0x1044, 0x 0x10FE, 0x10FF,

    // Table 7 (0x1043, 0x1044, 0x)

    /* 0 */ 0x2000, 0x2001, 0x20x1043, 0x1044, 0x4, 0x2005, 0x2006, 0x2007,
      
            0x10580ED, 0x10EE, 0x10EF,
    /* F */ 
            0x10580F2, 0x10F3, 0x10F4, 0x10F5, 0x10
            0x1058     0x10F8, 0x10F9, 0x10FA, 0x10
            0x1058 0x10FE, 0x10FF,

    // Table 7 
            0x1058)

    /* 0 */ 0x2000, 0x2001, 0x
            0x10584, 0x2005, 0x2006, 0x2007,
      x1075, 0x1076, 0x10  // Table 4 (for high byt048, 0x2049, 0x204A, 0x204, 0x0473, 0x0473, 0x0475, 048, 0x2049, 0x204A, 0x204477,
            0x0479, 0, 0x107F,
    /* 8 */ 0x10D, 0x051E, 0x051F,
    /* , 0x107F,
    /* 8 */ 0x10, 0x0522, 0x0523, 0x0524, , 0x107F,
    /* 8 */ 0x10, 0x03FB, 0x03FC, 0x03FD, x1097,
            0x1098,B, 0x204C, 0x204D, 0x204E, 0x204F,0x1043, 0x1044, 0x0, 0x2051, 0x2052, 0x2053, 0x2054,0x1043, 0x1044, 0xx2057,
            0x2058, 0x2059,0x1043, 0x1044, 0xx205C, 0x205D, 0x205E, 0x205F,
   0x1043, 0x1044, 0xx2061, 0x2062, 0x2063, 0x2064, 0x20x1043, 0x1044, 0x7,
            0x2068, 0x2069, 0x0E9, 0x10EA, 0x10EBB, 0x204C, 0x204D, 0x204E, 0x204F0E9, 0x10EA, 0x10EB0, 0x2051, 0x2052, 0x2053, 0x20540E9, 0x10EA, 0x10EBx2057,
            0x2058, 0x20590E9, 0x10EA, 0x10EBx205C, 0x205D, 0x205E, 0x205F,
  0E9, 0x10EA, 0x10EBx2061, 0x2062, 0x2063, 0x2064, 0x0E9, 0x10EA, 0x10EB*  means th};
