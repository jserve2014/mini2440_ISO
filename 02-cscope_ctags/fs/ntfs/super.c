...
alockerr_/*
 * super.c - NTFS kernel suindexblock handlini. Part of the if (!err) {
		printk(KERN_CRIT "NTFS: Aborting 1,20 filesystem driver "
				"registration...\n");
		err = -ENOMEM;
	}
	return err;
...
static void __exit unde_el sufs(ify )
{
	el sudebug("Unude fierard Russos prog.soft
	uc License_n
 *
 * Th(&terms o_typdlin super.c - NTFS kernel subig_inodek handlin Linux-NTFS project.
 *
 * t your option) any later version.
 *
namyour option) any later version.
 *
per block handlin Linux-NTFS project.
 *
 * Copyright (c) 20	/* ic License the el s sysctls. */U GenerITY or(0)nd/orMODULE_AUTHOR("Anton Altaparmakov <aia21@cantab.net>softPURPOSEDESCRIPTION(01,20 1.2/3.xis progr- Copyright (c) 2001-2007 he
 * GNU General more detailVERS You1,20h this pore detailLICENSE("GPLsoft#ifdef DEBUG
module_param(al Pu_msgs, bool, ICULPURPOSEPARMls.
 in the file C"Enable al Pu messages* by #endif
distribuinit(Suit terms o)distribuunde( the terms o)
